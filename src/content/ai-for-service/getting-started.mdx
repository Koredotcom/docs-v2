...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  Automation AI ──► Build virtual assistants                      │
│                                                                  │
│  Search AI ──────► Conversational knowledge search               │
│                                                                  │
│  Contact Center ─► Agent desktop & routing                       │
│                                                                  │
│  Agent AI ───────► Real-time agent assistance                    │
│                                                                  │
│  Quality AI ─────► Automated quality management                  │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
