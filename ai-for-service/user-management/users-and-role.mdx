...
App Owners and Administrators can create custom fields to capture agent metadata beyond the default profile attributes. Once created, a custom field appears in the profile of every agent in the account.
