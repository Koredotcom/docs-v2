...
For a full overview of the SDK, see [How the Web SDK Works](/ai-for-service/sdk/how-web-sdk-works).
...
For details, see the official [WCAG 2.2 documentation](https://www.w3.org/TR/WCAG22/) or download the [Voluntary Product Accessibility Template (VPAT)](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/sdk/images/koreai-accessibility-conformance-report.pdf).
...
For custom themes, follow the [Virtual Assistant Theme & Design guidelines](/ai-for-service/channels/add-web-mobile-client#add-webmobile-client-channel). Ensure:
