...
| `isAnonymous` | boolean | Set `true` for anonymous users. Anonymous users aren't persisted on the Platform. Default: `false`. |
...
To register your app and get credentials, see [SDK App Registration](/ai-for-service/sdk/app-registration).
