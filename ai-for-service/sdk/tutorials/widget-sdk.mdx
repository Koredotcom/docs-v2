...
2. **Enable the Widget SDK channel** on your bot by creating or using an existing client app. See [Add Widget SDK Channel](/ai-for-service/channels/add-widget-sdk-channel). Note the following from the **Configurations** tab:
   - Bot Name
   - Bot ID
   - Client ID
   - Client Secret
