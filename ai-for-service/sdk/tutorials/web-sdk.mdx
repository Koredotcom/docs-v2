...
2. Go to **Flows & Channels > Digital > Web/Mobile Client**. See [Web/Mobile Client channel setup](/ai-for-service/channels/add-web-mobile-client#add-webmobile-client-channel) for full details.
...
5. Select the newly created app in the **Select JWT App** dropdown and click **Save**.
   ...
   <Note>By default, the bot's Target Audience is **Enterprise Users**. You can change this to **General Public** before publishing — it can't be changed after.</Note>
