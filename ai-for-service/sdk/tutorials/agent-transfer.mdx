...
<Note>This tutorial may require a newer version of the BotKit SDK. If the downloaded files don't include `LiveChat.js` and `LiveChatAPI.js`, contact support.</Note>
