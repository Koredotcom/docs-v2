...
For a full end-to-end tutorial, see [BotKit SDK Tutorial — Flight Search](/ai-for-service/sdk/tutorials/flight-search-sample-bot).

---

## Prerequisites

It requires Node.js version 10 or higher.
...
See [SDK App Registration](/ai-for-service/sdk/app-registration) for details.

---

## Download and Install

Download the BotKit SDK from GitHub from [BotKit repo](https://github.com/Koredotcom/BotKit).
...
In a terminal, navigate to your BotKit SDK folder and run `node app.js` command.
