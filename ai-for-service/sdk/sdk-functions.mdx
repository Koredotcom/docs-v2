...
- [sdk.sendUserMessage](#sendusermessage)
- [sdk.sendBotMessage](#sendbotmessage)
- [sdk.AsyncResponse](#asyncresponse)
- [sdk.respondToHook](#respondtohook)
- [sdk.registerBot](#registerbot)
- [sdk.saveData](#savedata)
- [sdk.getSavedData](#getsaveddata)
- [sdk.getMessages](#getmessages)
- [sdk.clearAgentSession](#clearagentsession)
- [sdk.startAgentSession](#startagentsession)
- [sdk.resetBot](#resetbot)
- [sdk.extendRequestId](#extendrequestid)
- [sdk.skipBotMessage](#skipbotmessage)
- [sdk.skipUserMessage](#skipusermessage)
- [sdk.closeConversationSession](#closeconversationsession)
