...
| [Authorization Profiles](/ai-for-service/app-settings#authorization-profiles) | Overview of supported authentication models |
...
| Auto Open Debug Logs | Controls whether the Debug Log panel opens automatically when testing Digital or Voice channels. Enabled by default. |
