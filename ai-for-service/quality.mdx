...
- Assign Supervisors and Auditors to the relevant queues so they can access the right interactions. [Learn more](/ai-for-service/quality#2-set-up-contact-center).
