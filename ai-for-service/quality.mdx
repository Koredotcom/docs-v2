...
| View | Description |
|---|---|
| My Dashboard (Agent Console) | Assigned evaluations, sentiment trends, and resolution effectiveness |
...
- Assign Supervisors and Auditors to the relevant queues so they can access the right interactions. [Learn more](/ai-for-service/contact-center).
...
- Create evaluation metrics. [Learn more](/ai-for-service/quality-ai/configure/evaluation-metrics#create-a-new-evaluation-metric).
...
- Use the **Conversation Intelligence Dashboard** for contact center-wide performance trends. [Learn more](/ai-for-service/quality-ai/analyze/cx-insights).
