...
- Assign Supervisors and Auditors to the relevant queues so they can access the right interactions. [Learn more](/ai-for-service/contact-center/supervisor#real-time-monitor).
...
- Navigate interactions using adherence moments and violations. [Learn more](/https://docs.kore.ai/ai-for-service/quality-ai/analyze/ai-assisted-manual-audit).
