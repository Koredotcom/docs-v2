...
<Note>Off-Queue agents remain part of the queue's configuration. The Off-Queue indicator reflects the agent's deselection and does not change the assignment.</Note>
