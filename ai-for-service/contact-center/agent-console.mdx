...
| Agent Handling Time        | Time you have been handling the conversation since you accepted it.                        |
| Agent Last Message Time    | Elapsed time since you last sent a message in this conversation.                           |
