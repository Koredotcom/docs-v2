...
- If you do not accept or respond within the configured time, the system automatically sets your status to **Away (Idle)**. This status is not available for manual selection.

  ![Away Idle](/ai-for-service/contact-center/console/images/away-idle.png)

- You cannot log out during an active conversation. Transfer or close it first. If your browser closes unexpectedly, active conversations return to the queue after an inactivity threshold.
...
Select **Accept** to take the next interaction. If you do not accept within the configured time, the conversation returns to the queue and your status changes to Away.
...
![Accept Reject Button](/ai-for-service/contact-center/console/images/accept-reject-button.png)
...
If you do not send the first response within the configured time, the conversation returns to the queue and your status changes to Away.
...
- Invalid numbers display an error and disable the Call button.
...
1. Select **Call** in the VOICEMAIL panel.
   ...
   ![Call Option](/ai-for-service/contact-center/console/images/callback%20button.png)
...
4. Use **Swap** to switch between the customer call and the consulting agent. Switching to the customer call places the consult on hold.
   ...
   ![Swap Button](/ai-for-service/contact-center/console/images/swap-button.png)
...
- All chat transcripts from supervisors appear in yellow.
  ...
  ![Supervisor Conversation](/ai-for-service/contact-center/console/images/supervisor%20conversation.png)
...
![Forward Button](/ai-for-service/contact-center/console/images/forward-button.png)
...
2. In the **External Consultation Call** window, dial the number using one of three methods:
   ...
   - **Contacts Tab**: Search for the contact, select **Call**, then select **Call** on the dialer tab.
     ...
     ![Call Icon](/ai-for-service/contact-center/console/images/call-button%20(2).png)
   ...
   - **Call History Tab**: Select the number from history and select **Call** to dial.
     ...
     ![Call History Tab](/ai-for-service/contact-center/console/images/call-history%20(2).png)
...
**Co-browse via phone (security code):**
...
1. Select **Translate**.
   ...
   ![Translate Button](/ai-for-service/contact-center/console/images/translate-button.png)
...
![Manage Layout Button](/ai-for-service/contact-center/console/images/manage-layout-button.png)
...
4. Select **Play** to test the recording. Maximum recording length: 12 minutes.
   ...
   ![Play Button](/ai-for-service/contact-center/console/images/play-button.png)
