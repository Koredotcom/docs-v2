...
The Conversation Tray shows all conversations assigned to an agent.

![Conversation Tray](/ai-for-service/contact-center/console/images/tray-icons.png)
...
<Note>If a supervisor reassigns a conversation to another agent, it is removed from your Personal Work Bin.</Note>
...
* A supervisor has not transferred the conversation to another agent.
...
| Handling time             | Handling time does not accumulate while a conversation is in the Work Bin.          |
...
| Slot limit on self-assign | The slot limit does not block self-assignment from the Personal Work Bin.           |
...
The Reset to Default action restores your original skill and queue assignments as configured by your supervisor. It is available in the Queues and Skills section and resets all de-selections.
