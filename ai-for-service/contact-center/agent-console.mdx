...
| Footer   | Conversation status.                                                                                                                   |

**Multiple conversation statuses**

When a conversation has more than one conversation status, the card shows the first two followed by a +N indicator for the remaining count. Select +N to expand and view all conversation statuses.

Example:

![History Widget](/ai-for-service/contact-center/console/images/history-widget.png)

Selecting +2 displays the two additional conversation statuses.

Select any conversation card to view the full transcript.

![Transcript details](/ai-for-service/contact-center/console/images/transcript.png)
