...
Original agent experience:

When the interruption flow triggers, the active call is removed from the agent's screen and the Console returns to its default state.

CSAT attribution:

CSAT is attributed to the new agent, consistent with agent transfer scenarios.
