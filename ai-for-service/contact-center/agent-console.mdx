...
3. Choose an action:
   ...
   | Send & Close | Sends the email and opens the disposition window. If Wrap-up Code prediction active, a disclaimer appears to verify AI-generated content. |
   | X | Minimizes the email and saves it as a draft. |
