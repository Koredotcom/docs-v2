...
<Note>The Click-to-Call flow appears in Conditional Flows only after it is enabled in [Theme & Design](/ai-for-service/channels/add-web-mobile-client#ai-agent-theme-%26-design).</Note>
...
The Debug Log displays the interaction flow in a chat-style format, pairing user inputs with system responses. This makes it easy to trace conversation steps, inspect context at each stage, and identify where issues occur. [Learn more](../../automation/testing/talk-to-bot.md#debug-log).
