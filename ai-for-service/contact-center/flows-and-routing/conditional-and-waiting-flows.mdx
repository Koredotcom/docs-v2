...
2. Select Call, Chat, or Email Experience tabs as required and turn on the **Enable Fallback Message for No Agent Available** or **Enable Fallback Message for Out-of-Office Hours** toggle.
3. Enter the fallback messages and select **Save**.
