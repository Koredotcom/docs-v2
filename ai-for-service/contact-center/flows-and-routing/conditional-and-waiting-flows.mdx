...
<Note>If the conversation waiting for the Last Handling Agent is moved to the No Agents Available or Out-of-Office Hours flow, then it follows the routing behavior configured in the queue.</Note>
