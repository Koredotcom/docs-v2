...
<Note>The Click-to-Call flow appears in Conditional Flows only after it's enabled in [Theme & Design](/ai-for-service/channels/add-web-mobile-client.mdx).</Note>
