...
Hours of Operation defines when agents are available — standard working hours, weekends, holidays, and special days by time zone. Contact Center AI uses this configuration to trigger [Conditional Flows](/ai-for-service/contact-center/flows-and-routing/conditional-and-waiting-flows.mdx) for out-of-hours and no-agents-available scenarios.
...
1. Click **+ Add New**.
    ...
    ![Add Hours of Operation](/ai-for-service/contact-center/configurations/images/add-new.png)
...
- Click **+ Add Another** to add more time ranges within an entry.
- Click the **Delete** icon to remove an entry.
- Click **Save** when done.

![Configure Holiday Hours](/ai-for-service/contact-center/configurations/images/configure-holiday-hours.png)
...
Click the **Delete** icon under **Actions** and confirm.
...
You can also manage languages from [Language Management](../../app-settings/language-management/managing-languages-for-multilingual-vas.md) in App Settings.
...
The following languages are supported for AI Agents and Human Agents:
...
![Hold Audio](/ai-for-service/contact-center/configurations/images/hold-audio.png)
...
- **From the saved list**: Click the **Delete** icon next to the file and confirm. Re-upload if you change your mind.
- **Before saving**: Click the **Delete (x)** icon in the upper right of the upload panel.
...
1. Click the response group name.
...
1. Click the response group name.
2. Click the **Edit** icon, then **Delete Response Group**.
3. Confirm deletion.
...
1. Click a response group to open it.
2. Click **+ New Response**.
3. Set the **Title** and **Auto Expire**:
    - **Never** — The response does not expire.
    - **Custom Date** — Set an end date and time.
4. Select a response type tab and add content:
    - **Chat Response**: Type the message in the text editor. Click **Done**.
    - **Email Response**: Write in plain text, using variables, or in HTML/CSS. Optionally click **+ Add Subject** to add a subject line. Click **Done**.
5. Click **Create**.
...
1. Click the response group name.
2. Find the response and click the **Edit** icon under **Actions**.
3. Make changes and click **Save**.

### Delete a Response

1. Click the response group name.
2. Click the **Edit** icon for the response.
3. Click the **Delete** (bin) icon and confirm.

<Note>Deleted responses cannot be restored.</Note>
...
Enter the **Survey Name** and **Description**.
        ...
        ![General Information](/ai-for-service/contact-center/configurations/images/general-information.png)
...
3. Configure the **Request Message** (shown before the survey) and the **Gratitude Message** (shown after). Select a language, enter the text, and click **Done**.
...
5. Configure **Advanced Survey Conditions** (optional):
    ...
    |-----------|----------------|
    | Trigger when no agents are available | Agent transfer did not occur due to unavailability. |
    | Trigger outside business hours | Conversation occurred outside configured business hours. |
    | Trigger for agent-closed conversations | Only conversations closed by an agent receive the survey. |
...
Select the survey name or the **Edit** icon, make changes, and click **Done**.

### Delete a Survey

1. Select the survey name or the **Edit** icon.
2. Click **Delete** in the bottom toolbar and confirm.
...
| **Published** | The form is approved and available to agents in the console. |
...
Add components to the form — text fields, checkboxes, radio buttons, date fields, and more — using the Form Builder. See [Digital Forms](../../automation/use-cases/digital-skills/configure-digital-forms.md) for detailed guidance.

### Edit an Agent Form

- **Edit form fields**: Click the form record to open the Form Builder and make changes directly.
- **Edit form settings** (Name, Description, Data Security, Assignments):
    - From the live board: Click the **Edit** icon under **Actions**.
    - From the Form Builder: Click **More Options** > **Form Setting**.

### Publish an Agent Form

Publishing makes the form available for agents to send to customers from the Agent Console.

1. Click the **More Options** icon under **Actions**.
2. Select **Publish**.
...
- **From the live board**: Click **More Options** > **Delete**.
- **From the Form Builder**: Click **More Options** > **Delete**.

<Note>Deleted forms cannot be restored.</Note>

---

## Widgets

Widgets embed external systems or web pages into the Agent Console. Agents access widgets within custom [Agent Console Layouts](../../console/manage-layout.md).
...
1. Click **External Widget**, then **+ New External Widget**.
2. Configure:
...
In the **External Widgets** list, click the widget. Update the name, icon, or URLs and save.

### Delete a Widget

In the **External Widgets** list, click the widget. Click **Delete** in the bottom toolbar and confirm.

<Note>Deleting a widget removes it and all its configurations from the Agent Console permanently.</Note>

---

### Add a Widget to an Agent Console Layout

1. In the Agent Console, click **Manage Layout**.
2. Select a layout and click the **edit** icon.
...
1. In the Agent Console, click **Manage Layout**.
2. Select a layout and click the **edit** icon.
3. Click **More Options** on the widget and select **Delete**.
...
Select the **Delete** (bin) icon and confirm.
