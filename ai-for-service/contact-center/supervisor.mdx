...
The selected channel applies across Queues, Agents, Interactions, and Service Levels and persists during navigation. For Voice and Chat, the channel filter shows only Voice and Chat options; for Email, it shows only Email and limits the type filter to Inbound and Outbound; the Agents tab filters remain unchanged.
...
* Email metrics display only on selecting Email.
* Voice & Chat metrics remain unchanged.
