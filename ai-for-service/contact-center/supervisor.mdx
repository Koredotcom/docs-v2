...
- For Work Bin conversations, the Interactions view displays the name of the last agent who handled the interaction before it was moved to Work Bin. 
- The last handling agent name appears only for conversations in the Work Bin.
</Note>
