...
<Note>
    The Network Disconnection Notification Delay setting defines how long the system waits before notifying agents of a customer disconnect. If the customer reconnects within the configured delay, the notification is suppressed. Supported range is 3 seconds to 1 minute (default: 3 seconds).
</Note>
