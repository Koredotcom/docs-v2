...
- The last handling agent name appears only for conversations currently in the Work Bin.
</Note>
...
2. Select a metric from the dropdown list.
3. Select **Save**.
...
| Agent Handling Time                 | Time the currently assigned agent has been handling the conversation.                                                     | The agent accepts the conversation.      | Conversation transfers to another agent.                                 |
| Agent Last Message Time             | Elapsed time since the current agent last sent a message.                                                                 | The agent sends a message.               | The agent sends another message.                                         |
