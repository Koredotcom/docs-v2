...
<Note>In the Queues and Agents tabs, historical metrics filtered by a specific period don't auto-refresh. Data updates only when the page is hard reloaded or the duration filter is changed.</Note>
