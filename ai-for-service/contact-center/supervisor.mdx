...
**Voice & Chat**: Channel filter shows only Voice and Chat options.
**Email**: Channel filter shows only Email. The type filter shows only Inbound and Outbound.
**Agents tab**: No change in filters.
