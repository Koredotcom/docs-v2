...
3. Click **Start Flows > + New Start Flow**. See [Create Flows](/ai-for-service/flows/create-and-manage-flows#create-a-start-flow).
   ...
   ![New Start Flow](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/new-start-flow-1.png)
...
4. In the Experience Flow, add a **Script Node** with the following code:
   ...
   ![Experience Flow](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/experience-flow-2.png)
...
6. Add an **Agent Transfer** node to hand over the call to Genesys agents.
   ...
   ![Add Node in Experience Flow](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/add-node-in-experience-flo-3.png)
...
1. Go to **App Settings > Integrations > Agent Transfer**.
   ...
   ![Integrations Agent Transfer](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/integrations-agent-transfer-4.png)
...
2. Click **Voice > SIP Transfer** and configure:
   ...
   ![SIP Transfer](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/sip-transfer-5.png)
...
2. Go to **Admin > Architect**.
   ...
   ![Admin Architect](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/admin-architect-6.png)

3. Click **+ Add** to create a new call flow.

   ![Add New Call Flow](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/add-new-call-flow-7.png)
...
6. After the **Start** node, add a **Get SIP Headers** node:
   ...
   ![Store SIP Headers Result](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/store-sip-headers-result-9.png)
...
7. Add a **Set Participant Data** node:
   ...
   ![Assign Value as Expression](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/assign-value-as-expression-10.png)
...
10. Save and publish the flow.
    ...
    ![SIP Headers](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/sip-headers.png)
...
![DID Range](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/did-range-11.png)
...
2. Click **Add** to create a new call route.
   ...
   ![Add New Call Route](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/add-new-call-route-13.png)

   ![Create Call Route](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/create-call-route-14.png)
...
3. Click **+ Create New** and configure:
   ...
   ![Create External Trunk](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/create-external-trunk-17.png)

4. Select **Kore Site** in the **Number Plan Site** dropdown.

   ![Number Plan Site](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/number-plan-site-list-18.png)

5. Enter a unique name for **Inbound SIP Termination Identifier**.
6. The **Inbound Request-URI Reference** is auto generated:

   ![Inbound Request URI Reference](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/inbound-request-uri-reference-19.png)
...
7. In **SIP Access Control**, add the AI for Service voice gateway IPs:
   ...
   ![SIP Access Control](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/sip-access-control-field-20.png)

8. Expand **Media** and enable **Recording**. Enable all **Optional Recording** options.
9. Set **Codec** to **Opus** and select **Dual channel**.

   ![Dual Channel](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/dual-channel-checkbox-21.png)

10. Expand **Protocol** and enable **Conversation Headers**.

    ![Protocol Conversation Headers](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/protocol-conversation-headers-22.png)

11. Click **Save External Trunk**.

    ![Save External Trunk](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/save-external-trunk-23.png)

<Note>

- If **Media > Recording** isn't enabled, the end call summary in the Agent AI widget is unavailable. The middleware requires this setting to receive the session end event from Genesys.
- If **Protocol > Conversation Headers** isn't enabled, the landing summary and real-time transcription in the Agent AI widget are unavailable.
...
![Web Mobile Client](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/web-mobile-client-24.png)
...
2. Add a new field in the Genesys data table:
   ...
   ![Genesys Data Table](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/genesys-data-table-25.png)
...
1. Click **Answer** in Genesys.
   ...
   ![Accept Call in Genesys](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/accept-call-in-genesys-26.png)

2. Open the **Tools** section and select the interaction widget configured during setup.

   ![Available Tools](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/available-tools-27.png)

3. The Agent AI widget appears on the right side of the Genesys Agent Desktop.

   ![Agent AI Widget](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/agent-ai-widget-28.png)

4. Click the **Transcript** tab to view user-bot conversation history, a summary, and real-time transcripts.

   ![Transcript Tab](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/transcript-tab-29.png)
...
2. Click the interaction to view.
   ...
   ![Interaction to View](/ai-for-service/contact-center/integrations/voice-automation-using-sip-invite-protocol/images/interaction-to-view-30.png)
