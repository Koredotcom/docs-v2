...
* **Whitelist IP Address**: Whitelist the IP address Amazon Connect provides. This IP address is essential for allowing communication from Amazon Connect to Kore. Check with Amazon Connect documentation or Support for the details on this IP address.
