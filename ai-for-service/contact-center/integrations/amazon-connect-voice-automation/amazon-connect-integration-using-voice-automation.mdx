...
![architecture-diagram](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/architecture-diagram.png)
...
![external-voice-systems](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/external-voice-systems-1.png)
...
![specify-connector-details](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/specify-connector-details-2.png)
...
![test-kore-connector](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/test-kore-connector-3.png)
...
![transfer-to-phone-number-node](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/transfer-to-phone-number-node-4.png)
...
![destination-arn](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/destination-arn-5.png)
...
![configure-sip-trunk](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/configure-sip-trunk-6.png)

* **Attach to Start Flow**: Once the configuration is complete, attach this number to the relevant Experience Flow within Kore.
![start-flows](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/start-flows-7.png)
...
![amazon-connect-number](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/amazon-connect-number-8.png)

    ![call-originates](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/call-originates-9.png)
...
![ccai-dashboard-interaction](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/ccai-dashboard-interaction-10.png)

4. After interaction with Kore, the call is transferred back to Amazon Connect.
![transfer-back-to-amazon](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/transfer-back-to-amazon-11.png)
...
![create-table](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/create-table-12.png)
...
1. Create a REST API Gateway with the default configuration:
    ![create-rest-api](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/create-rest-api-13.png)

2. Create an API resource with the **Resource path** as "/kore-metadata." Click **Create resource**:
    ![create-resource](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/create-resource-14.png)
...
3. Create an **API Method** with the following details:
    ...
    ![create-method](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/create-method-15.png)

4. The created method appears as shown in the following screenshot:
    ![resources](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/resources-16.png)
...
5. To enable authentication for this API Gateway, you need **Authorizers**. Create a new Authorizer with the following details:
    ...
    7. Click **Create authorizer**.
        ![create-authorizer](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/create-authorizer-17.png)

        ![authorizer-details](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/authorizer-details-18.png)
...
6. Once the **koreClientAuth** Authorizer is created, add this as part of authentication for the API Resource and method you created.
    ...
    10. Click **Save**.
    ![edit-method-details](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/edit-method-details-19.png)

7. Click **Deploy API**.
    ![deploy-api](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/deploy-api-20.png)
...
![aws-lambda](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/aws-lambda-21.png)
...
* The modified Amazon Connect flow appears as shown in the following screenshot:
    ![modified-amazon-connect-flow](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/modified-amazon-connect-flow.png)
...
* **Start Flows**
    ...
    ![test-the-flow](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/test-the-flow-22.png)

    4. Identify the **Automation bot** used in Conditional Flow. You will need it in the next step when configuring the Botbuilder.
    ![automation-bot](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/automation-bot-23.png)
...
![add-service-node](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/add-service-node-24.png)
...
![core-store-session-metadata](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/core-store-session-metadata-25.png)
...
![define-request](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/define-request-26.png)
...
```
![define-request-body](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/define-request-body-27.png)
...
<Note>Pass the `kore-instanceSessionId` key and its value in the above specified format. This is required for the Agent AI widget to retrieve the user's bot history. You may also include additional data, as needed.</Note>
        ...
        ![define-request](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/define-request-28.png)
...
![analytics-and-optimization](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/analytics-and-optimization-29.png)

3. A list of conversations is displayed. You can also filter the results by contact ID.
![contact-search](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/contact-search-30.png)

4. When you open a contact's details, the metadata appears as contact attributes.
![contact-details](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/contact-details-31.png)
...
![contact-flow-final-screenshot](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/contact-flow-final-screenshot.png)
...
![printing-custom-data](/ai-for-service/contact-center/integration/amazon-connect-voice-automation/images/printing-custom-data.png)
