...
* **Connector Configuration**:
    ...
    * **Logging**: Select the option(s) to view the corresponding log in Connector Logs. Select both options.
...
On the Kore side, you must configure Contact Center AI (CCAI) to receive and manage calls transferred from Amazon Connect.
...
![start-flows](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/start-flows.png)
...
![amazon-connect-number](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/amazon-connect-number.png)
...
![ccai-dashboard-interaction](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/ccai-dashboard-interaction.png)

4. After interaction with Kore, the call is transferred back to Amazon Connect.
![transfer-back-to-amazon](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/transfer-back-to-amazon.png)
...
2. Create an API resource with the **Resource path** as `/kore-metadata`, and then click **Create resource**:
...
4. The following screenshot shows the method you created:
    ![resources](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/resources.png)
...
6. After creating the **koreClientAuth** authorizer, add this as part of authentication for the API resource and method.
    - Click **Edit method request**.
    - Under **Authorization**, select **Token authorizers** as **koreClientAuth**.
    - Click **Save**.
...
7. Click **Deploy API**.
    ![deploy-api](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/deploy-api.png)
...
* Name this flow as **TransfertoKore&MetadataPassing**. (You use this name later during the Agent AI integration step.)
...
* **Start Flows**
    ...
    ![test-the-flow](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/test-the-flow.png)

    4. Identify the **Automation bot** used in Conditional Flow. Use it in the next step when configuring the Botbuilder.
    ![automation-bot](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/automation-bot.png)
...
![analytics-and-optimization](/ai-for-service/contact-center/integrations/amazon-connect-voice-automation/images/analytics-and-optimization.png)
...
After integrating Agent AI as a TPA in Amazon Connect, create another contact flow (for example, *KVSAgentAssist*). Add this flow to the previously created or imported flow (*TransfertoKore&MetadataPassing*).
