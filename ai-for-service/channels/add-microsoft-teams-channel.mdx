...
The Platform now supports real-time LLM response streaming within Microsoft Teams chat conversations. Instead of waiting for the complete response, users see replies generated in real time, word by word, delivering a faster and more natural conversational experience. This enhancement reduces perceived latency, improves responsiveness, and increases user engagement. Refer to [Streaming Responses](/ai-for-service/generative-ai-tools/streaming-responses).
