...
![create an app](../images/slack-create-app.png)
...
![create a slack app](../images/create-a-slack-app.png)
...
![set redirect url](../images/set-redirect-url-and-scopes.png)
...
![bot token scopes](../images/bot-token-scopes.png)
...
![install app to workspace](../images/install-app-to-workspace.png)
...
![oauth tokens for workspace](../images/oauth-tokens-for-workspace.png)
...
![interactivity and shortcuts](../images/interactivity-and-shortcuts.png)
...
![events subscriptions](../images/events-and-subscriptions.png)
...
![enable interactions](../images/enable-interactions.png)
...
![app credentials configuration](../images/app-credentials-configuration.png)
...
2. Select **I’ve reviewed and removed any hard-coded information** and click **Activate Public Distribution.**.
  ...
  ![manage distribution](../images/manage-distribution.png)
...
![slack configuration](../images/slack-configurations-uxo.png)
...
![authorize client credentials](../images/authorize-client-id-client-secret.png)
...
![customize slack conversation](../images/customize-slack-conversations.png)
...
![proactive notifications](../images/proactive-notifications.png)
...
![enable slack channel](../images/enable-slack-channel.png)
