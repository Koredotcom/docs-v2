...
| `InteractiveLanguage` | The interaction language of the AI Agent. | String | Optional | Any language that is configured for the AI Agent. For the list of Supported App Languages, read [Getting Started with Multilingual AI Agent](/ai-for-service/app-settings/language-management/building-multi-language-bots) article. |
| `userInfo` | The user profile information. | Object | Optional | N/A |
| `firstName` | The first name of the user. | String | Optional | N/A |
| `lastName` | The last name of the user. | String | Optional | N/A |
| `email` | The email address of the user. | String | Optional | N/A |
