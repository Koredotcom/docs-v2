...
* If the `userIdentity` is not present in JWT, you can validate the `userIdentity` authentication using the appId and the `from` value will be used to generate the userId in the platform.
