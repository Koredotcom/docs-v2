---
title: Adding the Mattermost Channel
sidebarTitle: Adding the Mattermost Channel
noindex: true
---
...
![main menu](/ai-for-service/channels/images/mattermost.png)

3. Select the **Outgoing Webhooks** menu and click **Add Outgoing Webhook**.
![add outgoing webhook](/ai-for-service/channels/images/mattermost1.png)
...
4. Provide required information as per the below image.
    ...
    * Click on **Save** to complete the Outgoing Webhook setup.
    ![save mattermost configuration ](/ai-for-service/channels/images/mattermost2.png)
    ...
    * Copy this Token and provide it in the ‘Outgoing Webhook Token’ field present in the Platform Channel Configurations section.
    ![copy outgoing webhook token](/ai-for-service/channels/images/mattermost3.png)
...
2. Provide required information as per the below image.
    ...
    * Don't select the **Lock to this channel** option.
    ![choose default channel](/ai-for-service/channels/images/mattermost4.png)
...
![provide incoming webhook](/ai-for-service/channels/images/mattermost5.png)
...
![enable personal access tokens](/ai-for-service/channels/images/mattermost6.png)
...
2. Configure the Bot’s details:
    ...
    * Click **Create Bot Account** to complete the setup.
    ![create bot account](/ai-for-service/channels/images/mattermost7.png)
...
![success page](/ai-for-service/channels/images/mattermost8.png)
...
![enable mattermost](/ai-for-service/channels/images/mattermost9.png)
