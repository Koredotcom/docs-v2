...
![IVR panel](../images/third-party-voice.png)
...
![IVR configuration](../images/IVR-9.png)
...
![IVR configuration](../images/IVR-13.png)

8. On clicking **Test**, the following pop-up is displayed.
![IVR configuration](../images/IVR-14.png)

The **Phone Number**, **PIN**, and **Secret** are populated in the IVR Configurations panel as shown in the following screenshot.  ![IVR configuration](../images/IVR-15.png)
...
![IVR properties](../images/IVR-16.png)
