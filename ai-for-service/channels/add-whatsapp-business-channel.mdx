...
1. Select **Add product** under the Products section on the left navigation bar.
    ...
    <Note>The **Facebook Login for Business** is not available as default. Therefore, we recommend that you search for it to add under the My products section. Ignore, if it is already available.</Note>
...
| Disabled (default) | Sessions follow the standard platform behavior based on the user's identity. The inbound Phone Number ID does not influence session scoping.                                                                                                   |
...
![Temporary Authorization](/ai-for-service/channels/images/authorization-type-temporary.png)
...
![Permanent Authorization](/ai-for-service/channels/images/authorization-type-permanent.png)
