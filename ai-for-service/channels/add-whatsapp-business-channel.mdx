...
![infobip connection](../images/whatsapp3.png)

5. Click the **ellipses** icon under **Action** and select **Edit Configuration**.
![edit infobip configuration](../images/whatsapp4.png)
...
![deploy infobip](../images/whatsapp5.png)
...
7. Next, to add Infobip’s **Base URL**, follow these steps:
    ...
    * On the **WhatsApp Business Messaging** panel, click the **Configurations** tab and provide inputs for the following fields:
        ...
        * **Base URL**: Copy the Base URL from this page. Use this URL sends messages when the **WhatsApp Business Messaging** channel is enabled.
        ![infobip messaging partner](../images/whatsapp7.png)
        ...
        * **Webhook URL**: Copy the webhook URL provided in the configuration tab and update the same on the **Infobip developer portal** for Infobip to send the received messages from the subscriber (WhatsApp Business Messaging).
        ![infobip API](../images/whatsapp8.png)
    ...
    * Click **Save** to complete the integration setup.
    ![save infobip configuration](../images/whatsapp9.png)
...
![view infobip logs](../images/whatsapp10.png)

![infobip errors](../images/whatsapp11.png)
...
![save gupshup application](../images/whatsapp12.png)

2. Click the **+ Create App** button.
![create gupshup app](../images/whatsapp13.png)

3. On the **Create App** screen, click **Access API** to select the app type.
![access gupshup api](../images/whatsapp14.png)

4. Provide a unique name for the application and click **Submit**.
![submit gupshup app](../images/whatsapp15.png)

5. For **_Step 2: Onboard your Users_**, click **Next**.
![onboard gupshup ](../images/whatsapp16.png)
...
5. Paste the copied values for **Mobile number**, **WABA ID**, and **Password** in the respective input fields.  ![add gupshup WABA ID](../images/whatsapp19.png)
...
![test gupshup api](../images/whatsapp22.png)
...
![secure gupshup integration](../images/whatsapp23.png)
...
![configure karix](../images/whatsapp24.png)
...
![whatsapp api key](../images/whatsapp-api-key.png)
...
![messaging-dropdown](../images/messaging-dropdown.png)

5. Copy the **Webhook URL**.
![webhook url](../images/copy-webhook-url-netcore.png)
...
![enable webhook](../images/webhook-integration-netcore.png)
...
7. Click **Save**.
    ...
    ![enable netcore](../images/enable-channel-netcore.png)
...
![App-button](../images/App-button.png)
...
4. Find and Copy the **App ID** and **App Secret ID** and paste it as required in the **Step 4**
    ...
    ![App-settings-basic](../images/App-settings-basic.png)
...
1. Click **Add product** under the Products section on the left navigation bar.
    ...
    ![Products-add products](../images/Products-add products.png)
...
3. On the Settings page, enter the Valid OAuth Redirect URLs from the **Platform Configuration Page** as follows:
    ...
    <Note>      We recommends you verify the Callback URL using the Redirect URL Validator to ensure the accuracy of the path URL.   ![Validauth-redirecturl](../images/Validauth-redirecturl.png)</Note>
...
![Temporary Authorization](../images/temporary-authorization.png)
...
![Permanent Authorization](../images/permanent-token.png)
...
![Verify-save](../images/Verify-save.png)
