...
<Tip>For the private key, please copy only the key value within the **BEGIN PRIVATE KEY** and **END PRIVATE KEY** header tags. The XO Platform adds these tags by default.</Tip>
