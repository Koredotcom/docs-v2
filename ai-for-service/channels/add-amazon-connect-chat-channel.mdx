...
sidebarTitle: Amazon Connect Chat
---
...
<Note>Make sure the file name is `index.mjs` (not `.js`), and the handler in configuration matches `index.handler`.</Note>
...
3. Add the following 3 variables and click Save.
...
<Note>For better security, you can later replace `"Resource": "*"` with specific Connect instance ARNs.</Note>
...
|---|---|
| **Protocol** | `HTTPS` |
| **Endpoint** | Paste the Webhook URL copied from your the Platform Amazon Connect Channel Configuration page (for example, `https://abc123.ngrok-free.app/adapter/hooks/amazonconnect/st-e6895fc9-8012-5003-be9b-ab6df08f8eb6`) |
...
![Amazon Connect Chat](/ai-for-service/channels/images/aws-flow.png)
...
![Amazon Connect Chat](/ai-for-service/channels/images/retrieve-aws-region.png)
...
![Amazon Connect Chat](/ai-for-service/channels/images/aws-access-key.png)
![Amazon Connect Chat](/ai-for-service/channels/images/aws-access-key2.png)
![Amazon Connect Chat](/ai-for-service/channels/images/aws-access-key3.png)
...
![Amazon Connect Chat](/ai-for-service/channels/images/aws-platform.png)
