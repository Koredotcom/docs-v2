---
title: Adding the Zoom Contact Center Channel
sidebarTitle: Adding the Zoom Contact Center Channel
noindex: true
---
...
2. [Create a Bot Connector instance](#step-2-add-kore-ai-chatbot-connector-instance) on [Zoom App Marketplace](https://marketplace.zoom.us/apps) to associate an AI Agent.
...
![Zoom  channel](/ai-for-service/channels/images/Zoom.png)
...
5. In the **Create New Client App** window, follow the steps below:
    ...
    * (Optional) In the **Push Notifications** section, click **Enable** and then specify a URL to send the notifications.
    ![Zoom  client ID](/ai-for-service/channels/images/Zoom1.png)
    ...
    * When you Enable the Push Notifications, you can select one of the following options to manage the notifications:
        ...
        * **Message Delivery Failures** - Sends push notifications for failure scenarios such as WebSocket Disconnected, App is Killed, and Message Delivery Failure.
        ![message delivery failure](/ai-for-service/channels/images/Zoom2.png)
    ...
    * To customize the display messages for the push notifications messages sent to the client app, select one of the following options:
        ...
        * **Show a standard message from standard responses** - Sends a generic message instead of the original message.
        ![show standard messages](/ai-for-service/channels/images/Zoom3.png)
    ...
    * Click **Save** and then, click **Create**.
    ![manage responses](/ai-for-service/channels/images/Zoom4.png)
...
![Zoom  connector](/ai-for-service/channels/images/Zoom5.png)
...
1. Provide the following information for **Set Preferences**:
    ...
    * Click **Next**.
    ![Zoom  connector details](/ai-for-service/channels/images/Zoom6.png)
...
2. Provide the following information in the **Authorize** section:
    ...
    * Copy and paste the **Bot ID**, **Client ID**, and **Client Secret** values from the **Channels & Flows** > **Channels** > **Digital** > **All** > **Configured** section of the Platform (shown below) for **Authorization Parameters**.
    ![Zoom  bot details](/ai-for-service/channels/images/Zoom7.png)

3. Click **Next**.
![save Zoom  configuration](/ai-for-service/channels/images/Zoom8.png)

4. Copy the **Post URL** and **Access Token** values from the **Create Kore.ai Chatbot Connector** page.  ![Zoom  URL](/ai-for-service/channels/images/Zoom9.png)

5. Paste to the relevant fields on the Platform in the **Zoom Contact Center** > **Configurations** section.
![Zoom  contact center](/ai-for-service/channels/images/Zoom10.png)

5. Copy the **Webhook URL** from the **Zoom Contact Center** > **Configurations** section of the Platform.
![Zoom  Webhook URL](/ai-for-service/channels/images/Zoom11.png)

6. Paste on the **Create Kore.ai Chatbot Connector** page, and click **Next**.
![Zoom  Kore connnector](/ai-for-service/channels/images/Zoom12.png)

The following message appears once the Kore.ai Chatbot connector is authorized successfully.
![Zoom  channel](/ai-for-service/channels/images/Zoom13.png)
...
2. Click **Save**.
![enable Zoom  channel](/ai-for-service/channels/images/Zoom14.png)
