...
![line channel](../images/line.png)

2.  Click **Create a Messaging API Channel**.
![line messaging api](../images/line1.png)
...
![channel creation](../images/line2.png)
...
7. Under Enable Channel, select Yes and click Save to enable the LINE Channel for your assistant.  ![deploy line channel](../images/line3.png)
...
![Line Webhook URL](../images/line4.png)

3. Click **Update**.
![line webhook settings](../images/line5.png)
...
![line channel verification](../images/line6.png)
