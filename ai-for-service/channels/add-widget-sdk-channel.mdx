...
To add the Widget SDK Channel, you must first register, or create an app in the Platform. When you create an app, you are provisioning credentials for your application to communicate securely with Kore.ai servers. After you create an app, you can use that app registration in the configuration to add the Widget SDK Channel.
...
5. In the **Name** field, enter the name for the app registration used in the Platform, for example, My App Registration.
...
Once enabled [see here](/ai-for-service/sdk/tutorials/widget-sdk) for steps to integrate your AI Agent and your web application.
