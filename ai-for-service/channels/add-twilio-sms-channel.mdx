---
title: Adding the Twilio SMS Channel
sidebarTitle: Adding the Twilio SMS Channel
---
...
![Automations](/ai-for-service/channels/images/tw1.png)

3. Your Twilio Phone Number is displayed.
![Automations](/ai-for-service/channels/images/tw2.png)
...
1. Login to Platform and navigate to **Flows & Channels** > **Digital** > **Twilio SMS** > **Configuration** tab.
...
![Automations](/ai-for-service/channels/images/tw3.png)
...
![Automations](/ai-for-service/channels/images/tw4.png)
...
![Automations](/ai-for-service/channels/images/tw5.png)

8. Click **Add Senders** and follow the steps.
![Automations](/ai-for-service/channels/images/tw6.png)

9. From the Add Senders pop-up, select **Phone Number** from the dropdown list and click **Continue**.
![Automations](/ai-for-service/channels/images/tw7.png)

10. Select the **Select Phone Number** radio button and click **Step 3: Set up integration**.
![Automations](/ai-for-service/channels/images/tw8.png)

11. On the integration page, select **Send a Webhook**. Then, select the **Request URL**, **Fallback URL**, and **Status** **Callback URL** fields from the Platform Twilio SMS **Configurations** tab and enter them.
![Automations](/ai-for-service/channels/images/tw9.png)
...
![Automations](/ai-for-service/channels/images/tw10.png)

13. The setup complete pop-up appears. Click **View my new Messaging Service**.
![Automations](/ai-for-service/channels/images/tw11.png)
...
[How do I include an Image in an Outbound Twilio SMS (MMS)?](/ai-for-service/automation/how-tos/how-do-i-include-an-image-in-an-outbound-twilio-sms-mms#include-an-image-in-an-outbound-twilio-sms-mms)