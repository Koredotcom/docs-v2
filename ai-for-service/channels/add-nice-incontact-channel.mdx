...
![Instructions tab](../images/nice-in-contact-img1.png)
...
![Configurations](../images/nice-in-contact-img2.png)
...
![Nice InContact Configurations](../images/nice-in-contact-img3.png)

4. In the Enable channel, select **Yes** and then click **Save**. The configuration saved success message is displayed.
![Nice InContact Configuration saved](../images/nice-in-contact-img4.png)
...
![Download page](../images/nice-in-contact-img5.png)

3. In the **Studio** section, download **Studio Installer** to download the Nice inContact **StudioSetup.exe** file.
![Download Studio installer](../images/nice-in-contact-img6.png)
...
![File - Import from File](../images/nice-in-contact-img7.png)

2. Select the Studio Script downloaded from the XO platform and then click **Open**. For example, **Chat_Script.XML**.
![Open Studio Script file](../images/nice-in-contact-img8.png)
...
![Double click Text Box exchange](../images/nice-in-contact-img9.png)

4. The AI Agent page is displayed. Click **Add Bot**.
![Add bot](../images/nice-in-contact-img10.png)

5. On the General Information page, type in the bot name, select **Custom Exchange Endpoint**, and click **Next**.
![Custom Exchange endpoint](../images/nice-in-contact-img11.png)
...
6. On the Bot Configuration page, fill in the details as shown and then click **Next**.
    ...
    ![Integration version - 3.0.0](../images/nice-in-contact-img12.png)
    ...
    ![Custom headers](../images/nice-in-contact-img13.png)

7. On the Voice page, in the voice integration options, select **Text Only (No Voice Support)** and click **Next**.
![Integration options - Text Only](../images/nice-in-contact-img14.png)

8. On the **Test + Add** page, click **Add**.
![Test + Add](../images/nice-in-contact-img15.png)

9. The bot saved success message is displayed.
![Bot is successfully saved](../images/nice-in-contact-img16.png)
...
![Omnichannel Routing - ACD](../images/nice-in-contact-img20.png)

3. In the left-side vertical menu, under **DFO**, click **Point of Contact Digital**.
![DFO - Point of Contact Digital](../images/nice-in-contact-img21.png)

4. In the **Add Channel** section, click **Chat**. The My Channels page is displayed.
![My Channels](../images/nice-in-contact-img22.png)

5. Click **Create Messaging Channel**, type in the channel name, and click **Create**.
![Create messaging channel](../images/nice-in-contact-img23.png)

6. The created channel is displayed.
![Channel displayed](../images/nice-in-contact-img24.png)
...
![Queues](../images/nice-in-contact-img25.png)
...
![Edit the channel](../images/nice-in-contact-img31.png)
...
![Select Studio script](../images/nice-in-contact-img32.png)
...
1. Create a Campaign.
    ...
    ![Omnichannel routing - ACD](../images/nice-in-contact-img33.png)
    ...
    ![Create new campaign](../images/nice-in-contact-img34.png)

    4. Type in the campaign name and click **Create Campaign**.
    ![Create campaign](../images/nice-in-contact-img35.png)
...
2. Create A skills.
    ...
    ![Create new single skill](../images/nice-in-contact-img36.png)

    2. In the Skill Information section, in the **Media Type** dropdown, select **Chat**.
    ![Media type - Chat](../images/nice-in-contact-img37.png)
...
3. Create a Point of Contact.
    ...
    ![Contact settings](../images/nice-in-contact-img38.png)
        ...
        ![Point of contact is created](../images/nice-in-contact-img39.png)
...
![Chat script](../images/nice-in-contact-img40.png)

2. Under the **Properties** section, in the **TargetAgent** dropdown, select the user/group to route the agent request.
![Select user/group to route request](../images/nice-in-contact-img41.png)
