...
5. [Enable the Channel on the Platform](#step-5-enable-the-channel-on-the-platform).
...
**Important**
You must copy and store the generated **Key Secret**. You can't retrieve it again once you’ve created the key.
...
<Note>The region you select determines where your Conversation API app is hosted and where its associated data is stored. Once a region is chosen for your app, it can't be changed.
...
![configure on the platform](/ai-for-service/channels/images/paste-in-sinch-configurations.png)
...
Click **Save**.
![Platform sinch configurations](/ai-for-service/channels/images/xo-platform-sinch.png)
