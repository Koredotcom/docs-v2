...
![access keys](../images/sinch-settings-access-keys.png)
...
![copy project id](../images/copy-project-id.png)

You can also copy the **Project ID** by clicking **Conversation API** > **Overview** on the left menu.

![conversation api](../images/conersation-api-overview.png)
...
![new access key](../images/new-sinch-access-key.png)

The **Key** is created, and the *Key ID* & *Key Secret* are generated as shown in the form below.

![key id and secret](../images/key-id-and-secret.png)
...
2. On the **Conversation Apps** page, click the **NewApp** button in the **Apps** section.
    ...
    ![conversation apps](../images/conversation-apps.png)
...
Based on the region selected, capture the **Sinch region Base URL** and provide it in the configuration tab of this page. <a href="https://developers.sinch.com/docs/conversation/api-reference#base-url" target="_blank">See</a> the list of Sinch region URLs.
...
![new app id](../images/new-app-id.png)
...
![copy and save app id](../images/copy-and-save-app-id.png)
...
![add webhook](../images/add-sinch-webhook.png)

The **New webhook** form is displayed.

![new webhook form](../images/new-webhook-form.png)
...
2. Scroll down to the **Setup Channels** section.
    ...
    ![set up channels](../images/set-up-channels.png)
...
Go to **Automation AI** > **Flows & Channels** on the left navigation menu.
 ...
 ![select Sinch](../images/select-sinch.png)
...
Click **Save**.
![xo platform sinch configurations](../images/xo-platform-sinch.png)
