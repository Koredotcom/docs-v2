...
To use any Kore.ai Bot SDKs, you must first register your app to get the authentication credentials to communicate between the AI Agent and your application hosting the app. The Kore.ai bot SDKs can be used to add a chat widget to your company application that enables users to chat with the application using natural language input. The Platform interprets the user input, processes the request, and responds to the user.
