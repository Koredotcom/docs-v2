...
7. Paste these values for the **_Client ID_** and **_Client Secret_** fields.
    ...
    <Note>    Please ensure to copy and paste the **_Bot ID_** from the **Line Works Developer Console** > **Bot** page to the Platform **Configurations** section of the **Naver Works** Channel.     ![naverworks configuration](/ai-for-service/channels/images/naverworks8.png)</Note>
