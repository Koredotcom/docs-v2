...
4. On the **Manage client apps** page, copy the **Client ID** and **Client Secret** values displayed for the client app.  ![naverworks client secret](/ai-for-service/channels/images/naverworks5.png)
...
7. Paste these values for the **Client ID** and **Client Secret** fields.
    ...
    <Note>    Please ensure to copy and paste the **Bot ID** from the **Line Works Developer Console** > **Bot** page to the Platform **Configurations** section of the **Naver Works** Channel.     ![naverworks configuration](/ai-for-service/channels/images/naverworks8.png)</Note>
8. Click the **Copy** button for the **Redirect URL** field.  ![enable naverworks configuration](/ai-for-service/channels/images/naverworks9.png)
...
1. In the **Configurations** section for Naver Works on the Platform, click the **Authorize** button.  ![authorize naverworks](/ai-for-service/channels/images/naverworks12.png)
