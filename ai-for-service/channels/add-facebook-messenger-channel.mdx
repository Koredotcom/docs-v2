...
6. Select **messages**, **messaging_postbacks**, **messaging_optins**, **message_deliveries**, and **_message_reads_** in the **Edit Page Subscriptions** window to select the webhook services.
