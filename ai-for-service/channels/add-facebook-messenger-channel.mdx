...
2. [Configure the Webhook or Callback URL to send and receive messages](#step-2-configure-the-webhook-or-callback-url).
...
7. You now need to associate a page with the app. If you don't have a page, click **Create New Page** in the **Access Tokens** panel.
...
13. On the Platform, navigate to **Channels & Flows** > **Channels** > **Digital** > **All** > **Facebook Messenger**.
...
## Step 2: Configure the Webhook or Callback URL
...
2. Click the **Configurations** tab, and select **YES** for **Enable Channel**.  ![Enable Facebook channel](/ai-for-service/channels/images/fbm21.png)
