...
![ Facebook add products](../images/fbm4.png)
...
![ Facebook access token](../images/fbm5.png)

8. Click **Add or Remove Pages** and follow the instructions to add your page.
![ Facebook remove pages](../images/fbm6.png)

9. Click **Generate Token**.
![ Facebook generate token](../images/fbm7.png)

10. In the **Token Generated** window, select **I understand** and click **Copy** to copy the page Access Token.  ![ Facebook generated token](../images/fbm8.png)

11. Click **Done**.
12. Copy the **Page ID** of the Facebook page.  ![ Facebook configuration](../images/fbm9.png)

13. On the Kore.ai XO Platform, navigate to **Channels & Flows** > **Channels** > **Digital** > **All** > **Facebook Messenger**.

14. Click the **Configurations** tab, and paste the **Page Access Token** and **Page ID** values you’ve copied.  ![ Facebook page access](../images/fbm11.png)

15. Navigate to **Settings** > **Basic** and configure the **Privacy Policy URL** and **Terms of Service URL** fields for the app.
![ Facebook Privacy](../images/fbm12.png)

16. Click **Save Changes**.
17. Enable the deployment of the app by changing **App Mode: Development** to **Live**.
![ Facebook Save Changes](../images/fbm13.png)
...
![Facebook details](../images/fbm18.png)
...
![Facebook Messenger Developer](../images/fbm19.png)
...
![Facebook messenger channel](../images/fbm20.png)
...
2. Click the **Configurations** tab, and select **_YES_** for **Enable Channel**.  ![Enable Facebook channel](../images/fbm21.png)
