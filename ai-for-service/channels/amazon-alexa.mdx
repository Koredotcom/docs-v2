...
<Tip> Please enable **Account Linking** on the Kore.ai Platform under **Configurations** in the **Amazon Alexa** window. This allows AI Agent to use the access tokens from Alexa to make API calls defined in the Service nodes.</Tip>
