...
Adding the Cisco Webex Teams channel to your Kore.ai assistant is a four-step process to allow end-users to interact with it using their Webex accounts.
...
![access token](/ai-for-service/channels/images/cisco1.png)
...
8. Make a note of the **Client Id** and **Client Secret**.
      ...
      ![cisco client secret](/ai-for-service/channels/images/cisco2.png)
...
![enable cisco channel](/ai-for-service/channels/images/cisco3.png)
