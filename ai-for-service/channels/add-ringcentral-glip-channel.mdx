...
2. [App Set Up on the Platform using the Application Key and App secret](#step-2-application-set-up-on-the-platform)
...
3. Follow [these](#step-3-b--channel-setup-on-the-platform) steps to complete the configuration.
