...
![RingCentral developer Console](../images/ringcentral_glip1.png)

4. Select **REST API App** under **App Type** to call the **RingCentral REST API**.
![RingCentral REST API](../images/ringcentral_glip2.png)
...
![app properties](../images/ringcentral_glip2.png)
...
![webhook subscriptions](../images/ringcentral_glip6.png)
...
* In the following dialog window, click **Next**.
 ![sandbox account](../images/ringcentral_glip7.png)
...
![ringcentral developer application](../images/ringcentral_glip8.png)
...
![application credentials](../images/ringcentral_glip9.png)
...
6. Click **Save**.
    ...
    ![save  app](../images/ringcentral_glip11.png)
...
4. Click **+Add User**.![user extension](../images/ringcentral_glip12.png)
...
![unassigned extension](../images/ringcentral_glip13.png)
...
![team messaging](../images/ringcentral_glip14.png)
...
![enable ringcentral](../images/ringcentral_glip18.png)
...
![apply for production](../images/ringcentral_glip19.png)
