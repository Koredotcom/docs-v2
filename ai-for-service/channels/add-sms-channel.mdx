...
![SMS Channel Page](../images/sms-channel-page.png)
...
![Twilio Instructions](../images/twilio-instructions.png)
...
![SMS Channel Configured](../images/sms-channel-configured.png)
...
1. Click the Ellipsis (**⋮**) and then click **Disable**.
    ![Disable SMS Channel](../images/ellipsis.png)
