...
To add LivePerson as a channel to your Kore.ai assistant, you must add a app user in LivePerson and set up the integration. Adding the LivePerson channel to your Kore.ai assistant, allows end-users to interact with your assistant using their LivePerson account.
...
4. Enter skill name as . For example, if your **Kore.ai Assistant name** is **weather app**, then the skill name must be **weather_skill**.
