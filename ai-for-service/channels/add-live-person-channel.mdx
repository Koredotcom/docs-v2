...
![live person credentials](../images/liveperson_channel1.png)
...
![agent Workspace](../images/liveperson_channel2.png)
...
![manage users](../images/liveperson_channel3.png)
...
![skills](../images/liveperson_channel4.png)
...
![manage skills](../images/liveperson_channel4.png)

2. On the Add User page, select the **User Type** as _Bot_.
3. Enter a _Login Name_, _Email_, _Nickname_, _Employee ID_, and _Name_. (The nickname and name are displayed on the screen in the user chat.) ![nickname details](../images/liveperson_channel5.png)
...
![generate API Key](../images/liveperson_channel6.png)
...
![assignment](../images/liveperson_channel7.png)
...
![chat agent API ](../images/liveperson_channel8.png)
...
![access token](../images/liveperson_channel9.png)
...
![manage campaigns](../images/liveperson_channel10.png)
...
![Engagement Settings](../images/liveperson_channel11.png)
...
![Engagement Studio](../images/liveperson_channel12.png)
...
![manage campaigns](../images/liveperson_channel13.png)
6. On the Data Sources page, select the **Web card** and click **Edit**.
![data sources](../images/liveperson_channel14.png)
7. On the Web Tag page, copy the **embed code** and paste it into the html page you use to interact with the AI Agent.
![embed code](../images/liveperson_channel15.png)
8. Send a message from the _LivePerson Chat_ console to the AI Agent for which you have enabled the LivePerson channel.
9. In the XO Platform, once you receive a message from the **LivePerson Agent** console, you can send a response to start communication between the two systems, as shown below.  ![liveperson agent console](../images/liveperson_channel16.png)