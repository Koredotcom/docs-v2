---
title: Multiple Phone Numbers Support in the WhatsApp Channel
sidebarTitle: Multiple Phone Numbers Support in the WhatsApp Channel
noindex: true
hidden: true
mode: center
---
...
<Note>The user can add a **maximum of 20 phone numbers** to the list after which the Phone Number input field is disabled.</Note>

![alt_text](/ai-for-service/channels/images/wbm5.png)

* The user can remove/delete a phone number from the configured list to stop receiving messages.
* An alert message is displayed when you add a phone number that's already in use (configured on the Platform) as shown below:

    ![alt_text](/ai-for-service/channels/images/wbm6.png )

## Adding a Phone Number

To add a new phone number on the Platform to message via WhatsApp for Infobip, follow the steps below:
...
![alt_text](/ai-for-service/channels/images/wbm3.png )
