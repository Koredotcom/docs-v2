...
6. **On the Platform**
    ...
    ![alt_text](/ai-for-service/channels/images/genesys_m5.png)
...
1. Click the **Create App** link under the **Configurations** section of the **Genesys Cloud CX Messaging** Channel.
    ...
    ![alt_text](/ai-for-service/channels/images/genesys_cloud_2.1.png  )
...
2. Use the **Client ID** and **Client Secret** value of the new app to create a JWT token using the steps mentioned[ here](/ai-for-service/channels/add-wechat-channel).
    ...
    ![alt_text](/ai-for-service/channels/images/genesys_cloud_2.2.png  )
...
3. Add or update the Metadata Transfer Keys (slot variables), and then save the configuration. When you save the configuration, the Platform publishes the updated Bot List Schema to Genesys. Example slot variables:
    * `name`
    * `email`
4. In the Genesys Architect portal, verify that the updated slots appear under the **Default Kore Agent Intent** action.
5. Map the slots to Architect flow variables. Example mappings:
