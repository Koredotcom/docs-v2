---
title: Adding Instagram Channel
sidebarTitle: Adding Instagram Channel
noindex: true
---
...
You can set up the Instagram channel on the Platform to enable users to interact with your AI Agent using their Instagram accounts.
...
The app serves as the connection point between the Platform and Instagram.
...
6. Click **Create App**. This might ask for your authentication. After authentication, the app is created, and the **Add Products to Your App** page is displayed.
    ![Instagram](/ai-for-service/channels/images/insta4.png)
...
The app's configuration settings from the Meta for Developers portal are used in the Platform.
...
![Instagram](/ai-for-service/channels/images/insta1.png)

3. Select the I Understand checkbox. The token appears.

    <Note>    Copy the token as required while configuring the Messenger channel in the Platform.</Note>
4. Click **Done**.
5. Copy the following configuration settings from the Meta for Developers portal, as these are required in the Platform.
...
Configure the Platform's Webhook callback URL in the Meta app. This allows the Platform to receive and respond to Instagram messages and interactions in real-time.

1. In the Meta Developer portal, navigate to your **My App** > **Created App** > **Products** > **Messenger** > **Instagram Settings**.
2. In the Webhooks section, click **Add CallBack URL**. The Edit Callback URL pop-up prompts for the information required to configure the Webhook between your app and the Platform.
3. In the Platform, select the assistant and go to **Channels & Flows** > **Channels** > **Digital** > **All** > **Instagram** > **Configurations tab**. Copy the “Webhook URL” and “Verify Token”.
...
![Instagram](/ai-for-service/channels/images/insta5.png)

5. Click **Verify and Save**.
6. In the Webhooks section, click **Edit Subscriptions**. Select all the action fields and click **Save**. If the actions aren't subscribed after clicking on the save, click the **Webhooks** > **Subscribe button** displayed against the associated **Facebook Page**.
![Instagram](/ai-for-service/channels/images/insta2.png)

7. In the Platform, select the AI Agent and go to **Channels & Flows** > **Channels** > **Digital** > **All** > **Instagram** > **Configurations tab**.
![Instagram](/ai-for-service/channels/images/insta3.png)
...
<Note>Add testers to test the Instagram channel before submitting the app for approval. To add, navigate to **App** > **App roles** > **Add People** > **Tester**.</Note>
After enabling the channel and verifying all the configurations, you can publish the app for the new channel. Learn more about [Publishing your App](/ai-for-service/deployment/publishing-app).
