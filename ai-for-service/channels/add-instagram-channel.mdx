...
3. Select the I Understand checkbox. The token appears.
    ...
    <Note>    Copy the token as required while configuring the Messenger channel in the Kore.ai Platform.</Note>
4. Click **Done**.
...
Configure the XO platform's Webhook callback URL in the Meta app. This allows the Platform to receive and respond to Instagram messages and interactions in real-time.
...
After enabling the channel and verifying all the configurations, you can publish the assistant for the new channel. Learn more about [Publishing your App](/ai-for-service/deployment/publishing-app).
