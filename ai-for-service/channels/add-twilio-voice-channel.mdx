---
title: Adding the Twilio Voice Channel
sidebarTitle: Adding the Twilio Voice Channel
noindex: true
---
<Badge icon="arrow-left" color="gray">[Back to Third-Party Voice](/ai-for-service/channels#voice-channels)</Badge>

To add Twilio Voice as a channel to your AI Agent, you must get a Twilio phone number and set up a webhook integration to communicate with the AI Agent.
...
* Twilio Voice doesn't support enterprise AI Agents that require user authorization to communicate.
* Tasks that require the user's authorization to communicate with external systems must not be included.
* Webhook Nodes work asynchronously and aren't supported on Twilio Voice.
...
![Automations](/ai-for-service/channels/images/twv1.png)
...
1. In the Platform, go to **Channels & Flows** > **Channels** > **Third Party Voice** > **All** > **Twilio Voice**.
2. To complete the Channel setup, go to the **Configurations** tab and pursue the following steps:
    1. Enter your Twilio Number to associate with the AI Agent.
    ...
    ![Automations](/ai-for-service/channels/images/twv3.png)
3. From the **Voice Call Properties** tab, enter the details to configure the channel-level voice properties. Click [here for more details](/ai-for-service/automation/agent-flows#voice-call-properties).

### Related Links

For details regarding the configuration of voice properties at the Dialog Task level, refer to [Configuring Voice Call Settings for a Node](/ai-for-service/automation/agent-flows#voice-call-properties).
