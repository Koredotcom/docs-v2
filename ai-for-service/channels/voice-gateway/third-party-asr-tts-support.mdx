...
| Custom | IST TTS | - | - | - | - | - |
| Custom | Emotech TTS | - | - | - | - |
| Custom | MiniMax AI TTS | - | - | - | - |

<Note>MiniMax AI TTS is a custom TTS provider that isn't available by default. To use it, contact [Support](https://support.kore.ai).</Note>
