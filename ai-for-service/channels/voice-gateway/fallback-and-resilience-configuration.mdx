...
1. Open Error Handling within the Automation Node to define how Voice Gateway responds when a component failure affects an active call.
2. To end the call gracefully, configure a message for the system to play to the caller before it disconnects the call.
