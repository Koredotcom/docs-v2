...
- Still records the utterance in the conversation transcript, marked as a backchannel.

**Configuration**

To set `backchannel` Words at the app level or the channel level. Channel-level values override app-level values for that channel. Node-level configuration isn’t supported.
