...
<Note>Treat the ElevenLabs API key as a password. Share it only through secure support tickets and do not include it in screenshots, logs, or public channels.</Note>
