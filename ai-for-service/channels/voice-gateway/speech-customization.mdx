...
Voice Gateway supports custom voices cloned in ElevenLabs. To activate a cloned voice for your agent, share your ElevenLabs API credentials with the Support team. Once integration is complete, you can enable the voice through call control parameters-no redeployment required.
...
1. Raise a support ticket with your credentials: Submit a support ticket with your API key, the team completes the integration on your account and shares the new label name.
