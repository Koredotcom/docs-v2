...
| - | `52.220.160.153` | `10.155.5.10` | - | [sg-prod-korevg-sbc1.kore.ai](http://sg-prod-korevg-sbc1.kore.ai) |
| `sg-prd-korevg-siprtp-2` | `13.215.50.35` | `10.155.6.230` | ap-southeast-1b | - |
| - | `18.136.127.58` | `10.155.6.210` | - | [sg-prod-korevg-sbc2.kore.ai](http://sg-prod-korevg-sbc2.kore.ai) |
| `sg-prd-korevg-web-server-blue-1` | - | `10.155.77.112` | ap-southeast-1a | [sg-prod-korevg-webserver.kore.ai](http://sg-prod-korevg-webserver.kore.ai) |
| `sg-prd-korevg-web-server-blue-2` | - | - | ap-southeast-1b | [sg-prod-korevg-grafana.kore.ai](http://sg-prod-korevg-grafana.kore.ai) |
| `sg-prd-korevg-monitoring-server-blue` | - | `10.155.77.194` | ap-southeast-1a | [sg-prod-korevg-homer.kore.ai](http://sg-prod-korevg-homer.kore.ai) |
| - | - | - | - | [sg-prod-korevg-jaeger.kore.ai](http://sg-prod-korevg-jaeger.kore.ai) |
| `sg-prd-korevg-recorder-blue-1` | - | `10.155.82.177` | ap-southeast-1b | [sg-prod-korevg-rec1.kore.ai](http://sg-prod-korevg-rec1.kore.ai) |
| `sg-prd-korevg-recorder-blue-2` | - | `10.155.81.222` | ap-southeast-1a | [sg-prod-korevg-rec2.kore.ai](http://sg-prod-korevg-rec2.kore.ai) |
...
* Per the [firewall requirements](/ai-for-service/channels/voice-gateway/minimum-system-requirements-and-supported-browsers#firewall-requirements), will you be able to whitelist and let the traffic to all IP addresses and domains (SBCs, STUN/TURN, etc.)?
    - [ ] Yes
    - [ ] No
