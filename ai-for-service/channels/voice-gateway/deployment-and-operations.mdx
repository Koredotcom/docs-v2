...
![Call Flow Diagram](../images/call-flow-diagram.png)

### Agent Desktop Architecture (Client Inside Firewall-Asymmetric NAT)

![Agent Desktop Architecture-Asymmetric](../images/agent-desktop-architecture.png)

### Agent Desktop Architecture (Client Inside Firewall-Symmetric NAT)

![Agent Desktop Architecture-Symmetric](../images/agent-desktop-architecture-symmetric.png)
