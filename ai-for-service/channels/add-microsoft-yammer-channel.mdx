...
3. **Authorize**- You must Authorize the app from the **Configurations** tab on the Yammer Channel page in the app builder. This allows you to generate a developer access token to enable the Kore.ai Assistant platform to access the app.
...
6. Click **Continue** to create the app.  ![add Yammer channel](/ai-for-service/channels/images/Yammer-1.png)

7. After app creation, you are redirected to the **App Details** page. Capture the **Client ID** and **Client Secret** of your Yammer channel and provide them in the **Configurations** tab of LINE channel page.  ![yammer configurations](/ai-for-service/channels/images/Yammer-2.png)
...
![deploy yammer](/ai-for-service/channels/images/Yammer-3.png)
