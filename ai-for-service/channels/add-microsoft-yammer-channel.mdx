...
3. **Authorize**- You must Authorize the app from the **Configurations** tab on the Yammer Channel page in the app builder. This allows you to generate a developer access token to enable the AI Agent to access the app.
