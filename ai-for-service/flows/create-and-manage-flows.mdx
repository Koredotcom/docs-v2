...
| [Check Agent Availability](/ai-for-service/flows/node-types/check-agent-availability) | Voice, Chat | Route based on agent availability filtered by skill set. (Experimental — may be deprecated.)_ |
