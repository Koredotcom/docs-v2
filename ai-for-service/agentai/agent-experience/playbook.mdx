...
Playbooks are organized into **Stages** (primary groupings) and **Steps** (tasks within each stage). Primary playbooks have Open and Close stages by default. For Dynamic playbooks, you add stages manually.
