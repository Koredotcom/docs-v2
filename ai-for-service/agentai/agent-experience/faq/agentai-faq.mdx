...
4. Add the following context variable in the script field:
   ...
   ![Edit Script](/ai-for-service/agentai/agent-experience/faq/faq/edit-script.png)
...
4. Select **Save**.
   ...
   ![Welcome Events Extract Intents](/ai-for-service/agentai/agent-experience/faq/faq/welcome-events-extract-intents.png)
