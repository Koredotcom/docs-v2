...
6. Turn on the Intermittent Summary toggle. 
    <Note> Ensure **Generate Intermittent Summary** is on in [Widget Theming](/ai-for-service/agentai/configuration/widget-theming-layout-customization.mdx). </Note>
...
2. Select **Save**.
    ...
    <Note> To use the Custom Dialog Task, you must disable the Configure End of Conversation Dialog Task. </Note>
