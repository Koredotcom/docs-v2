...
3. Turn on the **Agentic Copilot** toggle if it's off.
...
3. Turn on the **Agent AI Mapping** toggle if it's off.
4. Select **Add Queue**.
5. Select the queues to add. Previously added queues don't appear unless deleted from the dashboard.
