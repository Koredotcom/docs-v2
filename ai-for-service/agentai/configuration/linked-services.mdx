...
| Option | Description |
|--------|-------------|
| **None** | Disables Search AI, and the search results come only from the configured bot. |
...
9. Expand the **Knowledge AI** section (shows only if you selected **Internal Information** or **External Information**). 
...
<Note>You can't delete an app that is currently in use. The delete button is unavailable, and a badge indicates the app is active.</Note>
