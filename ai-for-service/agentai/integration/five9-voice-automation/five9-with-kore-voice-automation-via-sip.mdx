...
3. Create or edit an Experience flow for Voice Automation from **Flows & Channels** > **Start Flows**:
    ![experience-flow](/ai-for-service/agentai/integration/five9-voice-automation/images/experience-flow.png)
...
![configure-agent-transfer](/ai-for-service/agentai/integration/five9-voice-automation/images/configure-agent-transfer.png)
...
5. Select **SIP Transport Type** as **UDP**.
    ![configure-sip-trunk](/ai-for-service/agentai/integration/five9-voice-automation/images/configure-sip-trunk.png)
...
2. Under **IVR Scripts**, right-click and select **Add IVR Script**. 
    ![add-ivr-script](/ai-for-service/agentai/integration/five9-voice-automation/images/add-ivr-script.png)
3. In the **IVR Flow**, soon after the Incoming Call Module, use **Set Variable Module** to set the DID number (see [SIP Trunk Provisioning](#sip-trunk-provisioning)), SIP URI (see [SIP Trunk-Agent AI](#sip-trunk-agent-ai)), and the BotID (see [Add Agent Assist Hub](/ai-for-service/agentai/integration/nice-agent-desktop-voice/nice-agent-desktop-voice#step-1-nice-cx-integration-hubs-%3E-add-agent-assist-hub)). 
    ![set-variable-module-properties](/ai-for-service/agentai/integration/five9-voice-automation/images/set-variable-module-properties.png)

4. Use **3rd-Party Transfer Module** to transfer the call to Kore Voice Automation. 
    ![third-party-transfer-module](/ai-for-service/agentai/integration/five9-voice-automation/images/third-party-transfer-module.png)

5. Use **Case Module** to transfer the call back to a skill, to an agent, or to hang up. 
    ![case-module-properties](/ai-for-service/agentai/integration/five9-voice-automation/images/case-module-properties.png)
...
![interaction-details](/ai-for-service/agentai/integration/five9-voice-automation/images/interaction-details.png) 
