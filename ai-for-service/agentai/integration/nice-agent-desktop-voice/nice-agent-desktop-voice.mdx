...
6. Update the values for the corresponding parameters:
    ...
    2. **Custom Data**: Use the `customdata` object in the script to pass information to the AI Agent. During runtime, this custom data is accessible in the `UserContext` of the AI Agent. Refer to [Access Custom Data in Agent AI Bot](/ai-for-service/agentai/agent-experience/access-custom-data-in-agent-ai) for instructions on how to access custom data in the AI Agent.
