---
title: Amazon Connect CCP Integration: Agent AI Chat
sidebarTitle: Amazon Connect CCP Integration: Agent AI Chat
---
...
| **Custom Contact Control Panel (CCP)** | - A supported br /owser (the latest version of Chrome is recommended, as Firefox may have limitations with Webr /TC/media). For details, refer to [AWS documentation](https://docs.aws.amazon.com/connect/latest/adminguide/connect-supported-br /owsers.html).<br />- Workstations meeting minimum CPU, RAM, and network bandwidth requirements for CCP usage.<br />- Network/firewall rules allowing outbound HTTPS (443), Webr /TC domains/ports, and host domains for the custom CCP.<br />- Valid SSL certificates if hosting the CCP outside the Amazon Connect domain. |
...
> **Note:** Lambda, Kinesis, and streaming services are not required for chat-only integrations.
...
2. Go to **Channels** > **Communication widget**.
    1. The default widget is available here. Create a new widget by clicking **Add widget**.
...
3. Click the required widget.
    2. The JavaScript sample code to run the widget on your local device is shown here. Copy the code.
