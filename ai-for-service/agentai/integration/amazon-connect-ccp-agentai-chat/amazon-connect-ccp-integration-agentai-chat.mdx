...
<Note>Lambda, Kinesis, and streaming services aren't required for chat-only integrations.</Note>
...
5. After entering the **local host URL**, you see the following screen:
...
5. You see the following screen for the chat widget:
