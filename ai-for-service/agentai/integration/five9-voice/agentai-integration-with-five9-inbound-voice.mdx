...
You have a skill named Chat_Skill, that handles incoming chat requests, and you want the Agent AI widget to render for conversations routed to this skill. You must create the following details of the third-party configuration record in your Agent AI account:
    ...
    Ensure the Third-Party Configuration setting is turned on in **Agent AI** > **Configurations** > **Widget Settings** > **Agent AI Settings** > **Agent AI General Settings**.
...
12. Enter **Name** as **accountid** and the **Value** must be the **accountid** of your Agent AI account. Find this ID by navigating to **Agent AI** > **Flows & Channels** > **Channels** > **Digital** > **Web/Mobile Client** > **JWT App Details**. Refer to this **[doc](/ai-for-service/channels/add-web-mobile-client#adding-the-web-mobile-client-channel)**.
...
8. Click **Done**.
10. Configure the **Trust Token** (provided by Kore) while creating the subscription. It's validated at Kore by call event get API.
