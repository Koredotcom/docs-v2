...
| Capture AI Agent Information in Kore Data Table | Algorithm | Algorithm assigned to the Client App. | Currently, `HS256` algorithm is the only supported value. So, the **algorithm** value is **HS256**. |
