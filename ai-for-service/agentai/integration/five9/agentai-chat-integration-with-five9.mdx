...
* One Skill or Campaign can't be mapped to multiple Agent AI bots.
</Note>
...
6. Don't select anything in the **Numbers** section, and click **Next**.
...
* Custom Data and Secure Custom Data passing isn't supported.
* Internal Transfers aren't supported as the widget can't be rendered for other agents joining the conversation, as the Five9 connector is getting disabled for other agents.
* **Concurrent Chats Limitation**: Customer messages or summary events for a specific chat are delivered to the Agent AI widget only when that chat window is active. If the agent navigates to a different chat, any new messages or events of the previous chat won't be captured and delivered to the widget.
