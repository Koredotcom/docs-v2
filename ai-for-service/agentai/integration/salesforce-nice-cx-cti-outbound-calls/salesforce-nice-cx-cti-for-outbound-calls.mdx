...
| Set up NICE AgentAssist Hub to stream voice to Kore Agent AI | Voice Gateway (VG) | For SaaS in US region, value is savg-webserver.kore.ai. For on-prem, refer to the corresponding host. | |
