...
* Have the AI Agent credentials saved separately. You need the Widget URL, Bot ID, Client ID, Client Secret, Account ID, and SIP URI. Read [Voice Gateway](/ai-for-service/channels/voice-gateway/configure-voice-gateway#steps-to-configure-sip-trunk) and [Chat](/ai-for-service/channels/add-web-mobile-client#add-webmobile-client-channel) for a walkthrough.
...
|---|---|---|---|
| Set up NICE AgentAssist Hub to stream voice to Agent AI | Agent AI URL | The domain of the Agent AI. | If it's legacy Agent AI, the URL is [https://agentassist.kore.ai](https://agentassist.kore.ai).<br />If it's AI for Service, URL is `https://platform.kore.ai`.<br />If it's on-prem, the URL is the origin where your Agent AI is hosted. |
...
Download Script For Voice: [xml script](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/assets/nicecti-sf-voice.xml) or [json script](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/assets/nicecti-sf-chat.json)
...
| **Custom Data**      | The **customdata** object in the script can be used to pass information to the AI Agent. During runtime, this custom data is accessible in the UserContext of the AI Agent.<br />Refer to [Access Custom Data in Kore AI Agent](/ai-for-service/agentai/agent-experience#access-custom-data) for instructions on how to access custom data in the AI Agent. | Include your data in the customdata object (one key-value pair per line). For example:<br /> `customdata.agentName="Agent"`<br /> `customdata.agentID="{agentid}"` |
...
Download Script For Chat: [xml script](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/assets/nicecti-sf-chat.xml) or [json script](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/assets/nicecti-sf-chat.json) 
...
| **ReqAgent**         | Update Skill for Agent Routing                                  | Skill and other attributes as needed                                                                                                                                                                                                                                                        |
| **Custom Data**      | The **customdata** object in the script can be used to pass information to the AI Agent. During runtime, this customdata is accessible in the UserContext of the AI Agent.<br /> Refer to [Access Custom Data in Kore AI Agent](/ai-for-service/agentai/agent-experience#access-custom-data) for instructions on how to access custom data in the AI Agent. | Include your data in the customdata object (one key-value pair per line). For example:<br /> `customdata.agentName="Agent"`<br /> `customdata.agentID="{agentid}"`                                                                                                            |
| **AgentAssist**      | Map the AgentAssist Hub Instance                                 | Select the AgentAssist Hub App created in the above step.                                                                                                                                                                          |
