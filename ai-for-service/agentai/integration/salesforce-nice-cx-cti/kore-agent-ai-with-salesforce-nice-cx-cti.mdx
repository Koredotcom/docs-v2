...
|---|---|---|---|
| Set up NICE AgentAssist Hub to stream voice to Agent AI | Agent AI URL | The domain of the Agent AI. | If it is legacy Agent AI, the URL is [https://agentassist.kore.ai](https://agentassist.kore.ai).<br />If it is AI for Service, URL is `https://platform.kore.ai`.<br />If it is on-prem, the URL is the origin where your Agent AI is hosted. |
