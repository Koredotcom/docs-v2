...
![summary-template-assist](/ai-for-service/agentai/integration/websdk/images/summary-template-assist.png)
...
Displays the main loader during widget initialization — before landing on the default view.
...
```
![conversation-summary](/ai-for-service/agentai/integration/websdk/images/conversation-summary.png)
