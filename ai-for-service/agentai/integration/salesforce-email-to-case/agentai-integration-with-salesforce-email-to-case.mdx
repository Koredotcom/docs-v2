---
title: Agent AI Integration with Salesforce Email-to-Case
sidebarTitle: Agent AI Integration with Salesforce Email-to-Case
---
...
* Salesforce Email-to-Case is configured. Refer to [Set up Email-to-Case](https://help.salesforce.com/s/articleView?id=service.setting_up_email-to-case.htm&type=5) for help.
* [Agent AI Salesforce](https://appexchange.salesforce.com/appxListingDetail?listingId=a0N4V00000HSGlnUAH) package is installed in your Salesforce organization.
...
4. Select **New** from the top-right corner of the page.
    ![agentai-configuration-page](/ai-for-service/agentai/integration/salesforce-email-to-case/images/agentai-configuration-page_1.png)
...
5. Enter the required values in the **Agent AI URL**, **Bot ID**, **Client ID,** **Client Secret**, and **Language (bot language)** fields. To get these values:
    ...
    4. Select the **copy** buttons against the required fields.
        ![jwt-app-details-section](/ai-for-service/agentai/integration/salesforce-email-to-case/images/jwt-app-details-section_2.png)
...
6. Select **Generate Summary in Agent AI with External API Data** to generate both the Landing Summary and Intermittent Summary within the Agent AI widget using external data.
    ![api-with-external-data](/ai-for-service/agentai/integration/salesforce-email-to-case/images/api-with-external-data_3.png)
...
* **Client ID**: Create an OAuth app by referring to the [Create an External Client App for the OAuth 2.0 Client Credentials Flow](https://developer.salesforce.com/docs/industries/loyalty/guide/authorization.html) doc. Enter the OAuth Consumer Key that is used to authenticate the API request.
...
1. Go to **App Launcher** and select **Cases**.
    ![app-launcher-cases](/ai-for-service/agentai/integration/salesforce-email-to-case/images/app-launcher-cases_4.png)

2. Open any record of cases.
3. Click the **gear** icon in the top-right corner, and then select **Edit Page**.
    ![edit-page](/ai-for-service/agentai/integration/salesforce-email-to-case/images/edit-page_5.png)

4. Under the **Custom-Managed** components, find the **OmniChannel_AgentAIEmail** component.
    ![custom-managed-omnichannel-agentai-email](/ai-for-service/agentai/integration/salesforce-email-to-case/images/custom-managed-omnichannel-agentai-email_6.png)

5. Drag and drop the component on the **Case** page.
    ![case-page](/ai-for-service/agentai/integration/salesforce-email-to-case/images/case-page_7.png)
...
1. The customer sends an email to the address configured under **Routing Addresses** in Email-to-Case.
    ![email-to-case-page](/ai-for-service/agentai/integration/salesforce-email-to-case/images/email-to-case-page_8.png)
...
3. After the case is opened, the Agent AI widget appears in the location where it was placed during setup in the [previous step](#add-component-to-the-case-page).
    ![agentai-widget](/ai-for-service/agentai/integration/salesforce-email-to-case/images/agentai-widget_9.png)
    ...
    ![landing-summary](/ai-for-service/agentai/integration/salesforce-email-to-case/images/landing-summary_10.png)
...
6. Select the **Submit** button to save the summary in one of the custom objects in Salesforce. To access these summaries, search for **Kore NonCTI AgentAI Conversation Summary** in the **App Launcher**.
    ![kore-noncti-agentai-conversation-summary](/ai-for-service/agentai/integration/salesforce-email-to-case/images/kore-noncti-agentai-conversation-summary_11.png)
