...
9. Click **Set contact attributes**, and enter the required fields:
    ...
    * **SipUri**: Add `sip:XXXX@savg-us-prod-sbc-in-nlb-0d9a4c651955ff47.elb.us-east-1.amazonaws.com` and replace **XXXX** with your SIPREC Configuration of Agent AI.
    ...
    8. Click **Save**.
    9. For **Transfer to Flow**, select a flow to route the user to. For example, save [KVSQueueFlow.json](/ai-for-service/assets/kvs-queue-flow.json) in a file, import this flow to **Flows**, and add **Queue** details for routing.
