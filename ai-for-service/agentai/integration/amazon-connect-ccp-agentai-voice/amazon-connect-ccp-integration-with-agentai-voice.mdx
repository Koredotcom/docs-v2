...
|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **AWS / Amazon Connect** | - An Amazon Connect instance with Administrator privileges.<br />- The instance must be in a region that supports the required services, such as Kinesis Video Streams and Lambda.<br />- If using Telephony: claimed phone numbers (DID or toll-free) as needed. |
...
9. Click **Set contact attributes**, and enter the required fields:
    ...
    * **SipUri**: Add `sip:XXXX@savg-us-prod-sbc-in-nlb-0d9a4c651955ff47.elb.us-east-1.amazonaws.com` and replace **XXXX** with your SIPREC Configuration of Agent AI.
    ...
    8. Click **Save**.
    9. For **Transfer to Flow**, select a flow to route the user to. For example, save [KVSQueueFlow.json](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/assets/kvs-queue-flow.json) in a file, import this flow to **Flows**, and add **Queue** details for routing.
