...
| Nice CX Integration Hubs > Add Agent Assist App | Voice Gateway(VG) | For Saas in US region, value is wss://savg-webserver.kore.ai. For on-prem, refer to corresponding host. | |
