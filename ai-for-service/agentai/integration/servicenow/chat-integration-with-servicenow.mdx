...
* Roles and Permissions:
    ...
    * XO Platform (Optional): Required only if you are doing an Agent Transfer from XO Platform to ServiceNow. For more information, refer to [Configuring the ServiceNow Agent - Utah and Higher versions](/ai-for-service/integrations/agents/servicenow/configuring-the-servicenow-agent-utah-and-vancouver).
