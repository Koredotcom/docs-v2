...
<Note>Before selecting an extraction strategy, verify that it supports the languages in your content. Support varies by extraction method. For details, see [Language-Specific Extraction Capabilities](/ai-for-service/searchai/tips-and-faqs#language-specific-extraction-capabilities).</Note>
...
Training prepares your content for search by processing the ingested data, applying configurations, generating embeddings, and building the search index.

Run training whenever you add new content or update search configurations to ensure the latest changes are reflected in search results.

Learn more about [Full vs. Incremental Training and Automatic vs. Manual Training](/ai-for-service/searchai/tips-and-faqs#application-training). 
...
- [Content Sources Documentation](/ai-for-service/searchai/content-sources)
- [Answer Generation](/ai-for-service/searchai/retrieval-answer-configuration)
- [Retrieval Strategies](/ai-for-service/searchai/retrieval-answer-configuration)
- [GenAI Tools - Models Library](/ai-for-service/generative-ai-tools/llm-integration)
