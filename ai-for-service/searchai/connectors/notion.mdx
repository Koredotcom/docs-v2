...
2. Under the **Configuration** tab of the integration, enable the following capabilities:
   ...
   ![Capabilities](/ai-for-service/searchai/connectors/images/notion/capabilities.png "Capabilities")
...
Use the [Permission Entity APIs](/ai-for-service/apis/searchai/permission-entity-apis) to associate users with this permission entity.
