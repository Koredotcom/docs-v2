...
| Supported content | Issues, Pull Requests, README files, md, mdx, mdoc, mdc, rst, adoc, asciidoc, txt, xlsx, xls, html |
| RACL support | Yes |
...
![alt_text](/ai-for-service/searchai/connectors/images/github/permissions.png "Permissions")
