...
2. Under **Tokens**, click **New Token**.
   ...
   ![Token Generation](/ai-for-service/searchai/connectors/images/youtrack/new-token.png "Token Generation")

3. Enter a name for the token and save the generated value.

   ![Token Generation](/ai-for-service/searchai/connectors/images/youtrack/create-token.png "Token Generation")
