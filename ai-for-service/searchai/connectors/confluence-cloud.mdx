...
| blog_created   | New blog post created                |
| blog_updated   | Blog post content modified           |
| blog_removed   | Blog post permanently deleted        |
| blog_trashed   | Blog post moved to trash             |
| blog_restored  | Blog post restored from trash        |
