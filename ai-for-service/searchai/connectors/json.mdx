...
1. Go to **Content** > **Connectors** and add the **JSON Connector**.
   ...
   ![Home](/ai-for-service/searchai/connectors/images/json/home.png "Home")
...
2. Select the source name to upload the JSON content to. If no source exists, create a new one. Upload the JSON file with your structured data.
   ...
   ![Configure](/ai-for-service/searchai/connectors/images/json/configure.png "Configure")
...
4. Click the **Files** tab to view the contents of the connector at any time.
   ...
   ![Files](/ai-for-service/searchai/connectors/images/json/files.png "Files")
...
![Add Files](/ai-for-service/searchai/connectors/images/json/add-files.png "Add Files")
