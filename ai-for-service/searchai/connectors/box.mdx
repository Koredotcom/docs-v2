...
| Supported content | .pdf, .docx, .ppt, .txt |
| RACL support | Yes |
...
2. Go to **My Apps** and click **Create New App**.
    ...
    ![New App](/ai-for-service/searchai/connectors/images/box/createnewapp.png "New App")

3. Create a **Custom App**:
   - Enter the app name, description, and purpose.

    ![Configuration](/ai-for-service/searchai/connectors/images/box/step1.png "Configuration")

   - Select **User Authentication (OAuth 2.0)** and click **Create App**.

    ![Configuration](/ai-for-service/searchai/connectors/images/box/step2.png "Configuration")
...
2. Select **Box Connector** and provide the following configuration details.
    ...
    ![Configuration](/ai-for-service/searchai/connectors/images/box/configure-connector.png "Configuration")
