...
![alt_text](/ai-for-service/searchai/connectors/images/zendesk/admin-center.png "Admin Center")
...
```json
"sys_racl": [
    "john.doe@example.com",      // assignee of the ticket
    "customer@example.com",         // submitter of the ticket
    "jane.doe@example.com",     // collaborator on the ticket
