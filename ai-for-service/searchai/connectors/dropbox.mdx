...
2. Create a new app. Under **Choose an API**, select **Scoped access** and choose the appropriate access type.
   ...
   ![alt_text](/ai-for-service/searchai/connectors/images/dropbox/create-app.png "Create App")
...
4. Open the **Permissions** tab (or click **Scoped App**) and enable the following minimum permissions:
   ...
   ![App permissions](/ai-for-service/searchai/connectors/images/dropbox/app-permissions.png "App permissions")

   ![Permissions](/ai-for-service/searchai/connectors/images/dropbox/permissions-types.png "Permissions")
...
5. On the **Settings** tab, set the **Redirect URI** to the URL matching your deployment region:
   ...
   ![Redirect URL](/ai-for-service/searchai/connectors/images/dropbox/redirect-url.png "Redirect URI")

6. Save the **App key** and **App secret** shown on the settings page. These are required in Step 2.

   ![App credentials](/ai-for-service/searchai/connectors/images/dropbox/app-credentials.png "App Credentials")
