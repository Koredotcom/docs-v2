...
![Drive Home](/ai-for-service/searchai/connectors/images/onedrive/onedrive.png "Drive Home")

The following shows content ingested after a sync operation through the OneDrive connector:

![Content](/ai-for-service/searchai/connectors/images/onedrive/content.png "Content")
...
![Access](/ai-for-service/searchai/connectors/images/onedrive/shareaccess.png "Access")

Files can also be shared via link:

![Access](/ai-for-service/searchai/connectors/images/onedrive/sharelink.png "Access")
...
**Example**: If John owns a file and shared it with a user group `team@example.com` and external user `jane.doe@example.com`, the `sys_racl` field appears as:
...
If John also grants access to all employees in his organization, the field includes the domain:
