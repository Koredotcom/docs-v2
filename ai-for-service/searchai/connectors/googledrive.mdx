...
8. Set the publishing status. In **Testing** mode, only added test users can access the app. In **Production** mode, the app is available to all Google account users.
   ...
   ![Publishing Status](/ai-for-service/searchai/connectors/images/googledrive/publishing-status.png "Publishing Status")

   To add test users in Testing mode, click **ADD USERS** on the same page.

   ![Add Users](/ai-for-service/searchai/connectors/images/googledrive/add-users.png "Add Users")
...
![Content](/ai-for-service/searchai/connectors/images/googledrive/content-tab.png "Content")
...
![Configuration](/ai-for-service/searchai/connectors/images/googledrive/config-tab.png "Configuration")
...
- Add multiple rules to a filter. For example, include all files from a specific folder and all files containing a keyword in the filename.
  ...
  ![Example](/ai-for-service/searchai/connectors/images/googledrive/example2.png "Example")

- Add multiple conditions to a single rule to narrow results. For example, ingest only PDF files from a specific folder.

  ![Example](/ai-for-service/searchai/connectors/images/googledrive/example3.png "Example")
...
![People With Access](/ai-for-service/searchai/connectors/images/googledrive/racl/example1.png "Example")

Example — a user and a user group with access (where `hr-team@example.com` is the permission entity for the group):

![User Groups](/ai-for-service/searchai/connectors/images/googledrive/racl/example2.png "User Groups")

**Anyone with link**

Treated as public access. All users can access files with this permission type.

![Anyone with Link](/ai-for-service/searchai/connectors/images/googledrive/racl/example3.png "Anyone with Link")

**Domain-specific access**

Search AI supports domain-scoped access and verifies user identity against the specified domain.

![Domain level Access](/ai-for-service/searchai/connectors/images/googledrive/racl/example4.png "Domain Level Access")
...
Use the [Permission Entity API](/ai-for-service/apis/searchai/permission-entity-apis) to add user IDs to the corresponding permission entity.
...
![Permissions Config](/ai-for-service/searchai/connectors/images/googledrive/racl/permissions.png "RACL Enable")
