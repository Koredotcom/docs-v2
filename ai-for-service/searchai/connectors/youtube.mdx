...
Each synced video is converted into a single **markdown document**. The following key fields are extracted and indexed.
...
> **Tip:** If you have a large channel (hundreds of videos with transcripts), consider requesting a quota increase from Google through the [Cloud Console Quotas page](https://console.cloud.google.com/iam-admin/quotas).
