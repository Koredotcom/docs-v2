...
![ServiceNow Authorization](/ai-for-service/searchai/connectors/images/servicenow/auth-tab.png "ServiceNow Authorization")
...
The connector supports incremental synchronization. Instead of performing a full content sync on every run, the connector fetches only records that has created or updated since the last successful sync, using the `sys_updated_on` field on the corresponding ServiceNow table.
...
![Configuration](/ai-for-service/searchai/connectors/images/servicenow/config-tab.png "Configuration")

Example — ingest articles with a specific sys ID:

![Example](/ai-for-service/searchai/connectors/images/servicenow/example1.png "Example")
...
- **Multiple rules** — Define one or more rules. Content matching any rule is ingested (logical OR).
  ...
  ![Example](/ai-for-service/searchai/connectors/images/servicenow/example2.png "Example")
...
- **Multiple conditions** — Each rule can have one or more conditions joined by logical AND. Content is selected only when all conditions are satisfied.
  ...
  ![Example](/ai-for-service/searchai/connectors/images/servicenow/example3.png "Example")
...
![User criteria](/ai-for-service/searchai/connectors/images/servicenow/racl/user-criteria.png "User criteria")
...
![Individual Users](/ai-for-service/searchai/connectors/images/servicenow/racl/users-in-user-criteria.png "Individual Users")
...
![Individual Users](/ai-for-service/searchai/connectors/images/servicenow/racl/individual-users.png "Individual Users")
...
**Webhook user sync** — Search AI doesn't support user synchronization through webhooks. Document entities are updated in real time via webhook, but associated user permissions are synchronized through the regular incremental or manual sync process for more accurate permissions.
