...
{/*
- To sync Salesforce Knowledge Articles, the following configurations must be in place before running a sync.

   - Enable Knowledge Settings - In Salesforce, go to Setup > Knowledge Settings and ensure that Knowledge is enabled for your org.

   - Enable Knowledge User on the service account - For the user account used by the connector, go to Setup > Users, open the user record, and ensure the Knowledge User checkbox is enabled. This setting must be active on the user's profile or directly on the user record.

   <Note>Both settings are required for content sync.</Note>
*/}
...
1. Log in to [Salesforce](https://login.salesforce.com/) and open **Setup** from the Setup icon.
   ...
   ![Salesforce Home](/ai-for-service/searchai/connectors/images/salesforce/salesforce-home.png "Home")

2. The **Object Manager** home page opens.

   ![Object Manager](/ai-for-service/searchai/connectors/images/salesforce/object-manager.png "Object Manager")

3. Go to **App Manager** and click **New Connected App**.

   ![Create App](/ai-for-service/searchai/connectors/images/salesforce/create-app.png "Create New App")

4. Fill in basic app details - name, email address, logo, and icon.

   ![App details](/ai-for-service/searchai/connectors/images/salesforce/app-details.png "App details")
...
8. Leave remaining settings as default and click **Save**, then **Continue**.
   ...
   ![App details](/ai-for-service/searchai/connectors/images/salesforce/save-app.png "App details")
...
![Authorization](/ai-for-service/searchai/connectors/images/salesforce/auth.png "Authorization")

Once connected, the connector status changes to **Connected** and is ready for content ingestion.

By default, the connector ingests only published knowledge articles. {/* If there are any attachments(.pdf) are also ingested in Search AI.*/}

## Content Filters

The Salesforce Connector supports selective ingestion. To filter content, select **Sync Specific Content** and click **Configure**.

![Content Filters](/ai-for-service/searchai/connectors/images/salesforce/content-filter.png "Content Filters")
...
![Content Rules](/ai-for-service/searchai/connectors/images/salesforce/filters.png "Content Rules")

The Parameter dropdown includes commonly used Knowledge Article fields such as `ArticleNumber`, `ArticleCreatedById`, `Title`, and `Language`. For the full list of supported fields, see the [Salesforce Knowledge Article Version API reference](https://developer.salesforce.com/docs/atlas.en-us.knowledge_dev.meta/knowledge_dev/sforce_api_objects_knowledgearticleversion.htm).

**Example:** Filter for articles published on a specific date.

![Content Rule Example](/ai-for-service/searchai/connectors/images/salesforce/example1.png "Content Rule Example")

**Example:** Filter for articles with a specific title and author.

![Content Rule Example](/ai-for-service/searchai/connectors/images/salesforce/example2.png "Content Rule Example")
...
![Custom Object Example](/ai-for-service/searchai/connectors/images/salesforce/custom-obj-example.png "Example")
...
The following access control methods aren't currently supported:
