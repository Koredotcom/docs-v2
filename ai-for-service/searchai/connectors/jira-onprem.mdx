...
A single Jira On-Premise connector supports multiple authentication profiles, allowing it to sync content from multiple Jira accounts. Each profile uses its own credentials and domain, and content sync works across all configured profiles.
