...
Reference for Knowledge Graph (KG) concepts. Applies to both Few-Shot and Ontology KG models unless noted. See [Knowledge AI Introduction](/ai-for-service/automation/knowledge-ai/knowledge-ai-introduction#knowledge-ai) and [Build a Knowledge Graph](/ai-for-service/automation/knowledge-ai/build-a-knowledge-graph).
