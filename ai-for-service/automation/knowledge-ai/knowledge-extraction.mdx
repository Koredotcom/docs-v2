...
Use this when your PDF isn't in Platform-compatible format. Annotating teaches the KG engine where questions and answers are.
...
<Note>
Once a Q&A pair is moved to the KG, it can't be moved again. If the question is later modified or deleted from the KG, you can re-add it from the extract.
</Note>
...
- The answer tag isn't a child or sibling of the question in the DOM.
- The question has no hyperlink to its answer (for hyperlink-based layouts).
- The linked answer page doesn't repeat the question above the answer.
