...
Responses use the same prompt editor as other dialog nodes. See [Prompt Editor](/ai-for-service/automation/dialogs/prompt-editor).
...
- Exporting as JSON includes conditional responses; CSV export doesn't.
</Note>
