...
**R&R V2** ranks only definitive matches from ML and KG (not FM) without rescoring. The R&R window shows the winning intent, ranking score, eliminated intents and their reasons, and the final result. See [Ranking and Resolver](/ai-for-service/automation/natural-language/training/ranking-and-resolver).
