---
title: Test Case Execution Summary
sidebarTitle: Test Case Execution Summary
noindex: true
---
...
You can execute test cases on the Conversation Testing Landing Page and the individual Test Case details page. Follow these steps for test execution:

1. On the **Test Suite Details** page, select the test suite and then click the **Run Test Suite** button for that specific suite.
![Test Suite Details](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img1.png)

    **Note:** You can also execute the test cases by clicking the Run Test button on the Test Suite Details page.

![Run test](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img2.png)

2. Choose the Version of the app you want to test.

    <Note>
    Ensure that you have valid authorization tokens for the app to make the service calls that would be part of the test suite.
    </Note>

    ![Choose Version](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img3.png)
...
![Result](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img4.png)

When a test case is executed, the test case result is determined with the features like assertions, dynamic texts, OneOf, and so on. To know more, see [Test Case Assertion](/ai-for-service/automation/testing/regression-testing/conversation-testing/test-case-assertion).

The platform simulates all the user inputs against the current app definition in sequence, as available in the test case. For every user input, the app's responses are captured along with the metadata. See Capture Test Suite Metadata under [Validate Test Suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/create-a-test-suite#validate-and-create-test-suite) to know more.

The Docker Status displays the execution status of Regression Testing runs. When a Conversation Testing run continues in the background, it shows the test suite name, current status, and the time of the latest update, making it easy to monitor ongoing and recent test runs. Select View to open the corresponding test suite details and review the run results. 
...
![Test Assertion](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img5.png)
...
* If the above conditions aren't met, the assertion is determined as Failed.
...
* Dynamic text values aren't considered when performing the comparison.
...
* A context assertion fails if the expected value and the actual value of the variable aren't the same.
...
![Past test executions](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img6.png)
...
![Result Summary button](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img7.png)
...
![Result summary](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img8.png)
...
3. The test result summary is displayed with the following details:
    ...
    * The status of the Test Suite - Passed or Failed
    ...
    ![Test result details](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img9.png)

4. The test case details and their assertion result summary are also displayed.
![Test case details and assertion result](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img10.png)
