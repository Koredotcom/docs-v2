...
A Test Suite contains a collection of test cases grouped to simulate a specific conversation between the user and the app and used anytime for test execution. You can know the execution status and determine and analyze the results in a test suite.
...
![Start recording New Test](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-record1.png)

3. In the pop-up displayed, choose whether to start the recording with the On Connect event included.

    <Note>
    "On-Connect" is the message you receive as soon as you open the chat window, even before you enter any message. The option is displayed for VAs with an On-Connect message. If you select "No", the On-connect message doesn't get added as a test case. If you select "Yes", then the On-connect message is created as a separate test case.
    </Note>

4. Define the Pre-processor Script to control preconditions during conversation testing. [Learn more](#pre-processor-script).

5. Click **Proceed** to start the test recording.
![Recording Options](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-record2-window.png)
...
![Chat Recording Status](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-record-chat.png)

    <Note>
    If there is an error while recording due to any limitation set on the platform, it's displayed on the page.
    </Note>
...
If you have enabled [LLM and Generative AI](/ai-for-service/generative-ai-tools/overview) for your app, you will see User Response suggestions while recording a Conversation Test Case.
...
It also helps you predict and simulate the end user's behavior and check if the app can execute all the defined flows by generating user responses and presenting any digressions from the specified intent.

Click any suggestion to send it to your app and test the response.

![Suggestions](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-suggestions.png)

You can refresh the suggestions list or minimize the suggestions panel. You can also talk to your app by typing in your responses.

![Refresh suggestions](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-refresh-collapse.png)
...
![Click Validate Test Suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-record3.png)
...
![Validation in Progress](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-validation-in-progress.png)
...
![Continue in Background](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-draft.png)
...
![Validate Test Suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-validate-ts.png)
...
Using Conversation Testing, you can test the sequence of nodes executed by the app for user input(s) and capture the following metadata at the time of test suite creation to verify if the app is executing the conversation flows as expected:

* Intent ID, Intent Name
* Node ID, Node Name
* Transition flow

The metadata are captured in both [Record](#record-conversation-to-create-a-test-suite) and [Upload](#upload-file-to-create-a-test-suite) scenarios for all the app responses of all the test suites. The details to be captured vary based on the intent type of the app response. For more information on the details captured here, see [Test Editor](/ai-for-service/automation/testing/regression-testing/conversation-testing/test-editor).
...
1. Upon approval, a **Create Test Suite** pop-up is displayed in which you can enter the following details:
    ...
    * Description
    * Tags
![Create Test Suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-ts.png)
...
![Create Test Suite-Select test case](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-tc-selected.png)

4. The dialog **Before you execute the test Suite** is displayed. Select the version of your app to be executed. If any authorization profiles are available, they're displayed here.
![Before you execute the test Suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-b4-u-execute.png)
...
![Continue executing test suite](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-execution.png)

If the test cases are passed, the **Result** is displayed as **Passed**, as shown in the screenshot below.
![Execution Results](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-suite.png)
...
![Upload TS JSON File](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-new-ts-upload.png)
...
![Browse for the JSON file](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-create-upload-file.png)
...
![JSON file upload error](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-file-error.png)

If an uploaded JSON file exceeds the configured size limit of 2 MB, an error is displayed as shown below.
![JSON file size error](/ai-for-service/automation/testing/regression-testing/conversation-testing/images/ct-create-test-suite-file-size-error.png)
