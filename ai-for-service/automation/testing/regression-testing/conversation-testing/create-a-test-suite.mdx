...
If you have enabled [LLM and Generative AI](/ai-for-service/generative-ai-tools/overview#generative-ai-tools) for your app, you will see User Response suggestions while recording a Conversation Test Case.
...
4. The dialog **Before you execute the test Suite** is displayed. Select the version of your app to be executed. If any authorization profiles are available, they are displayed here.
