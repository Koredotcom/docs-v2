...
Use this option if you don't have permission to invite developers directly.
...
2. Set the **Admin** and **Platform Access** roles as needed. See [Role Management](/ai-for-service/administration/role-management).
