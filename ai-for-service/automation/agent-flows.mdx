...
| No. of Retries | Max retry attempts (0-10) | IVR, Twilio, AudioCodes |
...
| No. of Retries | Max retries (0-10); overrides app-level setting | IVR, Twilio, AudioCodes, Voice Gateway |
