...
To understand customized JavaScript responses and channel-specific templates, refer to [Customize JavaScript Responses](/ai-for-service/automation/dialogs/prompt-editor#javascript-prompts-or-responses) in the [User Prompts](/ai-for-service/automation/dialogs/prompt-editor) article.
...
3. Enter channel-specific messages for bot responses using the **Manage** link. For more information, read the [Using the Prompt Editor](/ai-for-service/automation/dialogs/prompt-editor#) article.
...
2. Under the **Interruptions Behavior** section, you can configure the interruptions behavior for this node.
   ...
   <Note>The settings in the Instance Properties tab are specific to the current task and don't reflect in other dialog tasks that use this node.</Note>
