...
Node groups define a group of nodes but aren't part of the dialog flow. They are primarily used to scope sub-intents — controlling which sub-intents can be identified and executed while the user is at any node within the group.
