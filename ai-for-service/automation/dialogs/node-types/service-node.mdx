...
2. Choose a **Service Type** from the drop-down list:
   ...
   4. **Custom Authentication Service**: Define a URL to a third-party application that provides the authentication services necessary for the task flow. [Learn more](/ai-for-service/automation/dialogs/implementing-custom-authentication).
...
* [Implement Custom Authentication for the Service Node](/ai-for-service/automation/dialogs/implementing-custom-authentication) or
* [Enable 2-way SSL for the Service node](/ai-for-service/automation/dialogs/enabling-2-way-ssl-for-service-nodes)
