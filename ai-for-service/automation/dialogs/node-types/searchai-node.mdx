...
To set up node connection conditions, please follow the steps outlined in [Adding IF-Else Conditions to Node Connections](/ai-for-service/automation/dialogs/node-types/node-connections#node-connections). These settings apply only to this instance and won't affect other uses of the node. These settings are available only if this is the last node in a sequence.
...
* [Use Agent Node and Search AI to Generate Answers](/ai-for-service/automation/how-tos/use-agentnode-and-searchai-to-generate-answers#use-agent-node-and-search-ai-to-generate-answers)
