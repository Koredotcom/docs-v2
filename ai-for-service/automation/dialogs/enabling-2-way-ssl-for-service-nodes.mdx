---
title: Enabling 2-Way SSL for Service Nodes
sidebarTitle: 2-Way SSL for Service Nodes
noindex: true
hidden: true
mode: center
---
...
Platform offers this support by default in their cloud offering. In case the services you use need a two-way SSL, the platform provides the certificate.
...
This process is applicable for service nodes. See [Service Node](/ai-for-service/automation/dialogs/node-types/service-node) for more details.
