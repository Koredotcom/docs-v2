...
For details on what Digital Forms are and how it is implemented in the XO Platform, click [here](/ai-for-service/automation/digital-skills//digital-forms).
...
<Note>During the Export of the App, the logo is not exported along with Digital Forms. So, while importing this App, you need to separately copy the logo image file and then manually reupload the logo.</Note>
