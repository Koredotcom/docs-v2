...
In this help document, we'll explore how a user can view his/her account details using digital views. We'll see how a Digital View can be presented using Panels and Widgets. Widgets can be used to trigger Dialog Tasks and display appropriate messages and Panel can be used to hold these Widgets.

We'll also see how the Panel can be hosted on Web/Mobile Client using the Widget SDK.

For details on what Digital Views are and how it's implemented on the Platform, click [here](/ai-for-service/automation/digital-skills/digital-views).
