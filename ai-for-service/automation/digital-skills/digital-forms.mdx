...
<Note>During the Export of the app, the logo is not exported along with Digital Forms. So, when importing this App, you need to separately copy the logo image file and then manually reupload the logo.</Note>
...
| formMsgMeta.FORM_LINK_EXPIRY | Message that is displayed when the form link expires. **Note** : The expiry message of the digital form can't be customized. The expiry message will be displayed according to the app's language settings. |
...
<Note>While a Digital Form is used to define multiple Widgets and also add to multiple panels, it will be associated with a single Dialog Task across all Widgets and Panels.</Note>
...
<Note>If any edits are done to the Digital Form while it is In Development, the changes would be reflected in the Published version as soon as you publish the form.</Note>
...
**Note that this does not include the Sub-dialog Tasks generated using Digital Forms.**
