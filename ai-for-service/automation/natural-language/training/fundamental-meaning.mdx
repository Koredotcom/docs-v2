...
| Setting | Description |
|---|---|
| **Intent Detection using Task Name Words** | Enabled by default. Disable only when input starts/ends with exact task name. Useful for tasks sharing words such as multiple `order` intents.|
