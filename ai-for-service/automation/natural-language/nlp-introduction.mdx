...
| **Stemming** | Cuts words to their stem (for example, "Working" → "work"). Output may not be a valid word. |
| **Lemmatization** | Converts to base form using a dictionary (for example, "housing" → "house"). |
| **N-grams** | Combines co-occurring words (for example, "New York City") for richer context. |
...
- [Traits](/ai-for-service/automation/natural-language/training/traits)
