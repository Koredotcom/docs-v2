...
- The [Agent Node](/ai-for-service/automation/agent-node) feature is [enabled](/ai-for-service/generative-ai-tools/genai-features#enable-a-genai-feature).
...
- [Configure Web Crawl for Websites](/ai-for-service/searchai/content-sources#websites)
- [Upload Documents](/ai-for-service/searchai/content-sources#documents)

### Step 2: Create a Dialog and Configure the Agent Node

1. [Create a new dialog.](/ai-for-service/automation/agent-flows#dialog-tasks)
2. Add an [Agent Node](/ai-for-service/automation/agent-node) to the dialog. Select your model and tool calling prompt.
...
5. [Test the flow in the Playground](/ai-for-service/automation/testing/playground) to verify accurate, context-aware responses.
