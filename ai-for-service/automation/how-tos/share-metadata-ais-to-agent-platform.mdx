...
- An Agentic app created in Agent Platform. See [Create an Agentic App](/agent-platform/v1/agents/agentic-apps/create-an-app.mdx#1-create-an-app).
...
For code tools, see [Memory Stores in Agentic Apps](/agent-platform/v1/memory).
