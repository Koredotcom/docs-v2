...
A sub-intent is a child intent that's only active when a specific parent intent has already been matched. The Platform automatically adds an output context to the parent and a matching input context to the child, linking them together.
