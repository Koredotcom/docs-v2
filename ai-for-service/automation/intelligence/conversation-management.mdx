...
<Note>Use the toggle to enable or disable Statements. By default, all are enabled. Disabling a Statement excludes it from runtime processing, while other Standard Response categories continue to function normally. Use the filter to toggle all options at once.</Note>
