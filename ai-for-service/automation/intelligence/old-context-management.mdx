...
![set dialog tasks](../images/set-dialog-task.png)
...
![set alert tasks](../images/set-alert-tasks.png)
...
![add entity tags](../images/add-entity-tag.png)
...
![add KG tags](../images/add-kg-tags.png)
...
![dialog task preconditions](../images/dialog-tasks-preconditions.png)
...
![input preconditions](../images/input-preconditions.png)

#### Knowledge Graph

- Define preconditions per term in the Knowledge Graph.

![define intent preconditions](../images/define-intent-preconditions.png)
...
Define rules for contextually relevant intent detection using output context tags (similar to traits). [Learn more](../natural-language/training/traits.md)
...
![qualify contextual paths](../images/qualify-contextual-paths-window.png)
