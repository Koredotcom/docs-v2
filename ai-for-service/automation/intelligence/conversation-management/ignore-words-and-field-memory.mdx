...
> **Note:** This feature is only available when an Alert, Action, or Information task is configured for the assistant. [Learn more](../../use-cases/alert-tasks.md#general-settings)
...
3. Configure the following:
   - **Entity Type** — Select the expected input type to improve NLP recognition. [Learn more](../../use-cases/dialogs/entity-types.md)
