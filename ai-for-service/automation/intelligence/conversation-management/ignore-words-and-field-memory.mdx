...
![edit alert tasks for ignore words](/ai-for-service/automation/intelligence/images/ignore-words-edit-alert-tasks-window.png)
...
3. Configure the following:
   ...
   - **Memory User-Provided Value** — Choose one of:
     - **No, don't memorize** — Value isn't persisted after the task completes.
