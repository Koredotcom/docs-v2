...
|---|---|---|
| **Intent not Identified** | Triggered when the AI Agent can't find or understand the user's intent. | [Event Handling](/ai-for-service/agentai/configuration/conversation-events) |
...
| **Event Handlers** | Configurable behaviors for common AI Agent events (task completion, failures, channel actions, etc.). | [Event Handling](/ai-for-service/agentai/configuration/conversation-events) |
...
| **Errors & Warnings** | Messages displayed when errors occur — for example, *End date can't be before the start date.* |
