...
- **Customize for this node**: override with node-specific behavior. See [Interruption Handling](/ai-for-service/automation/intelligence/conversation-management#manaage-interruptions).
...
**Custom Tags:** Attach meta tags to messages, users, and sessions for analytics. See [Custom Meta Tags](/ai-for-service/analytics/automation/custom-dashboard/custom-meta-tags#custom-meta-tags).
