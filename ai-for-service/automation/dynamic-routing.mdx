...
Dynamic Routing is a single entry point that intelligently routes user queries to the most appropriate specialized app based on intent. It's powered by **DialogGPT**, an agentic orchestrator using Retrieval-Augmented Generation (RAG) and LLMs.
...
For background on app statuses, see [Publication Statuses](/ai-for-service/deployment/publishing-app#publishing-your-app).
...
**What happens if linked apps aren't published during the publish process?**
