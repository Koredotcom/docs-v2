...
![Manage bot tasks](/ai-for-service/images/bot-management-img17.png)

2. In the **Bot tasks** field, select the **Expand** ![](/ai-for-service/images/bot-management-img9.png) icon to display the available and deployed tasks. The **Bot tasks** dialog is displayed as shown in the following example.  
![Bot tasks dialog](/ai-for-service/images/bot-management-img19.png)
...
![restore](/ai-for-service/images/restore.png)
...
![Deploying Bots](/ai-for-service/images/bot-management-img1.png)
...
1. On the **Deployment Requests** page in the **Bots Management** module, hover over the Bot you want to approve and select the ![Icon](/ai-for-service/images/bot-management-img3.png) icon.  
![MAnually approving bot](/ai-for-service/images/bot-management-img4.png)
...
3. On selecting the Bot the **Bot Publish** page is displayed with the following additional information
    ...
    ![Publish bot after approving](/ai-for-service/images/bot-management-img5.png)
...
![Deploying Bot - Success](/ai-for-service/images/bot-management-img6.png)
...
![Enterprise bot assignments](/ai-for-service/images/bot-management-img23.png)
...
![Automatically assign all approved bots, their tasks, and channels](/ai-for-service/images/bot-management-img24.png)
...
2. Select **Save**.  
![Hold all deployment requests for manual admin approval](/ai-for-service/images/bot-management-img25.png)
...
![permanently_deleted](/ai-for-service/images/permanently_deleted.png)
