...
![SSO](/ai-for-service/administration/nac-images/sso-new-admin-console.png)
...
![SSO SAML](/ai-for-service/administration/nac-images/sso-saml-new-admin-console.png)
...
* **SAML 2.0 Endpoint**: The HTTP SSO endpoint for OneLogin to enable Service Provider-initiated SAML flow, for example, [https://app.onelogin.com/trust/saml2/http-post/sso/358111](https://app.onelogin.com/trust/saml2/http-post/sso/358111).  
...
![SSO OneLogin](/ai-for-service/administration/nac-images/using-single-sign-on-img4.png)
...
![Bitium portal](/ai-for-service/administration/nac-images/using-single-sign-on-img5.png)
