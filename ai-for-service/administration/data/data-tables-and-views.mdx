...
Assign a Table View to bots, process apps, or apps to share it. Users with shared access can view the view definition but can't edit or update it.
...
Data Tables are designed for low-volume, conversation-relevant data. They aren't a general-purpose database.
