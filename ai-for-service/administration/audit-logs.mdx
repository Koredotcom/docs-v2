---
title: Audit Logs and App Chat History
...
![Analytics - Audit Reports](/ai-for-service/administration/nac-images/analytics-img1.png)
...
![Event filter options](/ai-for-service/administration/nac-images/analytics-img2.png)

### Record Details

By clicking on any entry, you get to view further details:

![Record details](/ai-for-service/administration/nac-images/analytics-img3.png)

![Export search](/ai-for-service/administration/nac-images/analytics-img4.png)

<Note> The Audit Report contains system and user events for several Kore.ai products. To drill down further than Event Categories, use the Search for Description field, which lets you add one more criterion to the filter. To get XO Platform data, search for App Builder" exactly; the Search field is case-sensitive. For more complex filtering, we recommend exporting the report and using a spreadsheet editor. </Note>
...
![Analytics - Bot Chat History](/ai-for-service/administration/nac-images/analytics-img5.png)
...
<Note> The number of search terms in a search query is unlimited; however, no more than the first 20 characters of each search term are used to return search results. </Note>
...
![Export file of Chat History](/ai-for-service/administration/nac-images/analytics-img8.png)
...
![Chat History details](/ai-for-service/administration/nac-images/analytics-img9.png)

<Note>The Trace ID is retained in the logs for 30 days. Once the Trace ID is expired, you see a tooltip message as `Trace Id: Trace records for this message aren't available.`</Note> 
...
|  | Channel Data | Data received from the channel, that's, the information that's available in the User Context. |
