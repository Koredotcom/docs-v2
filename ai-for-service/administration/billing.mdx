...
For more information, refer to [Product-specific Billing Sessions](/ai-for-service/manage-assistant/plan-and-usage/billing-and-payments).

## Order Invoices

This section displays the history of Orders and Invoices and includes the fields as shown in the image:

![Download invoices](/ai-for-service/administration/nac-images/billing-order-invoices.png)

You have the option to download the Invoice from the invoice field.

<Note> This section isn't available for customers under the Enterprise plan. </Note>
...
![Plan and Usage information](/ai-for-service/administration/nac-images/billing-plan.png)
...
![Plan based eligibility and usage details](/ai-for-service/administration/nac-images/billing-manage-plan.png)

<Note> The **Billing** > **Plan** option doesn't appear on the Admin Console (left menu) for a shared account user. </Note>
...
![admin-console-billing-graph](/ai-for-service/administration/nac-images/billing-usage.png)
...
Billing metrics are shown using a graph or table, making it easy to understand usage patterns. Hover over a data point to view the date, sessions, voice sessions, and agents.