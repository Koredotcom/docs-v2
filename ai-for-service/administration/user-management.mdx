...
|----------|-------------|
| Default Fields Section | The user profile fields are displayed by default and can't be disabled from the User Profile page for the user. **First Name**, **Last Name**, **Profile Picture**. You can also select or clear **Allow Edits** to enable/disable the user from overwriting the data. Modifications to the user profile take effect when the user logs in next. |
