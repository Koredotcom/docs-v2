...
<Tip> If SSO is enabled, Admins can still log on to the Admin Console directly using their password credentials and bypass SSO. For more information, see [Logging On Using Your Admin Password Instead of SSO](/ai-for-service/administration/single-sign-on.mdx). </Tip>
