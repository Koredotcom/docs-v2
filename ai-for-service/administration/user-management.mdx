...
<Tip> If SSO is enabled, Admins can still log on to the Admin Console directly using their password credentials and bypass SSO. For more information, see [Exclude Users from SSO](/ai-for-service/administration/single-sign-on#exclude-users-from-sso). </Tip>
