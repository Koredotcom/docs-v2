...
{/*
AG: hiding this article for now. Must be updated to match UI. Can possibly combine this content into the Admin Overview article.
*/}
...
![Bot Metrics](/ai-for-service/administration/images/admin-console-dashboard-img1.png)
