...
1. In the User Management module, on the Directory Sync page, select **Configure**.
    ...
    ![Run manual sync](/ai-for-service/administration/nac-images/sync-with-company-directory.png)

2. The Cloud-Based Connector dialog is displayed. Follow the steps given here to proceed. 
![Run manual sync](/ai-for-service/administration/nac-images/cloud-based-connectors.png)
