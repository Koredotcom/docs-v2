...
![User Management - Groups](/ai-for-service/administration/nac-images/manage-group.png)
...
| Source | The source used to create the group. One of: **Local** - The group was created manually from the **User Management** module. **AD**. The group was imported or synchronized using Active Directory. **System** – The group was created as a default group. |
...
6. Click **Save**. The system creates the group and returns you to the **Groups** page.
    ...
    ![Create Groups](/ai-for-service/administration/nac-images/create-new-group-new-admin-console.png)
...
![Delete Groups](/ai-for-service/administration/nac-images/delete-group.png)
