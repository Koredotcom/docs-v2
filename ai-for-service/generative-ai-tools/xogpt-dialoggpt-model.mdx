...
| **No Intent** | 2 | User input doesn't match any category. | A configured Fallback Intent is triggered. |
...
| End Interaction | User indicates they're done with the interaction. |
...
|---------|----------|-----|-------------|-----------|-----------|
| v1.0 | 95.8% | 35.1 | 1.57 | [Summary v1](#benchmarks-summary-v1) | [Results v1](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/generative-ai-tools/test-date-and-results/xogpt-dailoggpt-v1.0.xlsx) |
...
See [Test Data and Results v1](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/generative-ai-tools/test-date-and-results/xogpt-dailoggpt-v1.0.xlsx) for full details.
