...
|---------|----------|-----|-------------|-----------|-----------|
| v1.0 | 99% | 45 | 0.9 | [Summary v1](#benchmarks-summary-v1) | [Results v1](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/generative-ai-tools/test-date-and-results/xogpt-response-rephrasing-v1.0.xlsx) |
...
See [Test Data and Results v1](https://raw.githubusercontent.com/Koredotcom/docs-v2/refs/heads/main/ai-for-service/generative-ai-tools/test-date-and-results/xogpt-response-rephrasing-v1.0.xlsx) for full details.
