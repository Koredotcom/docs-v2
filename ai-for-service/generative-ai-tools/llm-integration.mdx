...
4. In the model section, click **+Add** to configure ![Provider's New LLM](#Add a New Model to a Pre-built Integration). This step is optional.
5. Read the Policy Guidelines, select the checkbox, and click **Save**.
...
You can add models to an existing OOB integration (OpenAI, Azure OpenAI, Anthropic, and Google Gemini) without waiting for the Platform to add them. New models initially require custom prompts; the Platform adds system prompts over time.
