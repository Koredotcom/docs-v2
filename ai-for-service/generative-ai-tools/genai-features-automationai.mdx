...
|:------|:----------:|:-----------:|:----------------:|:-----------------:|:-------------------:|:------------------:|
| Azure OpenAI - GPT-4 Turbo, GPT-4o, GPT-4o mini, GPT‑5.4, GPT‑5-mini, GPT‑5.2, GPT‑5.4 Mini, GPT‑5.4 Nano | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| OpenAI - GPT-3.5 Turbo, GPT-4, GPT-4 Turbo, GPT-4o, GPT-4o mini, GPT‑5.4, GPT‑5.3 Instant, GPT‑5.2, GPT‑5.4 Mini, GPT‑5.4 Nano | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Amazon Bedrock | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
...
- Azure OpenAI and OpenAI GPT-5 models for Repeat Responses, Rephrase User Query, Zero-shot ML Model, Automatic Dialog Generation, Conversation Test Case Suggestions, Conversation Summary, NLP Batch Test Case Suggestions, and Training Utterance Suggestions features.
...
If disabled, Generative AI suggestions aren't displayed. [Learn more](/ai-for-service/automation/testing/regression-testing/conversation-testing/create-a-test-suite#create-a-test-suite).
