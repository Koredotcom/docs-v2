...
If disabled, you can't generate test cases during batch testing. [Learn more](/ai-for-service/automation/testing/regression-testing/batch-testing#auto-generating-test-cases).
