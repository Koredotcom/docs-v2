...
| **Kore.ai XO GPT** | Fine-tuned LLMs built for enterprise conversational AI—evaluated for accuracy, safety, and production readiness. See [Kore.ai XO GPT](xo-gpt-module.md). |
