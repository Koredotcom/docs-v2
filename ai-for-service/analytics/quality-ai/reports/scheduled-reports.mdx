...
Scheduled Reporting enables supervisors to generate, automate, and analyze reports to monitor agent performance, interaction quality, and adherence to evaluation metrics. It supports data-driven coaching and continuous improvement.
...
Available fields vary by report type and are dynamically updated based on the selected date range, including custom metadata fields. Note that changing the date range may change the available custom fields.
