...
The Reports page consists a list of generated reports. You can generate an instance of a new report, download reports, edit, view, and delete reports.
...
1. Select **Next** and follow provide the relevant information.
...
To add filters and set values, select **+Add Filter**. The available filters are:
