...
Scheduled Reporting enables users to generate and automate reports for analyzing agent performance, interaction quality, metric adherence, and contact direction (inbound or outbound). It supports both on-demand and scheduled execution and uses role-based access to control data visibility. 
...
The **Reports** page organizes all reports into tabs by type for easy access and management, including **My Reports** for viewing and managing reports you created, **All Reports** for accessing all reports available to you, and **Favorites** for a quick view of reports you have bookmarked.
...
![Reports Type](/ai-for-service/analytics/quality-ai/reports/images/general-report-selection.png)
...
#### Evaluation Form or Agent Scorecard Configuration
...
##### Schedule Frequencies Configuration
...
<Note>The report data is dependent on the selected filters. Users without the Quality AI Reporting permission can’t access reports, create reports, receive emails, or download report history.</Note>
