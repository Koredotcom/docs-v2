...
1. Complete the **Schedule** to generate a report with the current configuration.
    ...
    1. If you select **Schedule**:
        ...
        1. Select **Save** to confirm and activate the schedule.
           ...
           <Note>This report includes only evaluated interactions in all aggregated metrics. Interactions below the duration threshold aren't included in any aggregated metrics.</Note>
