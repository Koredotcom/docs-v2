...
<Note>Select **More Filters** to access filters from UserID through Custom Tags; the UTC Time Zone filter is available on the Summary, Conversations, Users, and Performance dashboards, while the Time Range filter is available on the Feedback, Conversation Insights, Custom, Task Execution Logs, and NLP Insights dashboards.</Note>
