...
<Note>
File type data requires the file type field to be present on each chunk. If this field is not yet available in your deployment, this chart will not populate.
</Note>
