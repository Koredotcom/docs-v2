...
The Document Engagement table shows per-document retrieval and click metrics. Use Document Engagement to identify high-retrieval documents that are not being cited or clicked, and low-retrieval documents that may need better indexing or content improvement. Use the search box and the **Source filter** to further filter the documents from a specific content source.
