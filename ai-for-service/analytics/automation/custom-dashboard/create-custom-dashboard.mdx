...
![Configured Custom Dashboard](/ai-for-service/analytics/automation/custom-dashboard/images/configured-custom-dashboard.png)
...
![Transfer Funds](/ai-for-service/analytics/automation/custom-dashboard/images/transfer-funds.png)
...
![Transfer Funds Add Scripts](/ai-for-service/analytics/automation/custom-dashboard/images/transfer-funds-add-scripts.png)

**Manage Payee**: A dialog task for the user to manage their payee list.

![Manage Payee](/ai-for-service/analytics/automation/custom-dashboard/images/manage-payee.png)
...
2. Click **Create a New Dashboard**.
    ...
    ![Create New Dashboard](/ai-for-service/analytics/automation/custom-dashboard/images/create-new-dashboard.png)
...
3. Widget setup:
    ...
    ![Dollar Value Breakup Query](/ai-for-service/analytics/automation/custom-dashboard/images/dollar-value-breakup1.png)

4. Click **Preview**, then click **Update to Dashboard**.

    ![Dollar Value Breakup Preview](/ai-for-service/analytics/automation/custom-dashboard/images/dollar-value-breakup2.png)
...
3. Widget setup:
    ...
    ![Customer Type Summary](/ai-for-service/analytics/automation/custom-dashboard/images/customer-type-summary.png)
...
3. Widget setup:
    ...
    ![Task Fulfillment Trend](/ai-for-service/analytics/automation/custom-dashboard/images/task-fulfillment-trend.png)
...
3. Widget setup:
    ...
    ![Top Failure Tasks](/ai-for-service/analytics/automation/custom-dashboard/images/top-failure-tasks.png)
...
3. Widget setup:
    ...
    ![Channel Volume Trend](/ai-for-service/analytics/automation/custom-dashboard/images/channel-volume-trend.png)
...
4. The following shows results when retrieving the count of all messages grouped by userId (without the Having clause):
    ...
    ![Filter Messages Having Clause 1](/ai-for-service/analytics/automation/custom-dashboard/images/filter-the-message-using-having-clause1.png)

5. The following shows results when using the Having clause (only users with more than 12 messages):

    ![Filter Messages Having Clause 2](/ai-for-service/analytics/automation/custom-dashboard/images/filter-the-message-using-having-clause2.png)

6. Click **Preview**, then click **Add to Dashboard**.

    ![Filter Messages Having Clause Preview](/ai-for-service/analytics/automation/custom-dashboard/images/filter-the-message-using-having-clause3.png)

7. The Having clause widget is added to the dashboard:

    ![Filter Messages Having Clause Dashboard](/ai-for-service/analytics/automation/custom-dashboard/images/filter-the-message-using-having-clause4.png)
