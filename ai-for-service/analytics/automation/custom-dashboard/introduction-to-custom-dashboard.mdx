...
noindex: true
---
<Badge icon="arrow-left" color="gray">[Back to Analytics Overview](/ai-for-service/analytics/overview#automation-analytics)</Badge>
...
1. Click **Analytics** on the left navigation pane. The Analytics panel opens with the list of reports.
    ...
    ![Navigate to Custom Dashboard](/ai-for-service/analytics/automation/custom-dashboard/images/navigate-to-custom-dashboard.png)
...
![Add Custom Dashboard](/ai-for-service/analytics/automation/custom-dashboard/images/add-custom-dashboard.png)
...
![Aggregate Functions](/ai-for-service/analytics/automation/custom-dashboard/images/aggregate-functions.png)
...
The Distinct function obtains the number of distinct values across the column. It's allowed with **Sum**, **Count**, and **Average**.
...
When conjugating multiple conditions, they're evaluated left to right. This ordering can't be changed using parentheses.

<Note>In the query setup for Filter By, individual AND and OR operators, and multiple ANDs or ORs, can be applied. A combination of AND/ORs isn't supported.</Note>
...
**Having** filters results with aggregate functions (the `Where` keyword can't be used here). For example, `count(messageid) > 10`. Works only with the **Group By** function.
...
<Note>In the Select clause, you can provide aliases to make column names more readable. For other fields, you can't define aliases and must use actual column names.</Note>

Click **Run** to see results in tabular format.

![Run the Query](/ai-for-service/analytics/automation/custom-dashboard/images/run-the-query.png)
...
![Run the Query Tags](/ai-for-service/analytics/automation/custom-dashboard/images/run-the-query-1.png)
...
![Filter By Developer](/ai-for-service/analytics/automation/custom-dashboard/images/filter-by.png)
...
![Data Representation](/ai-for-service/analytics/automation/custom-dashboard/images/data-representation.png)
...
![Widget Actions](/ai-for-service/analytics/automation/custom-dashboard/images/widget-actions.png)
...
![Query Modes](/ai-for-service/analytics/automation/custom-dashboard/images/query-modes.png)
...
<Note>You can add custom meta tags to the query that aren't yet included in the AI Agent while configuring the widget. However, to get the correct data, you need to add the custom meta tag to the AI Agent configuration.</Note>

![Type Ahead Suggestions 1](/ai-for-service/analytics/automation/custom-dashboard/images/type-ahead-suggestions-1.png)

![Type Ahead Suggestions 2](/ai-for-service/analytics/automation/custom-dashboard/images/type-ahead-suggestions-2.png)

![Type Ahead Suggestions 3](/ai-for-service/analytics/automation/custom-dashboard/images/type-ahead-suggestions-3.png)
