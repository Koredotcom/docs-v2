...
1. Click **Analytics** on the left navigation pane. The Analytics panel opens with the list of reports.
    ...
    ![Conversation Flows Dashboard](/ai-for-service/analytics/automation/images/conversation-flows-dashboard.png)
...
![Conversation Flows](/ai-for-service/analytics/automation/images/conversation-flows-1.png)

Select session-wise view by toggling the **View tasks by sessions** option.

![Conversation Flows Session View](/ai-for-service/analytics/automation/images/conversation-flows-2.png)
...
- **False Negatives**: Utterances that didn't result in any intent identification are shown as "Not Handled Utterances." Analyze these and add them to the training corpus if required.
...
![Conversation Flows Features](/ai-for-service/analytics/automation/images/conversation-flows-3.png)
...
- **Nodes**: Individual points plotted on the conversation flow across various levels. Only nodes that require input from the user are plotted. The following nodes are plotted:
    ...
    - Entity Nodes
    - Confirmation Nodes
    - User Input Nodes (using on intent transition)
    - Message Nodes
...
![Conversational Flows Filters](/ai-for-service/analytics/automation/images/conversational-flows-filters.png)
