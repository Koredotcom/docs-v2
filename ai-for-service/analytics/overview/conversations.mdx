...
**Recording Storage**: Recordings are stored in an AWS S3 bucket in MP4 format at 10–15 fps, up to 1080p resolution, with high compression, and approximately 25 MB per minute.
...
| Status | Message |
|--------|-------------|
| `Processing` | Recording available shortly |
| `Failure` | Error fetching recording |
| `Not Generated` | App not installed or consent declined |
