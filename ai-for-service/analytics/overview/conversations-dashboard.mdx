...
![Conversations Dashboard](/ai-for-service/analytics/overview/images/conversation-sessions.png)
...
![Conversation Sessions](/ai-for-service/analytics/overview/images/conversation-sessions.png)
...
![Self-service Rate](/ai-for-service/analytics/overview/images/self-service-rate.png)
...
![Drop-off Rate](/ai-for-service/analytics/overview/images/drop-off-rate.png)
...
When users can't complete tasks using the AI Agent, the session is handed over to a human agent. When the dialog reaches the agent transfer node, the platform classifies the session as an Agent Transfer session.
...
![Agent Transfer Rate](/ai-for-service/analytics/overview/images/agent-transfer-rate.png)

<Note>Unblu and IVR channels don't require an Agent Transfer node to transfer conversations to agents.</Note>
