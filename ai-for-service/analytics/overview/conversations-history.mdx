...
| **System triggered dialog**| Dialog triggered without user input (via NL Meta, Dynamic Node, or Automation Node). The label shows a system message with the dialog name instead of a blank bubble, making it easy to trace and audit these events. |
