...
1. Click **Analytics** on the left navigation pane. The Analytics panel displays the list of reports.
    ...
    ![Navigating to Conversations History Dashboard](/ai-for-service/analytics/overview/images/view-prebuilt-filters-1.png)
...
| **System triggered dialogue**| Dialogue triggered without user input (via NL Meta, Dynamic Node, or Automation Node). The label shows a system message with the dialogue name instead of a blank bubble, making it easy to trace and audit these events. |
