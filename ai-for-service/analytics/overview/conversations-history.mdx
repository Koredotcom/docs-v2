...
noindex: true
---
<Badge icon="arrow-left" color="gray">[Back to Analytics Overview](/ai-for-service/analytics/overview#overview-dashboards)</Badge>
...
1. Click **Analytics** on the left navigation pane. The Analytics panel displays the list of reports.
    ...
    ![Navigating to Conversations History Dashboard](/ai-for-service/analytics/overview/images/navigating-to-conversations-history-dashboard.png)
...
![Filters View Page](/ai-for-service/analytics/overview/images/filters-view-page.png)
...
|-------------|---------------|-------------|
| **All Conversations** (default) | Conversation Status: CLOSED; Containment Type: SELF-SERVICE; Is Developer: INCLUDE; Session Type: INTERACTIVE | Shows all conversations made during the specified dates regardless of other filter criteria. The "All Conversations" view can't be edited. |
...
1. On the Conversations History page, prebuilt filters are listed under the **Filter Views** section.
    ...
    ![View Prebuilt Filters](/ai-for-service/analytics/overview/images/view-prebuilt-filters-1.png)

2. Click **Read More** next to a filter name to see its configuration details.

    ![View Prebuilt Filters](/ai-for-service/analytics/overview/images/view-prebuilt-filters-2.png)

3. Click any prebuilt filter name to open the Conversations History panel with the relevant data.

    ![View Prebuilt Filters](/ai-for-service/analytics/overview/images/view-prebuilt-filters-3.png)
...
1. On the Conversations History page, click **+ Create Filter**.
    ...
    ![Create Conversation Filter](/ai-for-service/analytics/overview/images/create-conversation-filter-1.png)
...
3. Click **Save**.
    ...
    ![Create Conversation Filter](/ai-for-service/analytics/overview/images/create-conversation-filter-2.png)
...
2. Click the **More Filters** dropdown on the Conversations History panel.
    ...
    ![Edit a Conversation Filter](/ai-for-service/analytics/overview/images/edit-a-conversation-filter-1.png)

3. Modify the required fields in the **Edit Conversation Filter** window.
4. Click **Apply**.

    ![Edit a Conversation Filter](/ai-for-service/analytics/overview/images/edit-a-conversation-filter-2.png)
...
- **User Drop-off**: The user stopped participating before the conversation was completed, due to an error in the flow or another reason.
    ...
    ![Containment Type](/ai-for-service/analytics/overview/images/containment-type.png)
...
![Custom Label](/ai-for-service/analytics/overview/images/custom-label.png)

**Add a Custom Label**

1. Click the **+ Label** button on the Conversations History panel for the required conversation session.

    ![Add a Custom Label](/ai-for-service/analytics/overview/images/add-a-custom-label-1.png)
...
3. Enter the label name and click the **confirm** icon.
    ...
    ![Add a Custom Label](/ai-for-service/analytics/overview/images/add-a-custom-label-2.png)
...
![Other Conversation Parameters](/ai-for-service/analytics/overview/images/other-conversation-parameters.png)
...
- **Intent Unidentified**: Number of utterances that didn't result in intent identification.
- **Tasks Completed**: Number of tasks successfully completed.
- **Failed Tasks**: Number of tasks that failed.

![Conversation Summary](/ai-for-service/analytics/overview/images/conversation-summary.png)
...
![Conversation Events](/ai-for-service/analytics/overview/images/conversation-events.png)

**Intent Found**: Triggered when the AI Agent understands the user's intent. The identified intent name is displayed.

| Event | Description |
|-------|-------------|
| **Intent Not Found** | Triggered when the AI Agent can't understand the user's intent. |
| **Agent Transfer** | Triggered when a live agent transfer is initiated. |
| **Entity Retry** | Triggered when the user's input isn't identified and the AI Agent requests a retry. |
...
![Enriched Chat Transcript 1](/ai-for-service/analytics/overview/images/enriched-chat-transcript-1.png)

Event labels that appear under Conversation Events are displayed against each chat message in the transcript slider.

![Enriched Chat Transcript 2](/ai-for-service/analytics/overview/images/enriched-chat-transcript-2.png)

![Enriched Chat Transcript 3](/ai-for-service/analytics/overview/images/enriched-chat-transcript-3.png)
...
![Feedback User Type Label](/ai-for-service/analytics/overview/images/feedback-user-type-label.png)
...
2. Click the **User Details** tab to view:
    ...
    ![User Details](/ai-for-service/analytics/overview/images/user-details.png)
...
- The Chat History window displays the conversation flow, along with:
    - **Date Filter** dropdown to select the period of Chat History.
        ...
        ![Chat History 1](/ai-for-service/analytics/overview/images/chat-history-1.png)
    ...
    - Date-wise summary of:
        ...
        ![Chat History 2](/ai-for-service/analytics/overview/images/chat-history-2.png)
    ...
    ![Chat History 3](/ai-for-service/analytics/overview/images/chat-history-3.png)

    Click the **Message ID** to view the X-Trace Id and K-Trace Id associated with the message.

    ![Chat History 4](/ai-for-service/analytics/overview/images/xtraceid2.png)

<Note>X-Trace Id and K-Trace Id are retained in logs for 30 days. After expiry, a tooltip displays: "Trace records for this message aren't available."</Note>
...
The [Conversation History API](/ai-for-service/apis/automation/conversation-history) response includes a `messages.tags.altText` parameter that captures the configured Alternate Text values.
...
![JS template editor](/ai-for-service/analytics/overview/images/js-editor-alternate-text.png)

After the user selects an account type, the Alternate message appears in Chat History above the `{} JavaScript` tag.

![Chat history alternate message](/ai-for-service/analytics/overview/images/chat-history-alternate-message.png)
...
<Note>
- You can't add the same key to a message more than once.
...
2. Click **+Message Tag**.
    ...
    ![Message Tags 1](/ai-for-service/analytics/overview/images/message-tags-1.png)

3. In the **Add Message Tag** window, enter the **Key** and **Value**.

    ![Message Tags 2](/ai-for-service/analytics/overview/images/message-tags-2.png)

4. Click **Save**. The new tag appears below the message in the transcript slider.

    ![Message Tags 3](/ai-for-service/analytics/overview/images/message-tags-3.png)
...
![Feedback Survey](/ai-for-service/analytics/overview/images/feedback-survey.png)
...
1. **Start Time** and **End Time**, along with real-time counts for:
    ...
    ![Conversation Summary 1](/ai-for-service/analytics/overview/images/conversation-summary-1.png)
