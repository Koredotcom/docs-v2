...
<Note>The **Wallboard under Analytics** option is visible only when the Contact Center Wallboards in Analytics permission is enabled. [Learn more](/ai-for-service/user-management/users-and-role#flows-and-routing)</Note>
...
![Center wide Wallboard](/ai-for-service/analytics/contact-center/images/ccai-center-wide-wallboard.png)
...
![Launch Wallboard in New Tab](/ai-for-service/analytics/contact-center/images/launch-wallboard-new-tab.png)
...
![Top Section](/ai-for-service/analytics/contact-center/images/center-wide-abandoned-top-widgets.png)
...
![Bottom Section](/ai-for-service/analytics/contact-center/images/bottom-widget-metrics.png)
