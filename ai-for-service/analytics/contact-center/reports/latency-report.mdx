...
9. Select **Create**.
   ...
   ![Create Report](/ai-for-service/analytics/contact-center/reports/images/create-latency-report.png)

10. An instance of the Latency Report is generated.

    ![Report Created](/ai-for-service/analytics/contact-center/reports/images/latency-report-created.png)

11. Select the **Run** icon next to the report instance.

    ![Run Report](/ai-for-service/analytics/contact-center/reports/images/run-latency-report.png)
...
12. Select the **CSV** icon to generate the report output.
    ...
    ![Generate Output](/ai-for-service/analytics/contact-center/reports/images/latency-report-csv.png)
...
13. The system generates the Latency Report.
    ...
    ![Report Output](/ai-for-service/analytics/contact-center/reports/images/latency-report-csv-output.png)
