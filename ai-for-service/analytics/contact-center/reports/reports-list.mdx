...
| [Agent Group Membership Report](/ai-for-service/analytics/contact-center/reports/agent-group-membership-report) | A detailed report of an agent's group memberships. |
...
| [Agent Response Usage Report](/ai-for-service/analytics/contact-center/reports/agent-response-usage-report) | Tracks how many times agents used each standard response and secure form over a selected date range. |
