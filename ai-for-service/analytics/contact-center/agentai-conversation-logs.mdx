...
* **Transcripts of customer-agent conversations and AI suggestions** — Each AI suggestion shows copy, sent, thumbs up, or thumbs down icon based on the action the agent takes on it. The negative feedback reason is also visible on hovering over the feedback icon.
...
![ai-suggestion-translate-and-summary](/ai-for-service/analytics/contact-center/conversation_logs/ai-suggestion-translate-summary.png)
