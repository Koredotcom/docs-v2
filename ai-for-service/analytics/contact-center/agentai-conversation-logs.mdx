...
2. Go to **Agent AI** > **Analytics** > **Agent AI Logs**. The default view shows conversation records for the current day.
...
4. Select the **Calendar** to filter conversation records by **Today**, **Yesterday**, **Last 7 Days**, **Last 15 Days**, **Last 30 Days**, **Last 90 Days**, or **Custom Range**. The total conversation count for the selected range updates next to the **Conversation Logs** heading. 
...
<Note>
- Turn on the Agent Coaching feature for Overall Sentiment to display.
...
This feature lets you locate conversations using filters. By default, the calendar shows only current-day logs (Today). You can also search for a specific conversation by entering its Conversation ID.
