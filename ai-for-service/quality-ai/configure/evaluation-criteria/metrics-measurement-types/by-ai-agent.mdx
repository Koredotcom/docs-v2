...
| **Negative Weightage** |  Assign the negative weight when the criterion isn't met |
...
Configures metadata sent in the `requestMeta` object of the [Execute API](/agent-platform/v1/apis/agentic-apps/execute#sample-request) request. 
...
3. Add multiple mappings using **+ Add Custom Field**.
   ...
   ![Custom Field Propagation](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/images/sub-criteria-weightage.png)
...
1. Follow the [Response format](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/by-ai-agent#response-format-for-sub-metrics) specification.
