...
_ **Contents**: The `conversationId` (always included for Agent AI and Express sources) and custom fields configured for the metric, represented as key-value pairs. 
