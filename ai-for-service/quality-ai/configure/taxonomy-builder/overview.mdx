...
- Use when secondary issues shouldn't affect resolution metrics.
- Example: The customer's payment issue is resolved, but a casual rewards question isn't — the contact is still marked resolved.
