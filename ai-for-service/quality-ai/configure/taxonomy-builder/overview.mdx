...
- Example: A customer calls about a payment issue and mentions a rewards question. If the payment is resolved but the rewards question isn't, the contact is marked unresolved.
...
- Example: The customer's payment issue is resolved, but a casual rewards question isn't — the contact is marked resolved.
