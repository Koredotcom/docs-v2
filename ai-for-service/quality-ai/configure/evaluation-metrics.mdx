...
For full configuration details, see [By Transfer Etiquette](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/by-transfer).
