...
10. Select **Next**.
   ...
   <Note>Always keep one scorecard as the default. The system automatically sets the first scorecard you create as default. To disable the default toggle, first set another scorecard as default.</Note>    
