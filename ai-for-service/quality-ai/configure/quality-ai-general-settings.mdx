...
Audit Visibility controls what evaluation information agents can view after interactions are audited.

**Configure Audit Visibility**

In **Audit Settings** and configure the required options.
