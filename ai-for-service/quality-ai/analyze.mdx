...
The **AutoQA** section of Quality AI provides dashboards, analytics, and audit tools to help supervisors, QA managers, and agents monitor performance, evaluate interactions and make data-driven coaching decisions.
...
| [My Dashboard - Coaching Assignments](/ai-for-service/quality-ai/analyze/my-dashboard-coaching-assignments)               | Manage assigned coaching sessions, review interactions, and track coaching progress, feedback, and outcomes.                       |
...
| [Calibration Sessions](/ai-for-service/quality-ai/analyze/calibration-sessions) | Guide to conducting calibration sessions for consistent evaluation standards.                                                         |
