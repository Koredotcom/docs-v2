...
If the form disables multi-round re-disputes, no further Dispute option is available. A message displays explaining the re-evaluation decision is final. See [Dispute Restrictions and Limitations](#dispute-restrictions-limitations).
