...
- The agent receives the updated metric and can provide a new acknowledgement or dispute response.
...
Every edit creates a new **Audit Trail** entry recording the edited metric, the previous response, the updated response, who made the change, and when. See [Audit Trail](/ai-for-service/quality-ai/analyze/ai-assisted-manual-audit#audit-trail) Tab.
...
| **Audit Review Label**  | Displays the current audit stage. See the below [Audit Review Status](/ai-for-service/quality-ai/analyze/ai-assisted-manual-audit#audit-review-status) labels.                                                     |
