...
- **Timestamps aren't included**: For omission scenarios where expected behavior is missing and no specific message or event caused the outcome. 
...
QA users (auditors or supervisors) can self-assign unclaimed interactions for auditing. Interactions that are audited, completed, or assigned to another user aren't eligible.
