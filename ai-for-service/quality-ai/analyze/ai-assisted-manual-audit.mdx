...
AI-Assisted Manual Audit allows supervisors and QA teams to evaluate voice and chat interactions by combining AI-generated insights with manual scoring in a single workspace. When **Agent Accept & Dispute** is enabled, agents review evaluation results, acknowledge metric scores, and raise disputes, while supervisors review disputed metrics and make re-evaluation decisions.
...
1. Select **Submit** to complete the audit. If the evaluation form has disputes configured, the completed evaluation is surfaced to the agent for acknowledgement or dispute. 
...
| Element                | Description                                                                                                                       |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Review Progress**    | Displays the percentage of completed metric evaluations and the number of completed metrics against the total configured metrics. |
...
| **Response Options**   | Allows the supervisor to select the evaluation outcome, such as **Yes**, **No**, or **N/A**.                                      |
...
When a metric dispute occurs, the system allows supervisors to review the dispute history and take one of the following actions
...
| **Dispute Comment**    | Allows the agent to provide justification when disputing a metric.                          |
...
![Agent Review Panel](/ai-for-service/quality-ai/analyze/ai-assist-manual-edit/images/pending-supervisor-review.png)
