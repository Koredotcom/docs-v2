...
Every edit creates a new **Audit Trail** entry recording the edited metric, the previous response, the updated response, who made the change, and when. See [Audit Trail](#audit-trail) Tab.
