...
- If the QA User has marked the same agent and the mark is pending, the Audit Screen displays a confirmation message indicating that the agent already exists in the Coaching Candidates queue.
