...
| **Agent Accept & Dispute** | Enable **Agent Accept & Dispute** in **Quality AI** > **Settings** > **Quality AI General Settings** to activate the metric-level acknowledgment and dispute workflow. |
