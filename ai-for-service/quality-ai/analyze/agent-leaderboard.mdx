...
Users with Cross Queue Data Access can view performance across all queues; otherwise, the leaderboard is limited to assigned queues. By default, it displays data for the last 7 days across all languages, channels, and contact directions.
