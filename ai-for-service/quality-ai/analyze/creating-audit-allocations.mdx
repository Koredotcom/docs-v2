...
[Create Allocations](/ai-for-service/quality-ai/analyze/allocations/images/settings.png)
...
5. Enter the **Minimum Duration Threshold** under the Random Allocation. 
...
<Note> This setting is configurable per queue, agent, or channel, allowing independent sampling behavior across allocation rules. </Note>
