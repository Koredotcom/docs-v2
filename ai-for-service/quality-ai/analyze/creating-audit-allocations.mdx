...
| State   | Behavior                                                                                                                                                     |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **On**  | Allow agents to acknowledge or dispute metric-level scores for evaluations under this allocation.                                                            |
...
| State   | Behavior                                                                                                    |
| ------- | ----------------------------------------------------------------------------------------------------------- |
| **On**  | Allow agents to dispute QA re-evaluations and initiate additional rounds up to the configured limit.        |
