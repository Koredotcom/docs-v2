...
| Metric | Description |
|--------|-------------|
| **Total Interactions** | Total interactions handled in the selected period, with % change vs. previous period. |
| **Kore Evaluation Score** | Average Auto QA score for completed interactions, with trend indicator. |
| **No. of Supervisor Audits** | Total number of interactions manually audited by a supervisor for the selected period. |
| **Supervisor Audit Score** | Average score of manually audited interactions for the selected period. |
| **Total Coaching Assignments** | Total number of coaching sessions assigned to the agent during the selected period. |
| **No. of Fails** | Interactions that fell below the configured pass score. |
...
Helps supervisors how effectively customer issues are resolved across different L3 topics. It helps supervisors to identify which topics are performing well and which need attention.
...
| **Resolved or Unresolved Breakdown** | Counts and percentages of resolved and unresolved conversations per topic. |
...
| Option | Action |
|--------|--------|
| **View All Topics** | Opens **Topic Discovery** and navigate to full topic analysis. |
| **View Conversations** | Opens **Conversation Mining** and drill down into specific interactions.  |
