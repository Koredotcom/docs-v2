...
The Dashboard metrics allow you to filter and refine the data displayed across the entire Agent Dashboard by selected languages, date range, channel, and contact direction.
...
Use the **Select Scorecard** dropdown to filter insights for a specific scorecard. All data in both tabs updates based on the selected scorecard and time range.
...
| Section | Description |
|--------|-------------|
| **Strongest Attributes** | Displays the top 5 highest-scoring attributes based on adherence for the selected scorecard and time period, highlighting where the agent consistently performs well. |
| **Opportunity Areas** | Displays the bottom 5 lowest-scoring attributes for the selected scorecard and time period, highlighting areas that need coaching attention. |
...
| **Score or Adherence %** | Adherence percentage score for that metric |
