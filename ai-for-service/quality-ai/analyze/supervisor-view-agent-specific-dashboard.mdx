...
2. Select an agent to open their dashboard **Overview**.
   ...
   <Note> Enable **Auto QA**, **Agent Scorecard**, and **Agent Access to Scored Interactions** in **Quality AI Settings** to view evaluation scores and coaching insights.</Note>
...
Metrics are based on evaluation forms assigned to the agent at the queue level.
