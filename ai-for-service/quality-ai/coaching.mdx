...
| Component                         | Who Uses It              | Purpose                                                                                                            | Access                                 |
| --------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------- |
| [**Coaching Assignments**](#create-coaching-assignments)| Supervisors and QA users | Create, manage, and assign individual or group coaching assignments using evaluation metrics and agent attributes. | —                                      |
| [**Marked for Coaching**](#create-coaching-assignments)| Supervisors and QA users | Organize coaching candidates into groups, manage marked interactions, and dispatch coaching assignments in bulk.   | QA Functionalities Access              |
| [**Coaching Monitor**](#coaching-monitor)              | Supervisors and QA users | Track assignment progress, measure coaching effectiveness, and monitor score improvements by coaching area type.   | —                                      |
| [**Coaching Assignments**](#agent-view-of-coaching-assignments) | Agents          | Review assigned coaching activities, interactions, feedback, action plans, and best-response examples.             | Agent Dashboard + Coaching Assignments |
...
| -------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------- |
| **Coaching Assignments** | View and complete individual assignments only. No group visibility. | Create, manage, and track individual and group coaching assignments using evaluation metrics and agent attributes. | —                         |
| **Marked for Coaching**  | View access only where applicable.                                  | Manage coaching candidates, create groups, and dispatch assignments in bulk.                                       | QA Functionalities Access |
| **Coaching Monitor**     | No access.                                                          | Track coaching progress and performance trends by coaching area type.                                              | —                         |
| **Group Coaching**       | Receives individual assignments only. Group context isn't visible. | Create and manage group coaching workflows.                                                                        | QA Functionalities Access |
