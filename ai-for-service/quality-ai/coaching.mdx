...
<Note> The system displays *Pending Agent Review* and *Pending Supervisor Review* display only when you enable **Agent Accept & Dispute** in **Quality AI** > **Settings** > **Quality AI General Settings** and configure disputes in the evaluation form for the associated interactions.</Note>
