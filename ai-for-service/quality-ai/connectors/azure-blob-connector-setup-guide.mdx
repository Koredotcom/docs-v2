...
https://accountname.blob.core.windows.net/container/conversations/
...
| **Region**              | Azure storage account region.                   |
| **Authentication Type** | Connection String.                              |
| **Connection String**   | Required authentication value when using Connection String.  |
| **Channel**             | Unified Path or Separate Paths for Voice and Chat.      |
| **Voice Path**          | Blob path for voice recordings.                 |
| **Chat Path**           | Blob path for chat transcripts.                 |

**Channel Configuration Storage Paths**

Choose one configuration method:
* **Unified Path**: Configure a single Blob path containing both voice and chat content.
* **Separate Paths**: Configure independent paths for Voice or Chat interactions.
