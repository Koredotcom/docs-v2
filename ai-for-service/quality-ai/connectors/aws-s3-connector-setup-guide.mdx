...
│
├── metadata.csv
│   └── Contains all interaction metadata
│
├── audio/
│   ├── conv-123456.wav
│   │   └── Stereo recording
│   ├── conv-123457-agent.wav
│   │   └── Mono recording (agent only)
│   ├── conv-123457-customer.wav
│   │   └── Mono recording (customer only)
│   └── conv-123458.wav
│       └── Stereo recording
│
├── chat/
...
- All file sizes are under 50 MB, and file names do not contain spaces.
