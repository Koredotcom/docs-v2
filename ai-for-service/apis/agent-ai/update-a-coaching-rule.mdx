...
| `createdOn` | String | Date and time when the coaching rule was created. Format: ISO 8601 DateTime. |
...
| `lModOn` | String | Date and time when the coaching rule was last modified. Format: ISO 8601 DateTime.|
