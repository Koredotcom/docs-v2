...
| **Scope**         | `AgentAssist Analytics` — See [Associate API Scopes](../automation/api-introduction.md#associating-api-scopes) |
...
| `results.messages.author.type` | String | Type of the message author. |
