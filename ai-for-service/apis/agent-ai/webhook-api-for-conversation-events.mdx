...
sidebarTitle: Webhook API for Conversation Events
redirects:
  - /ai-for-service/apis/agent-ai/hooks-api-for-internal-transfers
  - /ai-for-service/apis/agent-ai/conversation-summary-trigger-api
  - /ai-for-service/apis/agent-ai/end-of-conversation-api
---
