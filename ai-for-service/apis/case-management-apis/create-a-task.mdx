...
| `userInfo.emailId`     | Optional | String | User's email address. Mandatory if `_id` isn't entered.                                      |
| `userInfo.phoneNumber` | Optional | String | User's phone number. Mandatory if `_id` isn't entered.                                       |
