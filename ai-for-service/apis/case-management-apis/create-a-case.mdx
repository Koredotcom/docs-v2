...
| `emailId` | Required | String | User's email address. Mandatory if `userInfo._id` isn't present. |
| `phoneNumber` | Required | String | User's phone number. Mandatory if `userInfo._id` isn't present. |
