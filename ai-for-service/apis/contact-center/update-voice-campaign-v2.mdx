---
title: Update Voice Campaign by ID v2
sidebarTitle: Update Voice Campaign v2
---
...
| `data.dncLists.id` | Unique identifier of the contact list in the DNC list. | string |
