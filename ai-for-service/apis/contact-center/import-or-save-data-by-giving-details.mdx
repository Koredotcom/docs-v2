---
title: Import or Save Data by Giving Details
sidebarTitle: Import Save Data
---
...
<Note>This version will be deprecated soon. Please use [Version 2](/ai-for-service/apis/contact-center/import-or-save-data-by-giving-details-v2) of this API.</Note>
...
|:-------------------|:----------------------------------------|:---------------|
| `Data`            | The data that's to be imported.       | string, required |
...
[
    {
        ...
        "configuration": {
            "description": "If no other wait experiences are defined or if contacts don't meet the conditions for other wait experiences, they will land into the default wait experience",
