...
| `fromTimeStamp` | Start date and time in ISO 8601 format (for example, `2023-01-07T09:45:00Z`). Optional if fetching call records from the first available record for initial syncs.            | String, optional   |
