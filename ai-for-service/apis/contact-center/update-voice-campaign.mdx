---
title: Update Voice Campaign by ID
sidebarTitle: Update Voice Campaign
---
...
| **Parameter** | **Description** | **Type** |
| :---- | :---- | :---- |
| `name` | Name of the campaign. Used to identify it. The name must be a maximum of 48 characters. | string, required |
...
| `dialingStrategy.callingHours.days` | List of allowed calling time blocks. Each object should include: day ('MO', 'TU', 'WE', 'TH', 'FR', 'SA', 'SU'), start ("9:00 AM"), and end ("6:00 PM"). | array[object], required |
