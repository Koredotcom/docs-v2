---
title: Update SMS Campaign API
sidebarTitle: Update SMS Campaign
---
...
--data '{
    ...
    "description": "Updated: This campaign sends an SMS with a link or instructions to interact with a Platform. Customers can check order status, raise tickets, or get help—all via chat-enabled SMS.",
    "contactLists": [
