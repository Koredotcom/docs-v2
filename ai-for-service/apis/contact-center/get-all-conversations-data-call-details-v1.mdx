---
title: Get All Conversations Data - Call Details v1
sidebarTitle: Conversations Call Details v1
---
...
| `timeZoneOffset` | The time zone offset. Example values: `-330`, `630`, `-500`.  | number, required       |
    ...
    "data": [
        ...
        },
      {
        ...
        },
        {
            ...
            "dispositionRemarks": [
                "The bot initiated a transfer to an agent and thanked the customer for waiting. The agent then joined the conversation but didn't provide any specific assistance or details. The bot informed the customer that Uat has now closed the conversation and encouraged them to reach out again if needed."
            ],
            "metaInfo": {
                "workinghours": {
                    "workdays": "mon,tue,wed,thu,fri",
...
| `destinations.respondingAgent.firstResponseTime`                            | YYYY-MM-DDTHH:MM:SS           | The time at which this agent first responded.                                                                                                                                                                                                          | `2023-01-10 2:25:54`                                                                                       |
...
| `destinations.respondingAgent.interactionEndTime`                           | YYYY-MM-DDTHH:MM:SS           | The time at which interaction with this agent ended.                                                                                                                                                                                                   | `2023-01-10 2:25:54`                                                                                       |
...
| `destinations.respondingAgent.afterCallWorkEndTime`                         | YYYY-MM-DDTHH:MM:SS           | Time when this agent completed post-call work.                                                                                                                                                                                                         | `2023-01-10 2:25:54`                                                                                       |
...
| `destinations.respondingAgent.assignedAt`                                   | YYYY-MM-DDTHH:MM:SS           | Time at which this contact was assigned to this Agent.                                                                                                                                                                                                 | `2023-01-10 2:25:54`                                                                                       |
| `destinations.respondingAgent.acceptedTime`                                 | YYYY-MM-DDTHH:MM:SS           | Time at which this Agent accepted the contact.                                                                                                                                                                                                         | `2023-01-10 2:25:54`                                                                                       |
