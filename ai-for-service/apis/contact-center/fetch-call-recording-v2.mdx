---
title: Fetch Call Recording v2
sidebarTitle: Fetch Call Recording v2
---
...
!!! NOTE
    ...
    The earlier version of the [Call Recording API](/ai-for-service/apis/contact-center/fetch-call-recording) is expected to be deprecated in the future. We will ensure existing customers receive sufficient advance notice. However, we recommend that new customers utilize v2 moving forward.
...
| `media_unavailable` | The recording isn't available on the server.              |
