...
Requests are monitored against a sixty-second limit. As long as the limit is not exceeded, the account or application can continue making requests.
...
Need a higher or custom rolling Rate Limit? Contact [Support](https://www.support.kore.ai).
