---
title: Get All Contact Details Voice Campaigns
sidebarTitle: Contact Details Voice
---
...
| `limit`    | Maximum number of records per page. Must be an integer between 1 and 100. Validations: Must be a number, Must be an integer, Minimum value: 1, Maximum value: 100 | number, optional |
