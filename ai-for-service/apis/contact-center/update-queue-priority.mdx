---
title: Update Queue Priority
sidebarTitle: Update Queue Priority
---
...
<Note> The Dynamic Queue Reprioritization toggle must be enabled at the UI level to update queue priorities through the Update Queue Priority API. If this toggle is disabled, any priority updates made through the API are not reflected.</Note>
...
| Parameter                   | Description                                                                                                      | Type/Required              |
|:----------------------------|:------------------------------------------------------------------------------------------------------------------|:-------------------|
| `queuePriorityData`          | List of queue-priority mappings used to influence routing order.                                                 | array of objects, required  |
