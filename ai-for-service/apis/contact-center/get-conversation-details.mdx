...
sidebarTitle: Get Conversation Details
---
...
|:------------------|:-----------------|:-----------|
| `accept`        | Supported response type. Must be `application/json`. | Required |
| `accountid`     | Identifies the customer account. | Required |
