---
title: Outbound Calling VG
sidebarTitle: Outbound Calling VG
---
...
{/* AG: parameters must be in backticks. */}
...
| timers              | An object containing various timeout properties. [Learn more](/ai-for-service/apis/contact-center/outbound-calling-vg#timers-configuration) | object, optional |
