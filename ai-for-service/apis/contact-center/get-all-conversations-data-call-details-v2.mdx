...
| Parameter        | Description                                                                                                                                                                                                                                                                                                                                                 | Type                    |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------|
| `startDate`    | The start date from which records are considered. Format: `yyyy-mm-dd HH24:mm:ss`. Example: `2022-08-25 07:20:15`                                                                                                                                                                                                                                   | DateTime, required      |
| `endDate`      | The end date up to which records are considered. Format: `yyyy-mm-dd HH24:mm:ss`. Example: `2022-08-25 18:20:15`                                                                                                                                                                                                                                   | DateTime, required      |
...
| `snoozeinfo`     | Indicates the number of times and duration of a customer who is to be placed on snooze.                                                                                                                                                                                                                                                                                                 | array[string], optional |
...
```json expandable=true
{
            "conversationId": "c-89502b3-e29c-4561-9233-4ba756269230",
            "sessionId": "6a4d318973438d8327625016",
            "channel": "Web/Mobile Client",
            "isVoicemail": "NO",
            "Direction": "Inbound",
            "skills": [],
            ...
            "errorDetails": "",
            "botId": "st-a1dce41e-496a-5111-b5c9-6c3221e87df2",
            "dispositions": [
                "System Generated"
            ],
            "dispositionRemarks": [
            ...
            "metaInfo": {
                ...
                "_id": "u-a1b63c5f-ecc6-55ce-bd44-c281b6196c89",
                "identities": [
                    {
                        "val": "cs-73e551fb-8920-5398-8288-cd0dbe142487/d7589392-0a4b-4335-a4eb-d93fb9c7b83519ca066f-a600-4846-84e5-bf054d260c1d",
                        "type": "mapped"
                    },
                    {
                        "val": "6a46030735c6731367b8cfdb/agentassist/c-db8aa6b-0884-47c2-a4e2-274628c146c1",
                        "type": "mapped"
                    }
                ],
                "agentTransferConfig": {
                    ...
                    "automationBotId": "st-a1dce41e-496a-5111-b5c9-6c3221e87df2",
            ...
            "channelSpecificUserId": "cs-73e551fb-8920-5398-8288-cd0dbe142487/d7589392-0a4b-4335-a4eb-d93fb9c7b83519ca066f-a600-4846-84e5-bf054d260c1d",
            "userId": "u-a1b63c5f-ecc6-55ce-bd44-c281b6196c89",
            "destinations": [
                {
                    "destinationType": "QueueEntry",
                    "queueId": "qu-deb6296-1ccc-438a-a03a-8043dc2702a8",
                    "queueName": "Default Queue",
                    "CallbackOpted": false,
                    "EnterTime": "2026-07-07T22:38:16",
                    "respondingAgent": {
                        "agentId": "u-21463d6e-3235-526a-920a-f10c75a14fea",
                        "agentNotes": [],
                        "destinationType": "AgentSegment",
                        "status": "Answered",
                ...
                {
                    "agentId": "u-72528ebc-d7df-597c-ad09-de020d442e56",
                    "agentNotes": [
                    ...
                    "ConsultingAgents": [],
                    "JoinedUsers": [],
                    "email": "sit_uxo987@mailinator.com",
                    "name": "sit uxo",
...
| `sessionStartTime` | YYYY-MM-DDTHH:MM:SS | Start time of the session. | 2023-01-10T2:25:54 |
| `sessionEndTime` | YYYY-MM-DDTHH:MM:SS | End time of the session. | 2023-01-10T2:25:54 |
...
| `snoozeinfo` | YYYY-MM-DDTHH:MM:SS | Indicates the number of times and duration of a customer who is to be placed on snooze. | 2023-01-10T2:25:54 |
...
| `agentChoseTranslate` | Boolean | Indicates whether an Agent requires translation during his segment of the conversation. | True |
...
| `destinations.EnterTime` | String (ISO 8601 datetime) | Time at which this conversation entered this queue. | 2023-01-10T2:25:54 |
...
| `destinations.respondingAgent.firstResponseTime` | YYYY-MM-DDTHH:MM:SS | The time at which this agent first responded. | 2023-01-10T2:25:54 |
...
| `destinations.respondingAgent.interactionEndTime` | YYYY-MM-DDTHH:MM:SS | The time at which the interaction with this respondingAgent ended. | 2023-01-10T2:25:54 |
...
| `destinations.respondingAgent.afterCallWorkEndTime` | YYYY-MM-DDTHH:MM:SS | The time when this agent completed post-call work. | 2023-01-10T2:25:54 |
...
| `destinations.respondingAgent.assignedAt` | YYYY-MM-DDTHH:MM:SS | The time at which this conversation was assigned to the Agent. | 2023-01-10T2:25:54 |
| `destinations.respondingAgent.acceptedTime` | YYYY-MM-DDTHH:MM:SS | The time at which this Agent accepted this conversation. | 2023-01-10T2:25:54 |
