...
| `skillGroupId`    | ID of the skill group. Find this with [GET /skill-groups](../contact-center/get-a-skill-group.md). For example, `sg-4372`. | string, required |
| `agents`          | An array of agent objects with the following details.                                                               | array, optional  |
| `userId`          | User ID. Find this with [GET /agents](../contact-center/list-all-agents.md).                                        | string, optional |
