---
title: Delete a Specific Agent from a Particular Agent Group
sidebarTitle: Delete Agent from Agent Group
---

Use this API to delete a particular agent with the given `streamId` and `agentId`.
