...
The deletion does not proceed if the requested user is:
...
<Note>
To check the execution status of this request, use the [Delete Customer Data Status API](delete-customer-data-status.mdx).
</Note>
