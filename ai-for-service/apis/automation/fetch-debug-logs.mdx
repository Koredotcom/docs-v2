...
| `channelType` | Enter the channel type to fetch logs. Channel type such as `rtm`, `ivrVoice`, `audiocodes`, `smartassist`, `korevg`, `twiliosms`, `genesys`, `genesysV2`, `genericsms`, `agentassist`, and `webhook` |
