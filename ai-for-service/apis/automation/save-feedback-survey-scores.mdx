---
title: Save Feedback Survey API
sidebarTitle: Save Feedback Survey Scores
---
<Badge icon="arrow-left" color="gray">[Back to API List](/ai-for-service/apis/automation/api-list)</Badge>

To save feedback survey scores provided by users and push data for visualization on the **Feedback Analytics** module using the Survey Type and Survey Name.

| Field | Value |
|---|---|
| **Method** | POST |
| **Endpoint** | `https://{{host}}/api/1.1/public/bot/{{BotID}}/saveFeedback` |
