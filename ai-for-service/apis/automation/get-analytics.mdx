...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------|
| **Method**        | POST                                                                                                                             |
| **Endpoint**      | `https://{{host}}/api/public/bot/{{BotID}}/getAnalytics?includeMeta=true`                                                                         |
...
| `NLAnalysis.skipConversation`                        | Boolean          | If set to `true`, skips the conversation record. If `false`, doesn't skip the conversation.                                                                                                                                                                                                                                                                                                       |
