...
| Parameter | Required | Description |
|---|---|---|
| `fileId` | Required | The unique identifier (ID) of the file to be imported. This ID can be retrieved from the response of the [Upload File API](upload-file.mdx) after uploading the Bot Functions file. |
