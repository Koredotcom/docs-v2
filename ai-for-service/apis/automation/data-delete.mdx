---
title: Data Delete API
sidebarTitle: Data Delete
---
...
| **App Access** | Read and Delete access to the Data Table from the Data Definition in DaaS. For more information, see [app assignment for accessing the data in a table](../../../administration/data/data-table/) and [Data as a Service](../../../administration/data/data-as-service). |
