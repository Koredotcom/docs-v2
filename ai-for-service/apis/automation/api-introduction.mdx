...
- Create one or more apps. [Learn more](/ai-for-service/administration/data/data-as-service).
...
- Grant the app read, write, and delete permissions to each table and view separately. [Learn more](/ai-for-service/administration/data/data-as-service).
...
<Note>
After enabled, the API Scopes must be Published. [Follow the Publish](/ai-for-service/deploy/publishing-bot) process to ensure that the API Scopes are selected.
</Note>
