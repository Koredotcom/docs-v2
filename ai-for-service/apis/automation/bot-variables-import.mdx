...
| `ignoreEnvironmentVariables` | boolean | Set to `true` to exclude environment variables during import. | Optional |
| `ignoreContentVariables` | boolean | Set to `true` to exclude content variables during import. | Optional |
