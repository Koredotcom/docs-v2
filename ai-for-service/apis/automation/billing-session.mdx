...
|---|---|
| **Method** | POST |
| **Endpoint** | **For Dialog Builder**: `https://{{host}}/api/public/bot/{{BotID}}/getBillingSessionsDetails`; <br /><br />  **For Admin Console**: `https://{{host}}/api/public/bots/getBillingSessionsDetails` |
| **Content Type** | `application/json` |
| **Authorization** | `auth: {{JWT}}` See [How to generate the JWT Token](/ai-for-service/apis/automation/api-introduction/#generating-the-jwt-token). |
| **API Scope** | **Dialog Builder**: App Settings > Dev Tools > API Scopes > Automation Billing Sessions <br /> **Admin Console**: Security > API Scopes > BotAnalytics > Billing Sessions |
