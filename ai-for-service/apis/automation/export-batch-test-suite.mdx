...
Exports test cases from a Batch Test Suite and returns a download link. This API supports exporting test cases created through file upload only — it doesn't support test data added manually.
