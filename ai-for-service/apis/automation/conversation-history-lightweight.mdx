...
```bash
curl --location 'https://{{host}}/api/public/bot/{{botId}}/messages-lite?channelType=web-sdk&channelUId={{channelUId}}' \
  ...
  "messages": [
    {
      ...
      "type": "incoming",
      "createdBy": "u-***",
      "createdOn": "2026-05-17T14:02:11.000Z",
      "sessionId": "s-***",
      "chnl": "rtm",
      "components": [ { "cT": "text", "data": { "text": "hi" } } ],
      "channels": [
        {
          "from": "ch-user-abc",
          "to": "bot",
