...
<Note>
If the bot language isn't included in the header, English is used as the default language for training. See the list of supported bot languages [here](/ai-for-service/app-settings/language-management/building-multi-language-bots).
</Note>
