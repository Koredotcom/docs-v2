...
To fetch the publish status of a given agent or the last completed status request for the agent. To initiate the Publish API, refer to [Publish Bot](../automation/publish-bot.mdx).
