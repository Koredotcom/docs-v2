...
<Note>
This API only initiates the export process. Use the [Export Status API](bot-export-status.mdx) to view the export progress and obtain a download link once the export completes.
</Note>
