...
To get the status of the Batch Test Execution request against a unique Request Id, and provide the download link for the results file after test execution is complete. Refer to the [Batch Test Execution API](batch-test-execution.md) to learn more.
