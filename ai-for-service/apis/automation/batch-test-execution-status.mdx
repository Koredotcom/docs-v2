---
title: Batch Test Execution Status API
sidebarTitle: Batch Test Execution Status
---
<Badge icon="arrow-left" color="gray">[Back to API List](/ai-for-service/apis/automation/api-list)</Badge>

To get the status of the Batch Test Execution request against a unique Request Id, and provide the download link for the results file after test execution is complete. Refer to the [Batch Test Execution API](/ai-for-service/apis/automation/batch-test-execution) to learn more.
...
| **BotID** | The *Bot ID* or *Stream ID* can be accessed under **General Settings** on the App Builder. | Required |
| **testSuiteName** | Name of the test suite created in the bot's platform that is being executed. | Required |
