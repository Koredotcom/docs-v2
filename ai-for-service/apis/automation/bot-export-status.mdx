...
Gets the status of a Bot Export request and provides the download link after the export completes. Refer to [Bot Export API](bot-export.mdx) to initiate an export.
