...
| `filters.from` | String | Yes | Start date and time for the survey response search range. A single API call supports querying up to 90 days of data and retrieving up to 50 records. Format: ISO 8601 DateTime.  |
| `filters.to` | String| Yes | End date and time for the survey response search range. A single API call supports querying up to 90 days of data and retrieving up to 50 records. Format: ISO 8601 DateTime. |
