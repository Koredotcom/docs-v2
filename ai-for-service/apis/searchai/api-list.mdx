...
|--------------------------------------------------------------------------------|------------------------------------------------------------------|------------------------------|
| [Answer Generation](/ai-for-service/apis/searchai/answer-generation)           | Fetch answers for a query using Search AI                        | Answer Generation            |
| [Advance Search V2](/ai-for-service/apis/searchai/advance-search)              | Fetch answers for a query using Search AI                        | Answer Generation            |
...
| [Analytics Metadata Ingestion](/ai-for-service/apis/searchai/analytics-metadata)| Send analytics metadata for search requests processed outside the application |  Feedback for Search AI |
| [Web Crawl APIs](/ai-for-service/apis/searchai/webcrawl)| Create Web source and crawl pages |  Data Ingestion|
