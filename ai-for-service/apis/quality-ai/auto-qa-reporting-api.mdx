...
This API returns interaction-level Auto QA scoring and metric qualification results based on the Quality AI form associated with each conversation.
...
| API Scope | Quality AI — See [Associate API Scopes](../automation/api-introduction.md#associating-api-scopes). |
...
| `Agents` | An array of agents who participated in the conversation. | `array` |
