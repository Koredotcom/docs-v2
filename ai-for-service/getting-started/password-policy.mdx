...
This document outlines the password requirements and security policies to access the Kore.ai Platforms, including AI for Service, AI for Process, and Agent Platform.
...
* **Password History**: You can't reuse any of your last **5 passwords**.
...
For enhanced security, enable Two-Factor Authentication on your account. When 2FA is enabled, you need both your password and a verification code to sign in.
