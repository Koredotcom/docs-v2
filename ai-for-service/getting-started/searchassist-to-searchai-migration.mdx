...
Some custom configurations are replicated as Advanced Configurations in Search AI, some configurations have been productized, and some custom configurations aren't replicated as they are no longer relevant. 
