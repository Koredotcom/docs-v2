...
This document provides archived information on the feature updates and enhancements introduced in **Search AI** of AI for Service (XO) v11.x past releases. For recent updates, see [the latest release notes](/ai-for-service/release-notes/search-ai).
