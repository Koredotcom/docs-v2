---
title: Voice Gateway Release Notes 2025 Archive
noindex: true
hidden: true
mode: center
---

<Badge icon="arrow-left" color="gray">[Back to the latest release notes](/ai-for-service/release-notes/voice-gateway)</Badge>
