...
This document provides information on the latest feature updates and enhancements introduced in **Search AI** of AI for Service (XO) v11.x releases. For previous updates, see release notes of [2025](/ai-for-service/release-notes/search-ai-2025) and [2024](/ai-for-service/release-notes/search-ai-2024).
