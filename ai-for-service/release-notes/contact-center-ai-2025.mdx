...
* Automated email alerts are sent to their registered Platform email.
...
All Deepgram voices can be selected, and Deepgram TTS can be set using call control parameters. This enables the use of Deepgram TTS across the Platform, with existing flows working successfully using Deepgram voices.
