...
The Voice Authentication (Voice Biometrics) feature is removed from the UI and is currently unavailable. Other Language & Speech configurations are not affected.
