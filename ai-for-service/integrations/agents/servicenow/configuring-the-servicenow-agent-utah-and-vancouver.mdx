...
4. On the **Configurations** tab, choose an authentication method:
   ...
   **Option 1: Basic Auth**
   ...
   ![Basic Auth](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img2.png)
   ...
   **Option 2: OAuth with Refresh Token**
   ...
   ![OAuth with Refresh Token](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img3.png)
...
7. Click **Configure** to map channels.
   ...
   ![Customize channel mapping](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img4.png)

8. Select channels to map to the ServiceNow agent.

   ![Map channels with ServiceNow agent](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img5.png)
...
2. Navigate to **System Definition > Plugins** from the left menu.
   ...
   ![System Definition - Plugins](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img6.png)

3. Search and install the following plugins:

   - **Omni-experience Standard Feature Set**

     ![Omni-experience Standard Feature Set](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img7.png)

   - **Advanced Work Assignment**

     ![Advanced Work Assignment](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img8.png)

   - **Customer Service Management**

     ![Customer Service Management](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img9.png)

   - **Glide Virtual Agent**

     ![Glide Virtual Agent](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img10.png)

   - **Virtual Agent API**

     ![Virtual Agent API](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img11.png)
...
2. Navigate to **Advanced Work Assignment > Management > Groups**.
   ...
   ![Groups](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img12.png)

3. Select the **Consumer Service Support** group.

   ![Group details](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img13.png)

4. Select the **Roles** tab and click **Edit**.

   ![Navigate to Roles screen](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img14.png)

5. Search for and assign the **awa_agent** and **agent_workspace_user** roles to the Consumer Service Support group. Click **Save**.

   ![Assign roles](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img15.png)

6. Go back to the group details screen, select **Group Members**, click **Edit**, and navigate to **Edit Members**.

   ![Edit members](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img16.png)

7. Search for and assign the required user (for example, `Abel Tuter`) to the Consumer Service Support group. Click **Save**.

   ![Assign user to group](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img17.png)

8. Click **Update** on the group details screen.

   ![Group details - Update](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img18.png)
...
2. Navigate to **System Web Services > Outbound > REST messages**.
   ...
   ![REST messages](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img19.png)

3. Select **VABot to Bot** from the list.

   ![VABot to Bot](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img20.png)
...
5. Paste it into the **EndPoint** field on the VABot to Bot edit screen.
   ...
   ![Endpoint - Webhook URL](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img21.png)

6. Scroll down, select **HTTP methods**, update the Webhook URL for **postMessage**, and click **Update**.

   ![HTTP Method - postMessage](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img22.png)
...
2. Create an Agent Transfer Node task (for example, `Platform Agent` task with a `UserAgent` node). See [Agent Transfer Node](/ai-for-service/automation/dialogs/node-types/agent-transfer-node).
   ...
   ![Agent Transfer Node task](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img23.png)

3. Click **Talk to Bot** and enter **Help**.
4. Log in to ServiceNow, go to **Profile**, and select **Impersonate User**.

   ![Impersonate user](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img24.png)

5. Select the username created (for example, `Abel Tuter`).

   ![Enter username](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img25.png)

6. Navigate to **Workspace Experience > Workspaces > Agent Workspace Home**.

   ![Agent Workspace Home](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img26.png)

7. In the Agent Workspace, select **Inbox** and set **Status** to **Available**.

   ![Status - Available](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img27.png)

8. When the user initiates chat, the conversation transfers to the ServiceNow agent and the connection is established.

   ![Connection established](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img28.png)
...
2. Before the agent transfer node, set meta info using a Script node:
   ...
   ![Entity nodes for user info](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img29.png)
...
1. In **Conversational Interfaces Home**, create a new context variable named `streamId`.
   ...
   ![New context variable streamId](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img30.png)

2. Define a Work item routing condition in the Queue using the `streamId` context variable.

   ![Work item routing condition](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img31.png)
...
- [ServiceNow: Create a work item queue](https://docs.servicenow.com/bundle/tokyo-servicenow-platform/page/administer/advanced-work-assignment/task/awa-create-queue.html)
  ...
  ![Create a work item queue](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img32.png)

- [ServiceNow: Virtual Agent Bot Integration API](https://developer.servicenow.com/dev.do#!/reference/api/tokyo/rest/bot-api)

  ![Virtual Agent Bot Integration API](/ai-for-service/integrations/agents/servicenow/images/configuring-the-servicenow-agent-utah-and-vancouver-img33.png)
