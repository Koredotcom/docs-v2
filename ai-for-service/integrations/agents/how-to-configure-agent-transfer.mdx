...
1. Open [Kore.ai App Builder](https://platform.kore.ai/auth/login).
...
3. Open or create a dialog task (e.g., `Support Call Back`) and add an **Agent Transfer** node.
   ...
   ![Add Agent Transfer node](/ai-for-service/integrations/agents/images/configure-agent-transfer-img1-at-node.png)
...
8. Enter the Callback URL:
   ...
   2. Copy the ngrok forwarding URL (format: `https://XXXXXXaa.ngrok.io`).
      ...
      ![NGROK forwarding URL](/ai-for-service/integrations/agents/images/configure-agent-transfer-img2-ngrok.png)
...
9. Open the dialog task and the agent transfer node to verify the configuration is saved. Select the required Events.
   ...
   ![Agent transfer node configuration](/ai-for-service/integrations/agents/images/configure-agent-transfer-img3-at-node-config.png)
...
11. Edit the BotKit SDK files:
    ...
    **`livechatapi.js`**
    ...
    ![livechatapi.js](/ai-for-service/integrations/agents/images/configure-agent-transfer-img4-at-livechatapi.png)
    ...
    **`config.json`**
    ...
    ![config.json](/ai-for-service/integrations/agents/images/configure-agent-transfer-img5-at-configjson.png)

    **`LiveChat.js`**
    - Set the `appId` and `appName` from your app.

    ![LiveChat.js](/ai-for-service/integrations/agents/images/configure-agent-transfer-img6-at-livechat.png)

    **`app.js`**
    - Add: `sdk.registerBot(require('./LiveChat.js'))`
    - Remove any existing `sdk.registerBot` statements that are not needed.

    ![app.js](/ai-for-service/integrations/agents/images/configure-agent-transfer-img7-at-appjs.png)
...
4. When a user initiates chat, the app transfers to an agent and notifies the user.
   ...
   ![Chat initiation](/ai-for-service/integrations/agents/images/configure-agent-transfer-img8-at-chat1.png)

5. The agent receives a notification on LiveChat.

   ![Agent receives notification](/ai-for-service/integrations/agents/images/configure-agent-transfer-img9-at-chat2.png)

6. The connection is established and the conversation continues.

   ![Connection established](/ai-for-service/integrations/agents/images/configure-agent-transfer-img10-at-chat3.png)
