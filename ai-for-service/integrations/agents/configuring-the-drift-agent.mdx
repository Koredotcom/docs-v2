...
2. Go to the App Store and click **Create New App**. Follow the [Drift quick-start guide](https://devdocs.drift.com/docs/quick-start) for instructions.
   ...
   ![Drift Developer Platform](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img1.png)
...
4. Add the redirect URL found on the **Configurations** tab of the Drift Agent in Kore.ai. Click **Add**.
   ...
   ![Add redirect URL](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img2.png)
...
5. Select the **WebHooks** tab and add the Kore.ai Drift Agent Webhook URL as the Request URL. Enable the following webhook scopes:
   ...
   ![Webhook scopes](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img3.png)
...
1. Under **Activate Your App**, click **Installing to Drift** and copy the **Install App to Drift** link to generate a non-expiring access token.
   ...
   ![Generating access token](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img4.png)
...
2. Copy the **Client ID**, **Secret ID**, and **Verification Token**.
   ...
   ![App Credentials](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img5.png)
...
4. Click the **Configurations** tab and enter:
   ...
   ![Drift agent credentials](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img7.png)
...
6. Click **Manage** to map channels to the Drift agent.
   ...
   ![Customizing the channel](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img8.png)

7. Select the channels to use Drift for handovers. 

   ![Mapping channels to Drift agent](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img9.png)
...
2. Create a new Agent Transfer Node task (e.g., a **Talk to Live Agent** task with a **LiveChats** node configured to use Drift). See [Agent Transfer Node](/ai-for-service/automation/dialogs/node-types/agent-transfer-node).
   ...
   ![New Agent Transfer Node task](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img10.png)
...
4. In the Bot Action script, enter:
   ...
   ![Bot Action script](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img11.png)
...
8. The connection is established and the conversation continues.
   ...
   ![Connection established](/ai-for-service/integrations/agents/images/configuring-the-drift-agent-img12.png)
