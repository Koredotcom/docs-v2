...
The Platform supports basic authentication for ServiceNow. See [App Authorization Overview](/ai-for-service/app-settings#authorization-profiles) for details.
...
3. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Authorization type - Basic auth](/ai-for-service/integrations/actions/images/servicenow-action-img2.png)
...
5. Click **Enable**. The **Integration Successful** pop-up is displayed.
   ...
   ![Integration successful](/ai-for-service/integrations/actions/images/servicenow-action-img3.png)
...
3. Select **Basic Auth**. See [App Authorization Overview](/ai-for-service/app-settings#authorization-profiles).
   ...
   ![Auth mechanism -- Basic auth](/ai-for-service/integrations/actions/images/servicenow-action-img4.png)

4. Click **Select Authorization** > **Create New**.

   ![Create new auth](/ai-for-service/integrations/actions/images/servicenow-action-img5.png)
...
5. Set **Authorization Type** to **Allow Users to Authorize the Integration** > **Basic Auth**, then enter the following credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/servicenow-action-img6.png)

6. Click **Save Auth**.

7. Select the new **Authorization Profile**.

   ![Select Auth profile](/ai-for-service/integrations/actions/images/servicenow-action-img7.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/servicenow-action-img8.png)

2. Click **Install** to begin installation.

   ![Begin installation](/ai-for-service/integrations/actions/images/servicenow-action-img9.png)

3. Once installed, click **Go to Dialog**. A dialog task for each template is auto-created.

   ![Dialog tasks for each template](/ai-for-service/integrations/actions/images/servicenow-action-img10.png)

4. Select the desired dialog task and click **Proceed**.

   ![Select desired dialog task and proceed](/ai-for-service/integrations/actions/images/servicenow-action-img11.png)
