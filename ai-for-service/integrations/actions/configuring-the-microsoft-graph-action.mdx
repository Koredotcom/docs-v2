...
3. Set **Authorization Type** to **Pre-authorize the Integration** > **OAuth**.
   ...
   ![Authorization type-OAuth](/ai-for-service/integrations/actions/images/ms-graph-action-img2.png)

4. Select the **System** card and click **Authorize**.

   ![Enable the Kore.ai's preconfigured Microsoft Graph app](/ai-for-service/integrations/actions/images/ms-graph-action-img3.png)
...
1. Select **Custom** and click **Select Authorization** > **Create New**.
   ...
   ![Create new authorization](/ai-for-service/integrations/actions/images/ms-graph-action-img4.png)
...
2. Select **OAuth v2**. See [Setting Up Authorization Using OAuth v2](/ai-for-service/app-settings/dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2).
   ...
   ![Auth mechanism type](/ai-for-service/integrations/actions/images/ms-graph-action-img5.png)
...
3. Enter the OAuth v2 credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/ms-graph-action-img6.png)

4. Click **Save Auth**, then select the new profile.

   ![Select auth profile to enable integration](/ai-for-service/integrations/actions/images/ms-graph-action-img7.png)

5. Click **Authorize**, enter credentials at `https://login.microsoftonline.com/`, and click **Allow Access**.
6. Click **Enable**.

   ![Integration enabled](/ai-for-service/integrations/actions/images/ms-graph-action-img8.png)
...
3. Set **Authorization Type** to **Allow Users to Authorize the Integration** > **OAuth**.
   ...
   ![Auth type - OAuth](/ai-for-service/integrations/actions/images/ms-graph-action-img9.png)

**System Authorization**

1. Select the **System** card.

   ![Enable the Kore.ai's preconfigured Microsoft Graph](/ai-for-service/integrations/actions/images/ms-graph-action-img10.png)
...
2. You can also select an existing profile:
   ...
   ![Existing auth profile](/ai-for-service/integrations/actions/images/ms-graph-action-img11.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/ms-graph-action-img12.png)

2. Click **Install** to begin installation.

   ![Begin installation](/ai-for-service/integrations/actions/images/ms-graph-action-img13.png)

3. Once installed, click **Go to Dialog**. A dialog task for each template is auto-created.

   ![Dialog task for each template](/ai-for-service/integrations/actions/images/ms-graph-action-img14.png)

4. Select the desired dialog task and click **Proceed**.

   ![Select desired dialog task](/ai-for-service/integrations/actions/images/ms-graph-action-img15.png)

5. The dialog task is auto-created and the canvas opens with all required entity nodes, service nodes, and message scripts.

   ![Canvas](/ai-for-service/integrations/actions/images/ms-graph-action-img16.png)
