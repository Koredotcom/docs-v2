...
The Platform supports basic authentication for Shopify. See [App Authorization Overview](/ai-for-service/app-settings#authorization-profiles) for details.
...
3. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type - Basic auth](/ai-for-service/integrations/actions/images/shopify-action-img2.png)
...
5. Click **Enable**. The **Integration Successful** pop-up is displayed.
   ...
   ![Integration successful](/ai-for-service/integrations/actions/images/shopify-action-img3.png)
...
4. Click **Select Authorization** > **Create New**.
   ...
   ![Create new authorization](/ai-for-service/integrations/actions/images/shopify-action-img4.png)
...
6. Enter the following credentials:
   ...
   ![Auth profile](/ai-for-service/integrations/actions/images/shopify-action-img5.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/shopify-action-img6.png)

   You can also click **Skip for Now** to install templates later.

   ![Skip for now](/ai-for-service/integrations/actions/images/shopify-action-img7.png)

2. Click **Install** to begin installation.

   ![Begin installation](/ai-for-service/integrations/actions/images/shopify-action-img8.png)
...
4. Select the desired dialog task and click **Proceed**.
   ...
   ![Select desired dialog task and proceed](/ai-for-service/integrations/actions/images/shopify-action-img9.png)

5. The dialog task is auto-created and the canvas opens with all required entity nodes, service nodes, and message scripts.

   ![Canvas for dialog task](/ai-for-service/integrations/actions/images/shopify-action-img10.png)
