...
2. The **Create a Deal** dialog task is added with the following components:
   ...
   ![Create a Deal dialog task added](/ai-for-service/integrations/actions/images/hubspot-tem-img4.png)
   ...
   - **createDealService** - Bot action service to create a deal. Click **+** to expand and click **Edit Request** to modify parameters.
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/hubspot-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img6.png)
   ...
   - **getAccountService** - Bot action service to get account details.
     ...
     ![getAccountService](/ai-for-service/integrations/actions/images/hubspot-tem-img7.png)
...
5. Follow prompts to create a deal:
   ...
   ![VA prompts to create a deal](/ai-for-service/integrations/actions/images/hubspot-tem-img8.png)

6. The new deal is created in HubSpot:

   ![New deal created](/ai-for-service/integrations/actions/images/hubspot-tem-img9.png)

7. Click **View Deal** to see deal details in HubSpot:

   ![View deal details](/ai-for-service/integrations/actions/images/hubspot-tem-img10.png)
...
2. The **Get Deal by Id** dialog task is added with the following components:
   ...
   ![Get Deal ID dialog task added](/ai-for-service/integrations/actions/images/hubspot-tem-img11.png)
   ...
   - **getDealService** - Bot action service to fetch deal. Click **+Add Response**:
     ...
     ![Add Response](/ai-for-service/integrations/actions/images/hubspot-tem-img12.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to get deal by id](/ai-for-service/integrations/actions/images/hubspot-tem-img13.png)
...
2. The **List All Deals** dialog task is added with the following components:
   ...
   ![List All Deals dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img14.png)

   - **List All Deals** - User intent to list all deals.
   - **listAllDealsService** - Bot action script to view all deals. Click **+Add Response**:

     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img15.png)
...
2. The **Update a Deal** dialog task is added with the following components:
   ...
   ![Update a Deal dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img16.png)
   ...
   - **updateDealService** - Bot action service to update a deal:
     ...
     ![Update a Deal dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img17.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img18.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompts to update deal](/ai-for-service/integrations/actions/images/hubspot-tem-img19.png)

4. Enter all deal details when prompted. The deal is updated in HubSpot:

   ![Deal updated](/ai-for-service/integrations/actions/images/hubspot-tem-img20.png)
...
2. The **Search Deal by Keyword** dialog task is added with the following components:
   ...
   ![Search Deal by Keyword dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img21.png)
   ...
   - **searchDealService** - Bot action script to search deals:
     ...
     ![searchDealService](/ai-for-service/integrations/actions/images/hubspot-tem-img22.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view all deals](/ai-for-service/integrations/actions/images/hubspot-tem-img23.png)
...
2. The **Delete Deal** dialog task is added with the following components:
   ...
   ![Delete Deal dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img24.png)
   ...
   - **deleteDealService** - Bot action script to delete a deal:
     ...
     ![deleteDealService](/ai-for-service/integrations/actions/images/hubspot-tem-img25.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to delete deal](/ai-for-service/integrations/actions/images/hubspot-tem-img26.png)
...
2. The **Create a Contact** dialog task is added with the following components:
   ...
   ![Create a Deal dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img27.png)
   ...
   - **createContactService** - Bot action service to create a contact. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/hubspot-tem-img28.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img29.png)
...
2. The **Get Contact by Id** dialog task is added with the following components:
   ...
   - **getContactService** - Bot action service to fetch contact. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/hubspot-tem-img30.png)

   - Click **+Add Response**:

     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img31.png)
...
2. The **List All Contacts** dialog task is added with the following components:
   ...
   ![List All Contacts dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img32.png)

   - **List All Contacts** - User intent to list all contacts.
   - **listAllContactsService** - Bot action script to view all contacts:

     ![listAllContactsService](/ai-for-service/integrations/actions/images/hubspot-tem-img33.png)
     ...
     **Sample Request:**
     ...
     ![listAllContactsService](/ai-for-service/integrations/actions/images/hubspot-tem-img34.png)
...
2. The **Update a Contact** dialog task is added with the following components:
   ...
   ![Update a Contact dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img35.png)
   ...
   - **updateContactService** - Bot action service to update contact:
     ...
     ![updateContactService](/ai-for-service/integrations/actions/images/hubspot-tem-img36.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/hubspot-tem-img37.png)
...
2. The **Search Contact by Keyword** dialog task is added with the following components:
   ...
   ![Search Contact by Keyword dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img38.png)

   - **Search Contact** - User intent to search a contact.
   - **Keyword** - Entity node for search keywords.
   - **searchContactService** - Bot action script to search contacts:

     ![searchContactService](/ai-for-service/integrations/actions/images/hubspot-tem-img39.png)
...
2. The **Delete Contact** dialog task is added with the following components:
   ...
   ![Delete Contact dialog task is added](/ai-for-service/integrations/actions/images/hubspot-tem-img40.png)

   - **Delete Contact** - User intent to delete a contact.
   - **ContactId** - Entity node for the contact ID.
   - **deleteContactService** - Bot action script to delete a contact:

     ![deleteContactService](/ai-for-service/integrations/actions/images/hubspot-tem-img41.png)
