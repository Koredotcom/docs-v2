...
Connect the Platform to Asana to find information about projects, users, and tasks. See [Asana documentation](https://developers.asana.com/docs/authentication) for details.
...
4. To use the templates, see [Using Asana Action Templates](/ai-for-service/integrations/actions/configuring-the-asana-action).
