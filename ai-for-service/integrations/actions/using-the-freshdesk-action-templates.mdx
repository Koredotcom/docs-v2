...
2. Under **Integration**, select **Freshdesk** to view action templates.
   ...
   ![Select Freshdesk](/ai-for-service/integrations/actions/images/freshdesk-action-img10-tem-img2.png)

If no integration is configured, click **Explore Integrations** to go to the Actions page.

![Explore integrations](/ai-for-service/integrations/actions/images/freshdesk-tem-img3.png)
...
2. The **Create Ticket** dialog task is added with:
   ...
   ![Create Ticket dialog task](/ai-for-service/integrations/actions/images/freshdesk-tem-img4.png)
   ...
   - **createTicketService** - Bot action service to create the ticket. Click **Edit Request**:
     ...
     ![Request](/ai-for-service/integrations/actions/images/freshdesk-tem-img5.png)
...
4. Follow prompts to create a ticket.
   ...
   ![VA console prompts](/ai-for-service/integrations/actions/images/freshdesk-tem-img6.png)
...
2. The **Get Ticket by ID** dialog task is added with:
   ...
   ![Get Ticket By ID dialog](/ai-for-service/integrations/actions/images/freshdesk-tem-img7.png)
   ...
   - **getTicketbyIdService** - Bot action service to find the ticket. Click **+Add Response**:
     ...
     ![Response](/ai-for-service/integrations/actions/images/freshdesk-tem-img8.png)
...
4. Follow prompts to find a ticket by ID.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/freshdesk-tem-img9.png)
...
2. The **List All Tickets** dialog task is added with:
   ...
   ![List All Tickets dialog task](/ai-for-service/integrations/actions/images/freshdesk-tem-img10.png)
   ...
   - **listAllTicketsService** - Bot action service to fetch all tickets. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/freshdesk-tem-img11.png)
...
4. Follow prompts to view all tickets.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/freshdesk-tem-img12.png)
...
2. The **Update a Ticket** dialog task is added with:
   ...
   ![Update a Ticket dialog task](/ai-for-service/integrations/actions/images/freshdesk-tem-img13.png)
   ...
   - **updateTicketScript** - Bot action script for the update.
     ...
     ![View component properties](/ai-for-service/integrations/actions/images/freshdesk-tem-img14.png)

   - Click **Edit Request**:

     ![Edit Request](/ai-for-service/integrations/actions/images/freshdesk-tem-img15.png)
...
4. Follow prompts to update a ticket.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/freshdesk-tem-img16.png)
...
2. The **Search Ticket by Field** dialog task is added with:
   ...
   ![Search dialog task](/ai-for-service/integrations/actions/images/freshdesk-tem-img17.png)
   ...
   - **searchTicketService** - Bot action service to search tickets. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/freshdesk-tem-img18.png)
...
4. Follow prompts to search tickets.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/freshdesk-tem-img19.png)
...
2. The **Delete a Ticket** dialog task is added with:
   ...
   ![Delete a Ticket dialog](/ai-for-service/integrations/actions/images/freshdesk-tem-img20.png)
   ...
   - **deleteTicketService** - Bot action service to delete the ticket. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/freshdesk-tem-img21.png)
