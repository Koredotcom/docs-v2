...
2. Under **Integration**, select **Microsoft Graph**.
   ...
   ![Integration - Microsoft Graph](/ai-for-service/integrations/actions/images/ms-graph-tem-img2.png)
...
3. If no integration is configured, click **Explore Integrations** to set one up. See [Actions Overview](/ai-for-service/integrations/overview#actions).
   ...
   ![Explore Integrations](/ai-for-service/integrations/actions/images/ms-graph-tem-img3.png)
...
2. The **List All Events** dialog task is added with the following components:
   ...
   ![List All Events dialog task is added](/ai-for-service/integrations/actions/images/ms-graph-tem-img4.png)
   ...
   - **listAllEventsService** - Bot action service to fetch all events. Click **+Add Response**:
     ...
     ![Add Response](/ai-for-service/integrations/actions/images/ms-graph-tem-img5.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view all events](/ai-for-service/integrations/actions/images/ms-graph-tem-img6.png)
...
2. The **List All Todo Lists** dialog task is added with the following components:
   ...
   ![List All Todo Lists dialog task is added](/ai-for-service/integrations/actions/images/ms-graph-tem-img7.png)
   ...
   - **listAllToDoListService** - Bot action service to fetch all to-do lists. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/ms-graph-tem-img8.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view All Todo Lists](/ai-for-service/integrations/actions/images/ms-graph-tem-img9.png)
...
2. The **Create an Event** dialog task is added with the following components:
   ...
   ![Create an Event dialog task is added](/ai-for-service/integrations/actions/images/ms-graph-tem-img10.png)
   ...
   - **createEventService** - Bot action service to create an event. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/ms-graph-tem-img11.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to create an event](/ai-for-service/integrations/actions/images/ms-graph-tem-img12.png)
...
2. The **Create a todo list** dialog task is added with the following components:
   ...
   ![Create a Todo list dialog task is added](/ai-for-service/integrations/actions/images/ms-graph-tem-img13.png)
   ...
   - **createTodolistService** - Bot action service to create a todo list. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/ms-graph-tem-img14.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![prompt to create todo list](/ai-for-service/integrations/actions/images/ms-graph-tem-img15.png)
...
2. The **Send email** dialog task is added with the following components:
   ...
   ![Send EMail dialog task is added](/ai-for-service/integrations/actions/images/ms-graph-tem-img16.png)
   ...
   - **sendEmailService** - Bot action service to send email. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/ms-graph-tem-img17.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to send email](/ai-for-service/integrations/actions/images/ms-graph-tem-img18.png)
