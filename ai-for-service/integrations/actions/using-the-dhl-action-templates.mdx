...
2. The **Track Shipment** dialog task is added with:
   ...
   ![Dialog task added](/ai-for-service/integrations/actions/images/dhl-action-img12-tem-img4.png)
   ...
   - **trackShipmentService** - Bot action service to track the shipment. Optionally click **Edit Request**:
     ...
     ![Request](/ai-for-service/integrations/actions/images/dhl-tem-img5.png)

     Click **+Add Response**:

     ![Response](/ai-for-service/integrations/actions/images/dhl-tem-img6.png)
...
4. Follow prompts to track a shipment.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/dhl-tem-img7.png)
...
2. The **Find Locations** dialog task is added with:
   ...
   ![Dialog task added](/ai-for-service/integrations/actions/images/dhl-tem-img8.png)
   ...
   - **findLocationsService** - Bot action service to find locations. Optionally click **Edit Request**:
     ...
     ![Request](/ai-for-service/integrations/actions/images/dhl-tem-img9.png)

     Click **+Add Response**:

     ![Response](/ai-for-service/integrations/actions/images/dhl-tem-img10.png)
...
4. Follow prompts to find locations.
   ...
   ![VA console prompt](/ai-for-service/integrations/actions/images/dhl-action-img11-tem-img2.png)

5. Click and expand the desired result to view location details.

   ![View location details](/ai-for-service/integrations/actions/images/dhl-action-img12-tem-img4.png)
