...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/images/dhl-action-img2.png)
...
5. Click **Skip for Now** to install templates later.
   ...
   ![Skip for now](/ai-for-service/integrations/actions/images/dhl-action-img4.png)
...
3. Click **Select Authorization** > **Create New**.
   ...
   ![Create new auth profile](/ai-for-service/integrations/actions/images/dhl-action-img5.png)

4. Select the authorization mechanism (e.g., **API Key**).

   ![Auth mechanism](/ai-for-service/integrations/actions/images/dhl-action-img6.png)
...
5. Enter the following credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/dhl-action-img7.png)
...
1. On the Integration Successful dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/dhl-action-img8.png)

2. Click **Install** for the desired template.

   ![Begin installation](/ai-for-service/integrations/actions/images/dhl-action-img9.png)
