...
Connect the Platform to Freshservice to create, view, update, and delete ITSM tickets. See [Freshservice documentation](https://www.freshworks.com/freshservice/product-updates/) for details.
...
4. Select the authorization mechanism (for example, **Basic Auth**).
