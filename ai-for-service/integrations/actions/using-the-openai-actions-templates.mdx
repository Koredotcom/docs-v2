...
2. Under **Integration**, select **OpenAI**.
   ...
   ![Integration -- OpenAI](/ai-for-service/integrations/actions/images/open-ai-tem-img2.png)
...
3. If no integration is configured, click **Explore Integrations** to set one up. See [Actions Overview](/ai-for-service/integrations/overview#actions).
   ...
   ![Explore Integrations](/ai-for-service/integrations/actions/images/open-ai-tem-img3.png)
...
2. The **Generate answers from context** dialog task is added with the following components:
   ...
   ![Generate answers from context dialog task is added](/ai-for-service/integrations/actions/images/open-ai-tem-img4.png)
   ...
   - **answerGenerationService** - Bot action service to generate answers. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/open-ai-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/open-ai-tem-img6.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to generate answer from context](/ai-for-service/integrations/actions/images/open-ai-tem-img7.png)

4. Enter a question based on context when prompted:

   ![Enter question](/ai-for-service/integrations/actions/images/open-ai-tem-img8.png)
...
2. The **Extract Skills from resume** dialog task is added with the following components:
   ...
   ![Extract Skills from resume dialog task is added](/ai-for-service/integrations/actions/images/open-ai-tem-img9.png)
   ...
   - **extractSkillsService** - Bot action service to extract skills. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/open-ai-tem-img10.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/open-ai-tem-img11.png)
...
4. Enter resume content when prompted:
   ...
   ![Enter resume content](/ai-for-service/integrations/actions/images/open-ai-tem-img12.png)

5. The VA extracts skills from the resume content:

   ![Extracted Skills from resume content](/ai-for-service/integrations/actions/images/open-ai-tem-img13.png)
