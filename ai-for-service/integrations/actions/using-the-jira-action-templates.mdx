...
2. Under **Integration**, select **JIRA**.
   ...
   ![Integration - JIRA](/ai-for-service/integrations/actions/images/jira-action-img14-tem-img2.png)
...
3. If no integration is configured, click **Explore Integrations** to set one up. See [Actions Overview](/ai-for-service/integrations/overview#actions).
   ...
   ![Explore Integrations](/ai-for-service/integrations/actions/images/jira-tem-img3.png)
...
2. The **Create an issue** dialog task is added with the following components:
   ...
   ![Create an issue dialog task is added](/ai-for-service/integrations/actions/images/jira-tem-img4.png)
   ...
   - **createIssueService** - Bot action service to create an issue. Click **Edit Request**:
     ...
     ![Edit Request](/ai-for-service/integrations/actions/images/jira-tem-img5.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to create issue](/ai-for-service/integrations/actions/images/jira-tem-img6.png)
...
2. The **Get Issues by Key** dialog task is added with the following components:
   ...
   ![Get Issues by Key dialog task is added](/ai-for-service/integrations/actions/images/jira-tem-img7.png)
   ...
   - **getIssuebyKeyService** - Bot action service to find an issue. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/jira-tem-img8.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to find issue by key](/ai-for-service/integrations/actions/images/jira-tem-img9.png)
...
2. The **Get All Issues** dialog task is added with the following components:
   ...
   ![Get All Issues dialog task is added](/ai-for-service/integrations/actions/images/jira-tem-img10.png)

   - **getAllIssues** - User intent to view all issues.
   - **getResourceIdService** - Bot action service to get JIRA site resource ID.
   - **getAllIssuesService** - Bot action service to fetch all issues. Click **+Add Response**:

     ![Add response](/ai-for-service/integrations/actions/images/jira-tem-img11.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view all issues](/ai-for-service/integrations/actions/images/jira-tem-img12.png)
...
2. The **Update an Issue** dialog task is added with the following components:
   ...
   ![Update an Issue dialog task is added](/ai-for-service/integrations/actions/images/jira-tem-img13.png)
   ...
   - **prepareUpdateIssuePayloadScript** - Bot action script to prepare update payload:
     ...
     ![prepareUpdateIssuePayloadScript](/ai-for-service/integrations/actions/images/jira-tem-img14.png)

   - **getResourceIdService** - Bot action service to get JIRA site resource ID.
   - **updateIssueService** - Bot action service to update an issue. Click **Edit Request**:

     ![Edit Request](/ai-for-service/integrations/actions/images/jira-tem-img15.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to update an issue](/ai-for-service/integrations/actions/images/jira-tem-img16.png)
...
2. The **Delete an Issue** dialog task is added with the following components:
   ...
   ![Delete an Issue dialog task is added](/ai-for-service/integrations/actions/images/jira-tem-img17.png)
   ...
   - **deleteIssueService** - Bot action service to delete an issue. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/jira-tem-img18.png)
