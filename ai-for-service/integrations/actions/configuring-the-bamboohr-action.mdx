...
Connect the Platform to BambooHR to create, view, and update employees, manage time off requests, and update request statuses. See [BambooHR documentation](https://documentation.bamboohr.com/docs) for details.
...
5. Select the authorization mechanism (for example, **Basic Auth**).
...
4. To use the templates, see [Using BambooHR Action Templates](/ai-for-service/integrations/actions/using-the-bamboohr-templates).
