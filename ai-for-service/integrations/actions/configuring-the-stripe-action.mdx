...
The XO Platform supports basic authentication for Stripe. See [App Authorization Overview](/ai-for-service/app-settings#authorization-profiles) for details.
...
3. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type - Basic auth](/ai-for-service/integrations/actions/images/stripe-action-img2.png)

4. Enter your **API Key**.
5. Click **Enable**. The **Integration Successful** pop-up is displayed.

   ![Integration successful](/ai-for-service/integrations/actions/images/stripe-action-img3.png)
...
4. Click **Select Authorization** > **Create New**.
   ...
   ![Create new auth](/ai-for-service/integrations/actions/images/stripe-action-img4.png)
...
6. Enter the following credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/stripe-action-img5.png)

7. Click **Save Auth**.
8. Select the new **Authorization Profile**.

   ![Select auth profile to complete integration](/ai-for-service/integrations/actions/images/stripe-action-img6.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore Templates](/ai-for-service/integrations/actions/images/stripe-action-img7.png)

2. Click **Install** to begin installation.

   ![Begin installation](/ai-for-service/integrations/actions/images/stripe-action-img8.png)

3. Once installed, click **Go to Dialog**. A dialog task for each template is auto-created.

   ![Dialog task for each template](/ai-for-service/integrations/actions/images/stripe-action-img9.png)

4. Select the desired dialog task and click **Proceed**.

   ![Select desired dialog task and proceed](/ai-for-service/integrations/actions/images/stripe-action-img10.png)

5. The dialog task is auto-created and the canvas opens with all required entity nodes, service nodes, and message scripts.

   ![Dialog task canvas](/ai-for-service/integrations/actions/images/stripe-action-img11.png)
