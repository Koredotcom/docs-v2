...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/images/bitly-action-img2.png)

3. Enter your **Personal Access Token**.

   ![Enter access token](/ai-for-service/integrations/actions/images/bitly-action-img3.png)
...
5. Click **Skip for Now** to install templates later.
   ...
   ![Skip for now](/ai-for-service/integrations/actions/images/bitly-action-img5.png)
...
2. Set **Authorization Type** to **Allow Users to Authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/images/bitly-action-img6.png)

3. Click **Select Authorization** > **Create New**.
4. Select the authorization mechanism (e.g., **API Key**).

   ![API Key](/ai-for-service/integrations/actions/images/bitly-action-img7.png)
...
5. Enter the following credentials:
   ...
   ![Basic auth credentials](/ai-for-service/integrations/actions/images/bitly-action-img8.png)
...
1. On the Integration Successful dialog, click **Explore Templates**.
   ...
   ![Explore Templates](/ai-for-service/integrations/actions/images/bitly-action-img9.png)

2. Click **Install** for the desired template.

   ![Install Template](/ai-for-service/integrations/actions/images/bitly-action-img10.png)
