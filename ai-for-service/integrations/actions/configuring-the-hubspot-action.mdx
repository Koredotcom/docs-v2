...
The XO Platform supports OAuth 2.0 for HubSpot. See [Setting Up Authorization Using OAuth v2](/ai-for-service/app-settings/dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2) for details.
...
4. Select the **System** card and click **Authorize**.
   ...
   ![Auth type-OAuth](/ai-for-service/integrations/actions/images/hubspot-integration-img2.png)

   ![Authorize Kore.ai's preconfigured HubSpot app](/ai-for-service/integrations/actions/images/hubspot-integration-img3.png)

5. You are redirected to `login.hubspot.com`. Enter your developer account credentials.

   ![Connect to developer account](/ai-for-service/integrations/actions/images/hubspot-integration-img4-img8.png)
...
1. Select **Custom** and click **Select Authorization** > **Create New**.
   ...
   ![Create new auth](/ai-for-service/integrations/actions/images/hubspot-integration-img5.png)
...
2. Select **OAuth v2**. See [Setting Up Authorization Using OAuth v2](/ai-for-service/app-settings/dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2).
   ...
   ![Select auth mechanism](/ai-for-service/integrations/actions/images/hubspot-integration-img6.png)
...
3. Enter the OAuth v2 credentials:
   ...
   ![Enter auth credentials](/ai-for-service/integrations/actions/images/hubspot-integration-img7.png)
...
6. Select a HubSpot account, click **Choose Account**, then click **Enable**.
   ...
   ![Enable integration](/ai-for-service/integrations/actions/images/hubspot-integration-img9.png)
...
5. Click **Enable**. A link is sent to the end user to authorize integration.
   ...
   ![Enable integration-authorization link sent to user](/ai-for-service/integrations/actions/images/hubspot-integration-img10.png)
...
2. Click **Select Authorization** > **Create New** and follow the Custom Authorization steps above.
   ...
   ![Create new authorization](/ai-for-service/integrations/actions/images/hubspot-integration-img11.png)

   You can also select an existing profile:

   ![Select existing auth profile](/ai-for-service/integrations/actions/images/hubspot-integration-img12.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/hubspot-integration-img9.png)

2. In the Integration Templates dialog, click **Install**.

   ![Begin template installation](/ai-for-service/integrations/actions/images/hubspot-integration-img14.png)
