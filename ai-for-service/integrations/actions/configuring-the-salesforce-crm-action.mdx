...
The Platform supports OAuth 2.0 authentication for Salesforce CRM. See [Setting Up Authorization Using OAuth v2](/ai-for-service/app-settings/dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2) for details.
