...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/images/google-maps-action-img2.png)

3. Enter your **API Key**.
4. Click **Enable**. On first configuration, the Integration Successful pop-up appears.

   ![Enable integration](/ai-for-service/integrations/actions/images/google-maps-action-img3.png)

<Note>The Google Maps action moves from Available to Configured.</Note>

5. Click **Skip for Now** to install templates later.

   ![Skip for now](/ai-for-service/integrations/actions/images/google-maps-action-img4.png)
...
3. Click **Select Authorization** > **Create New**.
   ...
   ![Create new auth](/ai-for-service/integrations/actions/images/google-maps-action-img5.png)

4. Select the authorization mechanism (e.g., **API Key**).

   ![Auth mechanism](/ai-for-service/integrations/actions/images/google-maps-action-img6.png)
...
5. Enter the following credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/google-maps-action-img7.png)
...
1. On the Integration Successful dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/google-maps-action-img8.png)

2. Click **Install** for the desired template.

   ![Install](/ai-for-service/integrations/actions/images/google-maps-action-img9.png)

3. Click **Go to Dialog** to view the dialog task.
4. A dialog task is auto-created for each installed template.

   ![Dialog tasks created](/ai-for-service/integrations/actions/images/google-maps-action-img10.png)
...
5. Alternatively, create a new dialog task, select the Google Maps integration, choose a template (e.g., **Get location by coordinates**), and click **Proceed**.
   ...
   ![Create new dialog](/ai-for-service/integrations/actions/images/google-maps-action-img11-tem-img2.png)

6. The canvas opens with all required entity nodes, service nodes, and message scripts.

   ![Dialog task canvas](/ai-for-service/integrations/actions/images/google-maps-action-img12-tem-img4.png)
