...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/images/here-action-img2.png)

3. Enter your **API Key**.

   ![API key](/ai-for-service/integrations/actions/images/here-action-img3.png)

4. Click **Save**. On first configuration, the Integration Successful pop-up appears.

   ![Save integration](/ai-for-service/integrations/actions/images/here-action-img4.png)

<Note>The Here action moves from Available to Configured.</Note>

5. Click **Skip for Now** to install templates later.

   ![Skip for now](/ai-for-service/integrations/actions/images/here-action-img5.png)
...
3. Click **Select Authorization** > **Create New**.
   ...
   ![Create new auth](/ai-for-service/integrations/actions/images/here-action-img6.png)

4. Select the authorization mechanism (e.g., **API Key**).

   ![Auth mechanism](/ai-for-service/integrations/actions/images/here-action-img7.png)
...
5. Enter the following credentials:
   ...
   ![Auth credentials](/ai-for-service/integrations/actions/images/here-action-img8.png)
...
1. On the Integration Successful dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/images/here-action-img9.png)

2. Click **Install** for the desired template.

   ![Install](/ai-for-service/integrations/actions/images/here-action-img10.png)
...
5. Alternatively, create a new dialog task, select the Here integration, choose a template (e.g., **Get Location**), and click **Proceed**.
   ...
   ![Create new dialog task](/ai-for-service/integrations/actions/images/here-action-img11-tem-img2.png)

6. The canvas opens with all required entity nodes, service nodes, and message scripts.

   ![Dialog task canvas](/ai-for-service/integrations/actions/images/here-action-img12-tem-img4.png)
