...
2. Under **Integration**, select **Salesforce**.
   ...
   ![Integration - Salesforce](/ai-for-service/integrations/actions/images/salesforce-tem-img2.png)
...
2. The **Create a Lead** dialog task is added with the following components:
   ...
   ![createLeadService bot action component properties](/ai-for-service/integrations/actions/images/salesforce-tem-img4.png)
   ...
   - **CreateLeadService** - Bot action service to create a lead. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/salesforce-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/salesforce-tem-img6.png)
   ...
   - **subDomainService** - Bot action service to fetch subdomain.
     ...
     ![subDomainService bot action component properties](/ai-for-service/integrations/actions/images/salesforce-tem-img7.png)

   - **createLeadMessage** - Message node to display responses.

3. Click **Train**, then **Talk to Bot** to test:

   ![VA prompts to create a lead](/ai-for-service/integrations/actions/images/salesforce-tem-img8.png)

4. Enter lead details when prompted:

   ![Enter lead details](/ai-for-service/integrations/actions/images/salesforce-tem-img9.png)

5. The new lead is created in Salesforce CRM:

   ![New lead created](/ai-for-service/integrations/actions/images/salesforce-tem-img10.png)

6. Click **View Lead** to see lead details:

   ![View lead details](/ai-for-service/integrations/actions/images/salesforce-tem-img11.png)
...
2. The **Update a Lead** dialog task is added with the following components:
   ...
   ![Update a Lead dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img12.png)
   ...
   - **updateLeadScript** - Bot action script to update a lead.
     ...
     ![updateLeadScript bot action component properties](/ai-for-service/integrations/actions/images/salesforce-tem-img13.png)
...
3. Click **Train**, then **Talk to Bot** to test. After entering lead details, the lead is updated in Salesforce CRM. Click **View Lead** to see updated details:
   ...
   ![View lead details](/ai-for-service/integrations/actions/images/salesforce-tem-img14.png)
...
2. The **Delete Lead** dialog task is added with the following components:
   ...
   ![Delete Lead dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img15.png)
   ...
   - **deleteLeadService** - Bot action service to delete a lead.
     ...
     ![deleteLeadService bot action component properties](/ai-for-service/integrations/actions/images/salesforce-tem-img16.png)

   - **deleteLeadMessage** - Message node to display responses.

3. Click **Train**, then **Talk to Bot** to test:

   ![VA prompt to delete a lead](/ai-for-service/integrations/actions/images/salesforce-tem-img17.png)
...
2. The **List All Leads** dialog task is added with the following components:
   ...
   ![List All Leads dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img18.png)

   - **List All Lead** - User intent to list all leads.
   - **listAllLeadsService** - Bot action service to fetch all leads. Click **+Add Response**:

     ![listAllLeadsService bot action component properties](/ai-for-service/integrations/actions/images/salesforce-tem-img19.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompts to view all leads](/ai-for-service/integrations/actions/images/salesforce-tem-img20.png)
...
2. The **View Lead by Id** dialog task is added with the following components:
   ...
   ![View Lead by Id dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img21.png)
   ...
   - **viewLeadbyIdService** - Bot action service to view a lead by ID. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/salesforce-tem-img22.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompts to view lead by id](/ai-for-service/integrations/actions/images/salesforce-tem-img23.png)
...
2. The **Search Leads** dialog task is added with the following components:
   ...
   ![Search Leads dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img24.png)
   ...
   - **searchLeadsService** - Bot action service to search leads. Click **+Add Response**:
     ...
     ![Add response](/ai-for-service/integrations/actions/images/salesforce-tem-img25.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view all leads](/ai-for-service/integrations/actions/images/salesforce-tem-img26.png)
...
2. The **Create Opportunity** dialog task is added with the following components:
   ...
   ![Create Opportunity dialog task is added](/ai-for-service/integrations/actions/images/salesforce-tem-img27.png)
   ...
   - **CreateOpportunityService** - Bot action service to create an opportunity. Click **Edit Request**:
     ...
     ![Edit request](/ai-for-service/integrations/actions/images/salesforce-tem-img28.png)
     ...
     **Sample Request:**
     ...
     ![Add response](/ai-for-service/integrations/actions/images/salesforce-tem-img29.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompts to create opportunity](/ai-for-service/integrations/actions/images/salesforce-tem-img30.png)

4. Click the **Chevron** icon to expand the new opportunity:

   ![Expand the new opportunity](/ai-for-service/integrations/actions/images/salesforce-tem-img31.png)

5. Click **View Opportunity** to see opportunity details in Salesforce CRM:

   ![View opportunity details](/ai-for-service/integrations/actions/images/salesforce-tem-img32.png)
