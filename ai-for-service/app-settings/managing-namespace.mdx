...
Use this option to **view, edit,** or **delete** namespaces. Deleting a namespace that's mapped to any component is restricted. You need to unmap the namespace from all associated components before deletion. As mentioned earlier, you can't delete the default namespace.
