...
Change Logs keep record of all the modifications made to the application. they're essential for tracking changes and are particularly useful for debugging, identifying configuration updates, and understanding their impact on application performance.
...
![Change Logs](/ai-for-service/app-settings/images/change-logs-img1.png)

This page shows the change made to the application in JSON format.

![Change Logs](/ai-for-service/app-settings/images/change-logs-img2.png)
...
![Change Logs](/ai-for-service/app-settings/images/filter-logs.png)
...
![Download Logs](/ai-for-service/app-settings/images/download-csv.png)
