...
In the case of multi-lingual AI Agent, while much of the AI Agent behavior does not change with the language, language semantics does impose some restrictions. This document lists the different behaviors that are language-dependent, so you as app developer can cater for such scenarios.
