...
| `word1` - If you quote words or use words that aren't in canonical form, the system restricts itself to what you used in the pattern | All languages | - | No | No | No |
...
| Two-letter identifiers for Dates - Like `Mo` for Monday and `Tu` for Tuesday. | English, German, Spanish, Portuguese (Brazilian), Italian, Chinese simplified, Chinese traditional, Indonesian, Korean, Dutch, Japanese, Arabic, Finnish, Russian, Polish, Ukrainian, Swedish, Kazakh, Norwegian, Hindi | French, Telugu, Tamil, Marathi, Catalan, Tagalog, Portuguese (European) | - | - | No |
...
<Note>The Spell Correction feature isn't supported in Universal Apps.</Note>
