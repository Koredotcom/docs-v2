...
To know how to use the service, please visit [KoreUtil Libraries - autoTranslate.](/ai-for-service/apis/automation/koreutil-libraries#koreutil-autotranslate)
...
5. Refer to the [Service Node](/ai-for-service/automation/dialogs/node-types/service-node#define-a-custom-service) documentation to learn more about how to configure service integrations.
