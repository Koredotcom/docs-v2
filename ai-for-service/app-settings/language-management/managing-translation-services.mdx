...
3. Provide the **API Key** (for example, AIzaXXXXXXXXXXXXXXXXXXXEpeW4xa0) of your Google Translation API service in the **Access Key** field. [Learn More.](https://cloud.google.com/translate)
