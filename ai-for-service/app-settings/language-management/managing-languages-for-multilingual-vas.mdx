---
title: Managing Languages for Multilingual AI Agent
sidebarTitle: Managing Languages
---
...
![Add Language](/ai-for-service/app-settings/language-management/images/mlva-img4-add-lang.png)
...
![Enable Language](/ai-for-service/app-settings/language-management/images/mlva-img5-config-new-lang.png)

    <Note>You can also search for a language by entering its name in the Search field.</Note>

4. After you click configure, you can setup the following language configurations:
![Setup language configurations](/ai-for-service/app-settings/language-management/images/mlva-img6-new-lang-config.png)
    ...
    b. **Select the Language Definition Mode** - You can choose any of the following options to copy the language definitions:
      ...
      - **Basic Mode** - Lets you only copy dialog prompts and messages.
         <Note>A base language is a language that is already enabled in the assistant. You need to choose a Base Language for your assistant from which you want to copy your assistant's data for both Basic and Advanced modes.</Note>
         ![Basic mode](/ai-for-service/app-settings/language-management/images/mlva-img7-base-lang.png)
      ...
      - **Advanced Mode** - Lets you copy dialog prompts, messages, knowledge graph, small talks, traits, and training data as per your need.
        ![Advanced mode](/ai-for-service/app-settings/language-management/images/mlva-img8-advanced-mode.png)
      ...
      - **Use Language Pack** - Lets you upload the language definitions after adding manually translating a JSON file. You can download a JSON language pack of any of the already-enabled languages and then edit the dialog prompts and messages in the JSON file. Upload the updated JSON file to enable the new language for the assistant.
        ![Language pack](/ai-for-service/app-settings/language-management/images/mlva-img9-lang-pack.png)

    c. **Manage Translations** - In case the Translation Engine isn't configured, click the **Configure** link to set up the translation engine for your assistant. To learn how to enable Input Translation or Runtime Response Translation, [refer to this article](/ai-for-service/app-settings/language-management/managing-translation-services).
    ![Manage translations](/ai-for-service/app-settings/language-management/images/mlva-img10-enable-translation.png)
...
3. Click on the language that's already enabled in the AI Agent. The **Manage Language** dialog appears, here you can:
  ...
  ![Manage language](/ai-for-service/app-settings/language-management/images/mlva-img11-update-lang.png)

4. Click the **Update** after all the necessary changes are made.

<Note>
- After you have configured a new language, to make the new language work, you must re-publish the app. Until then, the AI Agent continues to function with the previously published languages.
...
![Multilingual setting](/ai-for-service/app-settings/language-management/images/dgpt_language_management.png)
    ...
    b. Under Output, choose one of the following options:
      ...
      To configure the translation engine, refer to [Manage Translation Services](/ai-for-service/app-settings/language-management/managing-translation-services).
...
![Manage language](/ai-for-service/app-settings/language-management/images/localization_configuration.png)
...
![localization_configuration](/ai-for-service/app-settings/language-management/images/localization_configuration_configure.png)
...
![rephrase_specific](/ai-for-service/app-settings/language-management/images/rephrase_specific.png)
...
![Filter](/ai-for-service/app-settings/language-management/images/filter.png)
...
![Switch language](/ai-for-service/app-settings/language-management/images/mlva-img12-switch-language-1.png)

<Note>The language dropdown displays the App Language and NLU language for the languages where the App Language is not equal to NLU language. If the App Language and the NLU language are the same then the language drop down displays only the App Language.</Note>
...
![Enable or disable language](/ai-for-service/app-settings/language-management/images/mlva-img13-enable-disable-lang.png)
...
<Note>Any change in language settings needs to be published before it can take effect in the published assistant.</Note>
