...
<Note>The language dropdown displays the App Language and NLU language for the languages where the App Language isn't equal to NLU language. If the App Language and the NLU language are the same then the language drop down displays only the App Language.</Note>
