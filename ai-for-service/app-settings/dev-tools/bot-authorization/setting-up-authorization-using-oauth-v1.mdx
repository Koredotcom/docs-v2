...
1. The Platform obtains an unauthorized request token from the web application.
2. The Platform redirects the user to a login dialog at the web application.
3. The user authorizes the request token, associating it with their account.
4. The web application redirects the user back to the Platform.

    ![Auth profile - Add](/ai-for-service/app-settings/dev-tools/bot-authorization/images/basic-auth-img2.png)

5. The Platform exchanges the request token for an access token.
6. The access token allows the Platform to access a protected resource at the provider, on behalf of the user.

    ![New auth mechanism details](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img2.png)
...
![Defining tenancy](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img3.png)
...
![Additional fields](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img4.png)
...
![Adding auth fields](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img5.png)
...
![Test authorization dialog](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img6.png)

Click **Test** to begin the authorization test.

When validation completes, the **Test Authorization** dialog closes and the results — either success or failure — are displayed. If the authorization fails, the Auth Test Failed message is displayed along with the **Headers** and **Response** tabs.

![Auth Test Failed](/ai-for-service/app-settings/dev-tools/bot-authorization/images/oauth-v1-img7.png)
