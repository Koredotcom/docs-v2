...
6. Enter the **Description** for the profile and select the API endpoint **Method** — either **GET** or **POST**.
    ...
    > **Note:** By default, the GET method is selected for existing apps.
...
For more information, see [Using Session and Context Variables in Tasks](../../../automation/use-cases/using-session-and-context-variables.md).
