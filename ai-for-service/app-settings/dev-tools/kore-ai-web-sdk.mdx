...
In the next section, define the Web/Mobile Client channel for the Travel Planning Sample App by creating a new client app and defining channel settings. [See here](/ai-for-service/channels/add-web-mobile-client) for a detailed explanation.
