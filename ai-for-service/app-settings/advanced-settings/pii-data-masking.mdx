...
When PII redaction is enabled, the platform protects sensitive information— such as phone numbers, email addresses, and credit card numbers — by redacting the values when users provide them.
