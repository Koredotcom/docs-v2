...
![Download invoices](/ai-for-service/drafts/new-admin-console/images/billing-order-invoices.png)

You have the option to download the Invoice from the invoice field.

<Note> This section is not available for customers under the Enterprise plan. </Note>
...
![Plan and Usage information](/ai-for-service/drafts/new-admin-console/images/billing-plan.png)
...
![Plan based eligibility and usage details](/ai-for-service/drafts/new-admin-console/images/billing-manage-plan.png)
...
![admin-console-billing-graph](/ai-for-service/drafts/new-admin-console/images/billing-usage.png)
