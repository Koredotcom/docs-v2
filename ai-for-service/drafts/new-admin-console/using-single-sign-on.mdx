...
![SSO](/ai-for-service/drafts/new-admin-console/images-used/sso-new-admin-console.png)
...
![SSO SAML](/ai-for-service/drafts/new-admin-console/images-used/sso-saml-new-admin-console.png)
...
![SSO OneLogin](/ai-for-service/drafts/new-admin-console/images-used/using-single-sign-on-img4.png)
...
7. In the Bitium **X.509 Certificate** field, copy the certificate data, and then paste the data into the Admin Console **Certificate** text box.  
    ...
    <Note>
    Only data after the **BEGIN CERTIFICATE header and before the **ENCERTIFICATE** footer should be copied and pasted into AI for Service.
    </Note>
...
![Bitium portal](/ai-for-service/drafts/new-admin-console/images-used/using-single-sign-on-img5.png)
