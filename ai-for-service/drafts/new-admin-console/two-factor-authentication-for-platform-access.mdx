...
![Security & Control - 2FA](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img1.png)

3. Click **Enable 2FA** to activate 2FA via email OTP verification.  
![Enable 2FA](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img2.png)

4. Click **Save**.  
![2FA - Save](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img3.png)
...
![User Management - Role Management](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img4.png)

2. Click the **edit** icon of the desired Admin user's entry to view the **Manage Role** window.  
![Edit role to enable 2FA](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img5.png)

3. Click the **Permissions** tab.
4. Select "**YES**" for **Two-Factor Authentication**.
5. Click **Save**.  
![Save permission for 2FA](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img6.png)
...
![BAC Login - enter email id](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img7.png)

2. Enter your account password, and click **Log in**.  
![BAC Login - enter password](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img8.png)

3. Enter the OTP received on your registered email address in the following screen.  
![BAC Login - enter OTP](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img9.png)

4. After you enter the correct OTP and the verification is successful, the following verification success message appears.  
![BAC Login - Verification successful](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img10.png)
...
![Bot Builder Login - enter email id](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img11.png)

2. Enter your account password, and click **Login** to authenticate.  
![Bot Builder Login - enter password](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img12.png)
...
![Bot Builder Login - enter OTP](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img13.png)
...
![Bot Builder Login - verification success](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img14.png)
...
![Switch to another account](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img15.png)
...
![Account selection page](/ai-for-service/drafts/new-admin-console/images-used/two-factor-authentication-for-platform-access-img16.png)
