...
On accessing the [Admin Console](adminconsole.md), you will be directed to its Dashboard page.
...
* **Custom Date Range** 
    * **Filters** can be applied to display Metrics for the following:
        * **conversation session type** – [see here for more details on the conversation sessions](../app-settings/advanced-settings/bot-sessions.md) can be either one or both (default setting) of the following:
