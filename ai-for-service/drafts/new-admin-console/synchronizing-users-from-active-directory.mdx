...
1. In the User Management module, on the Directory Sync page, select **Configure**.
    ...
    ![Run manual sync](/ai-for-service/drafts/new-admin-console/images/sync-with-company-directory.png)
...
3. On the **Connection** tab, define the following fields:
    ...
    ![Run manual sync](/ai-for-service/drafts/new-admin-console/images/cloud-based-connectors.png)
