...
2. Click **Create Key** under the Bring Your Own Key section.  
 ![BYOK](/ai-for-service/drafts/new-admin-console/images/byok_1.png)
...
6. Select Apps and Bots: Click **Next** to view all applications and bots in your workspace.
    ...
    * Deselect any apps/bots you want to keep on the default Kore.ai encryption.   
    ![BYOK](/ai-for-service/drafts/new-admin-console/images/byok_2.png)
...
![BYOK](/ai-for-service/drafts/new-admin-console/images/byok_3.png)  
![BYOK](/ai-for-service/drafts/new-admin-console/images/byok_4.png)  
