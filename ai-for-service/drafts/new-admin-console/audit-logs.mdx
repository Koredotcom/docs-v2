...
![Analytics - Audit Reports](/ai-for-service/drafts/new-admin-console/images/analytics-img1.png)
...
![Event filter options](/ai-for-service/drafts/new-admin-console/images/analytics-img2.png)

### Record Details

By clicking on any entry, you get to view further details:

![Record details](/ai-for-service/drafts/new-admin-console/images/analytics-img3.png)

![Export search](/ai-for-service/drafts/new-admin-console/images/analytics-img4.png)
...
![Analytics - Bot Chat History](/ai-for-service/drafts/new-admin-console/images/analytics-img5.png)
...
![Export file of Chat History](/ai-for-service/drafts/new-admin-console/images/analytics-img8.png)
...
![Chat History details](/ai-for-service/drafts/new-admin-console/images/analytics-img9.png)
