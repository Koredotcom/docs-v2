...
![User Management - Groups](/ai-for-service/drafts/new-admin-console/images-used/manage-group.png)
...
6. Click **Save**. The system creates the group and returns you to the **Groups** page.
    ...
    ![Create Groups](/ai-for-service/drafts/new-admin-console/images-used/create-new-group-new-admin-console.png)
...
![Delete Groups](/ai-for-service/drafts/new-admin-console/images-used/delete-group.png)
