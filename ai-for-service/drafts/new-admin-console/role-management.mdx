...
4. Under the **Profile** tab, **edit Admin Role.**
    ...
    ![assign admin role](../images/create-admin-role.png)
...
![Creating custom App role](../images/create-app-role.png)
...
![Assign App Role to a User from the Admin Console](../images/assign-app-role.png)
