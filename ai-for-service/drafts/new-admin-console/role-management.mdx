...
4. Under the **Profile** tab, **edit Admin Role.**
    ...
    ![assign admin role](/ai-for-service/drafts/new-admin-console/images/create-admin-role.png)
...
![Creating custom App role](/ai-for-service/drafts/new-admin-console/images/create-app-role.png)
...
![Assign App Role to a User from the Admin Console](/ai-for-service/drafts/new-admin-console/images/assign-app-role.png)
