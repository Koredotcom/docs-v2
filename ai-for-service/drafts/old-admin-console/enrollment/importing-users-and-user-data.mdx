...
![Enrollment - Import](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img1.png)
...
![Bulk User Import History](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img2.png)
...
1. On the **Enrollment > Import** page, select the **here** link.
   ...
   ![View Results Link](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img3.png)

2. The **Report On File Import** dialog opens with per-user results.

   ![Report on File Import](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img4.png)
...
1. On the **Enrollment > Import** page, select **File Based Bulk User Import History**.
   ...
   ![Import History Link](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img5.png)

2. In the **File Based Import History** dialog, select **Results** in the **Report** column for the import you want to review.

   ![File Based Import Results](/ai-for-service/administration/enrollment/images/importing-users-and-user-data-img6.png)
