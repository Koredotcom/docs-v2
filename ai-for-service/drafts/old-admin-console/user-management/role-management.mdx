...
4. Select one or more roles from the dropdown.
   ...
   ![Assign Admin Role](/ai-for-service/administration/user-management/images/custom-role-admin.png)
...
5. Configure the desired permissions.
   ...
   ![New Bot Role](/ai-for-service/administration/user-management/images/new-role.png)
...
5. Select **Add**.
   ...
   ![User Bot Assignment](/ai-for-service/administration/user-management/images/user-assignment.png)
...
5. Select **Save**.
   ...
   ![User Groups Assignment](/ai-for-service/administration/user-management/images/user-groups.png)
