...
```
---
<Note> Only authorized users can access version control and environment management features. [Learn more](/agent-platform/agents/agentic-apps/settings/sharing-permissions).</Note>
