...
Without required permissions, API keys and scopes are not accessible in Apps and Tools. [Learn More](/agent-platform/administration/security-and-control#api-scopes).
...
![Session Resolution using Identify fields](/agent-platform/apis/agentic-apps/images/session-resolution.png "Session resolution")
...
| Export and Import App Configurations                                                                                           | [Import/Export APIs](/agent-platform/apis/agentic-apps/import-export)   |
