...
* **Text to Image Nodes**
    ...
    * Example: AI-driven design tools, creative content generation. [Learn more](../types-of-nodes/text-to-image-node.md).
...
* **Image to Text Nodes**
    ...
    * Example: AI-powered document scanners, and accessibility tools. [Learn more](../types-of-nodes/image-to-text-node.md).
