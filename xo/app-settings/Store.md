...
The Store allows you to find predefined App templates that you can use to develop your own AI Agent faster. If a template fits your needs - for example it completes a task that is common in your business, you can save time and resources by not starting from scratch.
...
2. You can view, explore, and use all the available template apps .
3. The App category contains templates that you can apply and then customize to design your own AI Agent.
...
Once you have accessed the App store, follow the below steps to explore the various templates offered:

### Filter

You can **filter** the Apps based on one or more of the following criteria (you can select multiples):
...
You can **sort** the template Apps based on:
...
Hover over a template Apps to **preview** its features like:

1. Name, icon, and summary of the Apps.
...
1. A **video** that explains the App’s features.
2. Two sections that provide:

   * **Overview** – This section gives a summary of the template Apps and the available features .
   * **Technical Specifications** – This section gives a detailed overview of the technical aspects of the App, including prerequisites, configuration, etc.
...
When using an App template from the store, you are importing it into your account. Once you have explored and selected a template app, follow the below steps to use it in your account:

### From the Store:

1. Visit the store, explore the template apps and click **Use Template** on the one you choose.
