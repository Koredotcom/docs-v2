...
<strong>Note:</strong> The following entries till isDeveloper are the sub-parameters of the <strong>users</strong> parameter.
  ...
  <tr>
   ...
   <td>array of agents that need to be assigned to the user
  <tr>
   <td>streamId
   </td>
   <td>
  ...
  <tr>
   ...
   <td>Determines if the specified users can create agents in their App Builder accounts. Set to true or false.
 Default value is _“true”._
  ...
  <tr>
   ...
   <td>Determines if the specified users can have access to App Builder. Set to true or false.
