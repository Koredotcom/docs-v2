...
| [Analytics Explorer](/agent-platform/analytics-explorer)                                                          | Near real-time monitoring of event volume, LLM performance, token consumption, and cost. Drill down into sessions and traces, benchmark model performance, and run custom queries around project event data. |
