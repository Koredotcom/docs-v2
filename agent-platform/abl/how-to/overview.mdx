---
title: Artemis how-to guides
sidebarTitle: Artemis how-to guides
---
...
<CardGroup cols={2}>
  <Card title="Agent architecture and design" href="#agent-architecture-and-design" icon="sitemap">
    Choose an agent pattern, split work across agents, and set execution behavior.
  </Card>
  <Card title="Conversation entry and welcome experience" href="#conversation-entry-and-welcome-experience" icon="comments-dots">
    Control greetings, startup logic, session setup, and channel differences.
  </Card>
  <Card title="Routing and multi-agent orchestration" href="#routing-and-multi-agent-orchestration" icon="route">
