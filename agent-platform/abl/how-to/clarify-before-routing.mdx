...
---
<Badge icon="arrow-left" color="gray">[Back to how-to guides](/agent-platform/abl/how-to/overview#routing-and-multi-agent-orchestration)</Badge>
...
- [How to route unclear requests to a fallback agent](/agent-platform/abl/how-to/route-to-fallback-agent).
- [How to handle messages that contain multiple user intents](/agent-platform/abl/how-to/handle-multiple-intents).
