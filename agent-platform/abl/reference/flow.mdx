...
Common error types are `tool_timeout`, `tool_error`, `invalid_input`, `validation_error`,
...
| `THEN`            | `string`  | Next action: `CONTINUE`, `COMPLETE`, `ESCALATE`, `BACKTRACK`, `RETRY_STEP`, `HANDOFF`, or a step name. |
