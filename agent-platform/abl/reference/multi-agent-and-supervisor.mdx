...
| `GENESYS_SIP_HEADERS` | `object` | No | -- | Per-trigger override of the Genesys Audio Connector SIP transfer headers sent when this escalation transfers the call (voice). |
