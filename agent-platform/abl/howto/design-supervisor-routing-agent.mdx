...
<Accordion title="Support Supervisor">
...
<Accordion title="Account Support Agent">
...
<Accordion title="Order Status Agent">
...
<Accordion title="Billing Supervisor">
...
<Accordion title="Pending Payments Agent">
...
<Accordion title="Refund Guidance Agent">
