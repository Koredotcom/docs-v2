...
Transfer Sessions is a monitoring and control page for live handoffs from a bot to a human agent on an external contact center platform.
...
## How a Transfer Session Is Created
