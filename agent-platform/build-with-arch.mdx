...
- Build your project manually in **Studio** using the visual editor and ABL. See **Get started with Studio**.
- Start from a ready-made project in the **Template Gallery**, which includes sample projects for industries such as banking, retail, healthcare, telecom, travel, and more.
</Note>
