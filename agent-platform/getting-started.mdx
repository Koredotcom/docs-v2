...
Go to [agents.kore.ai](https://agents.kore.ai) and create your account. After verifying your email, you land in **Studio** - the browser-based IDE where you build, test, and manage your agents.
