...
{/* AG: Documenting servers and IPs of all deployment regions.
...
| Region  | URL                                               | IPs                        |
|---------|---------------------------------------------------|----------------------------|
| USA     | [agents.kore.ai](https://agents.kore.ai/)         | • x.x.x.x <br /> • x.x.x.x |
| Germany | [de-agents.kore.ai](https://de-agents.kore.ai/)   | • x.x.x.x <br /> • x.x.x.x |
| JP      | [jp-agents.kore.ai](https://jp-agents.kore.ai/)   | • x.x.x.x                  |
| UAE     | [uae-agents.kore.ai](https://uae-agents.kore.ai/) | • x.x.x.x                  |
| EU      | [uk-agents.kore.ai](https://uk-agents.kore.ai/)   | • x.x.x.x                  |
| IND     | [ind-agents.kore.ai](https://ind-agents.kore.ai/) | • x.x.x.x                  |
