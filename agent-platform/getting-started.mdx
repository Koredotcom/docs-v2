---
title: Get Started using Agent Platform
sidebarTitle: Get Started
---

import FeedbackLink from '../components/feedbacklink2';
...
| Goal | Resources |
|------|-----------|
| Create specialized agents for different tasks. | [Add More Agents](/docs/agents/create)         |
| Set up multi-agent coordination patterns.      | [Configure Orchestration](/docs/orchestration) |
| Connect your knowledge bases for RAG.          | [Add Knowledge](/docs/knowledge)               |
| Create workflow, code, or MCP tools.           | [Build Custom Tools](/docs/tools)              |
