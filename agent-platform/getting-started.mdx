...
Get started with the platform by describing your business requirements to Arch, either through a conversation in Studio, from your development environment using MCP, or from the terminal using the CLI. Arch generates a working project that you can review, customize, test, and deploy.
...
| [CLI](/agent-platform/cli)        | Create, test, and manage agents and projects from the terminal, and automate validation, evaluation, and deployment in CI workflows. | Developers and teams automating build, test, and deployment pipelines. |
