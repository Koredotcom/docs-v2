...
Agent Platform sends requests to a fixed set of IP addresses. If your organization applies IP restrictions, then to permit the platform traffic, allow the relevant IPs from the following list. The platform is available in the following regions at the listed URLs.
