...
```mermaid
graph LR
    A["Phase 1: Foundation <br /><br /> Account and core setup"] --> B["Phase 2: Configuration <br /><br /> Agents, tools, knowledge"]
    B --> C["Phase 3: QA and Test <br /><br /> Validate and test safely"]
    C --> D["Phase 4: Deployment <br /><br /> Go live and integrate"]
```
