...
| Step                         | Description                                                                                                                                                                                                                                  |
|------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **1. Sign Up**               | Create an account to get a dedicated workspace. If you've used AI for Service Platform, your existing workspaces appear automatically. To use a shared workspace, you'll need permission from its owner. [Learn more →](/agent-platform/getting-started) |
