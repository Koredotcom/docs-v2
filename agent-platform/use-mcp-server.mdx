...
If you prefer scripting or CI automation over an AI assistant, the [Artemis Platform CLI](/agent-platform/install-use-cli) exposes the same platform operations directly from your terminal or pipeline.
