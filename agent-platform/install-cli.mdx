---
title: Install the Artemis Platform CLI
sidebarTitle: Install CLI
noindex: true
hidden: true
---

The Artemis Platform CLI lets you build and manage Agent Platform projects from your terminal or CI pipeline. This article covers prerequisites and installation.

For creating, reviewing, customizing, testing, and deploying agents with the CLI, see [Use the Artemis Platform CLI](/agent-platform/use-cli).
