...
The WSDL Repository lets you upload and manage WSDL (Web Services Description Language) files for SOAP-based services.
...
**Dry Run** — Identifies and lists the operations from the uploaded WSDL, without creating any tools. Use this to preview the HTTP tools that will be generated from the operations defined in the uploaded WSDL.
