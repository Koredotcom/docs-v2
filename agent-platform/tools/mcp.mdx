...
<Note>You can connect to the platform's MCP server from within your editor or terminal—perform platform operations without leaving your context. For details, see [How to use platform MCP server](/agent-platform/mcp-server)</Note>
