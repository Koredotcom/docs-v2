...
<Note>If you select **Hosted token exchange**, complete Step 3. Otherwise, skip to Step 4.</Note>

### Step 3: Set the Token Envelope Policy (Hosted Token Exchange Only)
...
### Step 4: Select the Public SDK Key and Create the Channel
...
### Step 6: Configure Widget Behavior
