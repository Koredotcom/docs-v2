...
| **Regex-based Detection** | Identifies PII using regular expressions. Available options:<br /><br />• Built-in Library<br />• Custom Regex<br /><br />See [Regex-based Detection](#regex-based-detection). |
| **Entity-based Detection** | Identifies PII using entity recognition. Available options:<br /><br />• Inbuilt Entity<br />• Model-based<br /><br />See [Entity-based Detection](entity-based-detection). |
