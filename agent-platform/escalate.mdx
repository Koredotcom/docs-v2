...
| Property       | Type     | Required | Description                              |
| -------------- | -------- | -------- | ---------------------------------------- |
| queue          | string   | No       | Target queue in the human agent system. You can use expressions to define dynamic values for the queues.  |
...
- During agent transfer, `ESCALATE.routing.metadata` is passed to the external agents as sip headers in case of voice interactions and as session level tags in chat. 
</Note>
