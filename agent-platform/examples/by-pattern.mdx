...
> **Cross-reference:** See the [MCP Configuration Guide](/agent-platform/guides/tools-and-integrations) for details on registering MCP servers with your project.
...
> **Cross-reference:** See the [SearchAI Guide](/agent-platform/guides/knowledge-bases) for knowledge base ingestion, indexing, and search strategy configuration.
...
- Browse [industry-specific examples](/agent-platform/examples/by-industry) for real-world implementations.
- Study [orchestration patterns](/agent-platform/examples/orchestration-and-integration) for multi-agent coordination strategies.
- Follow [integration recipes](/agent-platform/examples/orchestration-and-integration) for connecting agents to external services.
