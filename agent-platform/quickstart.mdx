...
Head to [agents.kore.ai](https://agents.kore.ai) and create your account. Once you verify your email, you'll land in **Studio** — the browser-based IDE where you build, test, and manage your agents.
...
- [Your first agent tutorial](/agent-platform/tutorials/build-your-first-agent) — Build a complete agent with tools, knowledge, and guardrails
- [Multi-agent orchestration](/agent-platform/tutorials/multi-agent-and-knowledge) — Design supervisor routing with handoff, delegation, and escalation
- [Platform overview](/agent-platform/platform-overview) — Understand what makes ABL different from other frameworks
- [ABL language reference](/agent-platform/abl-reference/language-overview) — Full language specification for all ABL constructs
