...
The Platform now supports an additional AI model:
...
The platform now auto‑generates SAML and OIDC endpoint URLs for identity provider configuration. These system-managed URLs ensure consistent setup, reduce manual errors, and are accessible only to organization owners and admins. 
