...
{/* Mel: Publish after PM confirmation

<p className="rn-heading">\{ Artemis 1.4.4 \} August 17, 2026 </p>
...
Azure Bring-Your-Own-Key (BYOK) encryption no longer requires customers to register and maintain their own Entra app registration or federated-credential (FIC) configuration. Artemis now uses a platform-owned, cross-tenant Workload Identity Federation application, so customers only need to consent to the platform app, grant it a Key Vault role, and supply their tenant ID and key location. 
...
<p className="rn-heading">\{ Artemis 1.4.3 \} August 13, 2026 </p>
...
<p className="rn-heading">\{ Artemis 1.4.2 \} August 8, 2026 </p>
...
<br />[Learn more →](/agent-platform/channels/set-up-ms-teams-copilot#configuration)


---

<p className="rn-heading">\{ Artemis 1.4.1 \} August 1, 2026 </p>
...
<p className="rn-heading">\{ Artemis 1.4.0 \} July 30, 2026 </p>
...
<p className="rn-heading">\{ Artemis 1.3.1 \} July 21, 2026 </p>
