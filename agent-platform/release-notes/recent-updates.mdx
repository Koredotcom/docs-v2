...
[Learn more →](../ai-agents/create-agent.md)
...
[Learn more →](../ai-agents/tools/workflow-tools.md#accessing-app-environment-variables-in-workflow-tools)
...
[Learn more →](../models/external-models/add-an-external-model-using-easy-integration.md#integrate-a-model-from-vertex-ai)
...
[Learn more →](../models/supported-models.md)
...
[Learn more →](../ai-agents/agentic-apps/orchestrator.md#single-agent-configuration)
...
[Learn more →](../ai-agents/agentic-apps/settings/app-configurations.md#waiting-experience)
...
[Learn more →](../apis/agentic-apps/execute.md)
...
These models offer diverse capabilities across different sizes and specializations, letting you optimize for performance, cost, or specific use cases while maintaining full access to Platform orchestration, tools, and knowledge features. [Learn more →](../models/supported-models.md)
...
Two new API scopes, View connections and Manage connections, have been added, offering more granular permission control for accessing and updating external model connections. [Learn more →](../apis/apis-list/connections-api.md)

**New Model Support**

The OpenAI gpt-4o-search-preview model is now supported in Prompts and Workflow tools. The model is optimized for search and RAG workflows, and features multi-chunk document retrieval and grounded response generation. [Learn more →](../models/supported-models.md#supported-external-models-for-easy-integration)
...
[Learn more →](../ai-agents/agentic-apps/settings/variables.md)
...
[Learn more →](../ai-agents/agentic-apps/api-keys.md)
...
[Learn more →](../ai-agents/agentic-apps/settings/app-configurations.md#error-handling)
...
[Learn more →](../evaluation/agentic-evaluation/create-simulation.md)
...
[Learn more →](../ai-agents/agentic-apps/settings/guardrails.md)
...
[Learn more →](../settings/security-and-control/encryption-key-management.md#bring-your-own-key)
...
[Learn more →](../ai-agents/knowledge/manage-knowledge-tools.md#test-the-knowledge-base)
...
[Learn more →](../ai-agents/agentic-apps/app-profile.md)
...
[Learn more →](../ai-agents/create-from-scratch.md#testing-a-tool)
...
[Learn more →](../models/supported-models.md#custom-model-support-in-agentic-apps)
...
[Learn more →](../models/supported-models.md#supported-models-for-structured-output)
...
[Learn more →](../ai-agents/agentic-apps/diagnostics-for-agent-platform.md)
...
[Learn more →](../ai-agents/agentic-apps/app-testing.md#playground-interface-components)
...
[Learn more →](../ai-agents/agentic-apps/app-testing.md)
...
[Learn more →](../ai-agents/tools/tool-flows/types-of-nodes/human-node.md)
...
[Learn more →](../ai-agents/tools/tool-flows/types-of-nodes/function-node.md#add-and-configure-a-function-node)
...
[Learn more →](../models/external-models/add-an-external-model-using-api-integration.md#add-an-external-model)
...
[Learn more →](../models/open-source-models/open-source-summary.md)
...
[Learn more →](../settings/user-management/invite-a-user.md)
...
* Commercial models: Create multiple connections for the same model, each with its own API key/security token, and track usage separately per connection. [Learn more →](../models/external-models/managing-external-models.md)
* Fine-tuned and open-source models: Run multiple deployments of the same model to improve inference control, manage costs, and optimize performance. [Learn more →](../models/fine-tune-models/managing-fine-tuned-models.md)
...
* Model Analytics & Traces: Filter and view data by deployment name & version (open-source/fine-tuned) or connection name (external). [Learn more →](../settings/monitoring/analytics/model-analytics-dashboard.md#model-performance-filters)
* Audit Logs: Model Added/Deleted events now display the relevant deployment or connection name. [Learn more →](../settings/monitoring/audit-logs.md#account-level-audit-logs)
* Billing & Usage: The drill-down view in the Usage page’s Models tab displays the *deployment name*, *type*, *credits used*, *last updated date,* and *status* for a model. Totals of all the deployments roll up to show model-level consumption, with deployment-level data reflected in *fine-tuning*, *hosting*, and *storage* metrics. [Learn more →](../settings/billing/billing-and-usage.md#models-usage)
...
[Learn more →](../ai-agents/agentic-apps/settings/app-configurations.md)
...
[Learn more →](../ai-agents/agentic-apps/deployment/app-deployment.md)
...
[Learn more →](../ai-agents/external-agents.md)
...
[Learn more →](../ai-agents/agentic-apps/settings/events.md)
...
[Learn more →](../ai-agents/ai-for-service.md)
...
[Learn more →](../ai-agents/tools/tool-flows/types-of-nodes/loop-node.md)
...
[Learn more →](../ai-agents/tools/create-a-code-tool.md)
...
[Learn more →](../ai-agents/agentic-apps/analytics-dashboard.md)

**Export All Runs and Logs Data**

Admins can now export and download All Runs and Logs from the Monitoring Custom Scripts dashboard as a `.csv>` file, following the schema and file-naming conventions defined in the Agent Platform. [Learn more →](../settings/monitoring/monitoring-custom-scripts.md#export-runs-and-logs-data)
...
[Learn more →](../ai-agents/agentic-apps/export.md)
...
[Learn more →](../ai-agents/tools/tool-flows/manage-flow-nodes.md)
...
[Learn more →](../ai-agents/tools/configure-mcp-server.md)
...
[Learn more →](../models/external-models/add-an-external-model-using-easy-integration.md#integrate-a-model-from-amazon-bedrock)
...
Evaluation Studio now supports CSV export for evaluation tables from the three-dot menu, preserving all column data, scores, and footer metrics (for example, pass%, fail%, avg, min, max).
...
[Learn more →](../ai-agents/agentic-apps/memory-stores.md)
...
[Learn more →](../ai-agents/tools/mcp-tools.md)
...
[Learn more →](../apis/agentic-apps/overview.md)
...
[Learn more →](../settings/workspaces/workspace-management.md)
...
[Learn more →](../ai-agents/knowledge/overview.md)
...
[Learn more →](./../ai-agents/agentic-apps/import.md)
...
* Fixed an issue with CTranslate2 where deploying models with more than 6 billion parameters (for example, opt-6.7b) on A10 hardware was stuck in the Deploying state when optimization was not enabled.
