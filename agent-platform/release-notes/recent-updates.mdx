...
[developer] or [admin], and resolve them before promoting or republishing projects on the new version.

<p className="rn-subtitle">For agent developers</p>
...
<p className="rn-subtitle">For admins</p>
