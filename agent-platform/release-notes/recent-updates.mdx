...
<br />[Learn more →](/agent-platform/abl-reference/tools#reusing-secrets-across-tools-secretref)
...
<br />[Learn more →](https://docs.kore.ai/agent-platform/channels/digital#set-up-microsoft-teams)
