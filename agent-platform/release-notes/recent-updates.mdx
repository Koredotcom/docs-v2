...
[Learn more →](/agent-platform/orchestrate#input-processor)
...
[Learn more →](/agent-platform/agents/agentic-apps/settings/events#event-processor)

<p className="rn-subtitle">Unified Memory Retrieval and Variable Resolution Support</p>

Consistent support for memory retrieval and variable resolution — covering content, environment, and memory variables — is now available across all components. This ensures uniform behavior and improved context awareness, enabling developers to reliably use dynamic data throughout orchestration, agents, workflows, and integrations.
...
[Learn more →](/agent-platform/apis/agentic-apps/sessions#get-session-details)
...
[Learn more →](/agent-platform/agents/agentic-apps/custom-tags)
...
[Learn more →](/agent-platform/apis/agentic-apps/sessions#list-sessions)
...
[Learn more →](/agent-platform/administration/security-and-control#add-an-auth-profile)
