...
<p className="rn-subtitle">Azure-provisioned workspaces are now managed through Azure Portal</p>

For workspaces provisioned via Azure Marketplace/Liftr, creation and deletion are now disabled within Studio to ensure full synchronization with the Azure Portal.
