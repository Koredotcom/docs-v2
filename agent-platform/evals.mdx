...
|-----------------|-----------------------------------------------------------------------------------------------------------------------------|
| Quick Eval      | Automatically generates personas, scenarios, evaluators, and runs using Arch AI for rapid testing and iteration.                 |
...
Arch automatically generates the required personas, scenarios, evaluators, and evaluation runs.
...
1. Open the Eval Set.
1. Under Regression Settings, select a baseline run.
 Typically, this is the last known-good evaluation run.
1. Specify the regression threshold.
...
![Runs](/agent-platform/images/eval-runs.png)
