...
**Learn more**: To understand how Evaluations fit into the complete workflow, from creating a project with Arch to continuously improving your agents, see [Arch AI Development Lifecycle](/agent-platform/arch-lifecycle).
