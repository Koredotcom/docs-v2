...
| **Gateway ⇄ Runtime Verbs** | Event count                  | <br>                                                                                                                                                                                                                                    |
| **Network Quality (MOS)**   | Inbound (Caller → Platform)  | <br>                                                                                                                                                                                                                                    |
|                         | Outbound (Platform → Caller) | <br>                                                                                                                                                                                                                                    |
| **SIP Ladder**              | Reveal control               | <br>                                                                                                                                                                                                                                    |
...
| Test Context | This sub-tab lets you construct a **test scenario** to launch a new session against this agent's current definition, pre-loaded with specific starting [conditions. U](http://conditions.it)se it to reproduce or probe agent behavior. |
...
- You must have the **View Recordings** permission to view, play, and download the recordings. 

![Recordings in Sessions](/agent-platform/images/sessions-recording.png)
...
A project admin or owner can update the Retention Period in [Project Settings](/agent-platform/administration/agent-behavior-settings).

<Note> Changes to the Retention days setting apply only to recordings created after you save the new setting. Existing recordings retain the retention period that was assigned when they were created. For example, reducing the retention period from 90 days to 30 days does not shorten the lifetime of existing recordings.</Note>
