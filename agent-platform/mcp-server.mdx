...
The server (`@koreai/arch-mcp-tools`) is a standard stdio MCP server.

The clients launch it using the command: `npx -y @koreai/arch-mcp-tools`.

In your client's config, you add it as a server named: `arch-agent-platform`.
