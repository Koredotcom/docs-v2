...
In the platform, feature usage is throttled by rate limit thresholds, that are different for different plans and usecases. To know more, see [the platform rate limits](/agent-platform/drafts/rate-limits).
