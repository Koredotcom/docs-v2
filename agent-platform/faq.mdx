...
Open **Settings** > **Team** > **Members** and click **Invite member**. Enter their email address and select a [role](/agent-platform/glossary.mdx#role).
...
Studio works best on the latest versions of Google Chrome, Microsoft Edge, Mozilla Firefox, and Apple Safari. We recommend a Chromium-based browser (Chrome or Edge) for the best experience with the code editor and debugging tools.
