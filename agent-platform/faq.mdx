...
Go to [agents.kore.ai](https://agents.kore.ai/) and click **Get started**. You can sign up with your email address or use Google or GitHub single sign-on. A free tier is available so you can start building agents immediately.
...
- **Email:** Send a message to Support.
