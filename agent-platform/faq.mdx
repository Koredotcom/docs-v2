...
You can sign up with your email address or use Google or GitHub single sign-on (SSO). A free tier is available so you can start building agents immediately. See [Quick Start Guide](/agent-platform/getting-started) for details.
