...
<Steps>
  ...
  <Step title="Configure Realtime LLM Voice Settings">
    ...
    * **S2S Provider**: The realtime speech-to-speech model. Each option shows how it authenticates:

      | Provider                       | Credential source                              |
      | --------------------------------- | ------------------------------------------------- |
      | **Amazon Nova Sonic (S2S)**    | Uses Voice Service credentials.                |
      | **Azure OpenAI Realtime**      | Uses the project-selected model connection.    |
      | **Grok Realtime (S2S)**        | Uses the project-selected model connection.    |
      | **Google Gemini Live**         | Uses the project-selected model connection.    |
      | **OpenAI Realtime**            | Uses the project-selected model connection.    |
  ...
  <Step title="Configure Provider-Specific Settings">
    Additional fields appear based on the selected **S2S Provider**, under a **[Provider] Configuration** panel — typically voice, model, and generation settings specific to that provider.
  </Step>
