...
<Tabs>
  ...
  <Tab title="Configuration">
    The channel includes the same **General** (Display Name), **Provider Verification Strength**, call routing, and **Realtime LLM Voice Settings** options that are described in [Set up Realtime LLM Voice](#set-up-realtime-llm-voice). You can edit these settings any time and with immediate effect.
  </Tab>
