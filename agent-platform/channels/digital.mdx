...
<Steps>
  <Step title="Complete Azure Bot Setup">
    ...
    2. In **Bot settings**, set **Messaging endpoint** to the webhook URL shown on the **New Microsoft Teams Connection** page.
...
<Tabs>
  ...
  <Tab title="Deployment">
    ...
    | **Active Deployment** | Shows the bound deployment version and when it was deployed, for example `v4.0` deployed `May 11, 2026, 06:17 PM`. |
