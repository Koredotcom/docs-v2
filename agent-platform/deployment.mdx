...
| **AIforWork** | Connect agents to Kore.ai's Employee Experience platform for bidirectional messaging. See the [channel setup guide](/agent-platform/channels#set-up-aiforwork). |
