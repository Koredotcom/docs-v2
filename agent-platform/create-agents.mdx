...
| `VOICE:` | Defines voice configuration for the initial response without a preceding `RESPOND:` block. |
...
For full details, refer [Sessions guide](/agent-platform/sessions). 
