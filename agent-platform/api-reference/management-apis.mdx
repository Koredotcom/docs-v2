...
```bash
curl -X POST https://agents.kore.ai/api/tool-secrets \
  -H "Authorization: Bearer abl_sk-your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://agents.kore.ai/api/tool-secrets?projectId=clx1abc2d0000ab12cd34ef56&environment=production" \
  -H "Authorization: Bearer abl_sk-your-api-key"
```
...
```bash
curl -X PUT https://agents.kore.ai/api/tool-secrets/sec_abc123 \
  -H "Authorization: Bearer abl_sk-your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://agents.kore.ai/api/tool-secrets/sec_abc123 \
  -H "Authorization: Bearer abl_sk-your-api-key"
```
