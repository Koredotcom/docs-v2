...
<img className="kore-img-light" src="/agent-platform/images/split-brain-how-it-works.png" alt="Dual-Brain Architecture" />
<img className="kore-img-dark" src="/agent-platform/images/split-brain-how-it-works-dark.png" alt="Dual-Brain Architecture" />
