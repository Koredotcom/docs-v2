...
sidebartitle: Community and Support
order: 5
description: 'Find help, connect with other developers, report issues, track releases, and monitor the operational status of the Agent Platform.'
---
...
1. [Platform overview](/agent-platform/platform-overview-user) to know the Platform.
2. [Quickstart](/agent-platform/quickstart) to build a foundation.
3. [Glossary](/agent-platform/glossary) to get familiar with terms.
...
3. **Review the [ABL language reference](/agent-platform/abl-reference/language-overview)** before submitting documentation changes.
...
Your support tier is determined by your [plan tier](/agent-platform/glossary#plan-tier). Contact your account team to discuss support options.
...
The Agent Platform follows [semantic versioning](https://semver.org/) for its API and SDK releases:
