...
The **Voice Analytics** page provides a dedicated dashboard for monitoring call quality, speech recognition accuracy, and end-to-end latency across the voice processing pipeline. For teams running voice-enabled agents, this page is critical for ensuring that audio quality, recognition accuracy, and response latency meet the standards callers expectations and for diagnosing degradations before they affect customer satisfaction at scale.
