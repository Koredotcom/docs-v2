...
- **Export Warnings**: If the platform detects any conditions that affect the export, such as automatic normalization of tool formats, it surfaces them in the Export Warnings. All warnings are informational and do'ot block the export process. Review warnings before exporting to understand what the platform has automatically adjusted. 
