...
| Pattern | Best For |
|---------|----------|
| [Single Agent](/docs/orchestration/single-agent) | Simple, focused use cases with one domain |
| [Supervisor](/docs/orchestration/supervisor) | Complex tasks requiring parallel agent coordination |
| [Adaptive Network](/docs/orchestration/adaptive-network) | Dynamic hand-offs between specialized agents |
...
### [Create Agents](/docs/agents/create)
Build your first agent with tools and knowledge.

### [Orchestration Patterns](/docs/orchestration)
