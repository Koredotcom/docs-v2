...
|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [Executive Dashboard and Usage](/agent-platform/analytics-insights/executve-dashoard-usage)                  | Executive dashboard with KPIs, trend charts, outcome distribution, and ROI. Operational analytics with LLM performance, session/trace exploration, and billing-unit consumption reporting. |
