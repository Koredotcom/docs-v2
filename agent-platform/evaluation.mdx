...
![Evaluation Studio Page](./evaluation/images/eval_studio_page.png)
Path of the image is relative from the .mdx file, with path as `./evalation/images/eval_studio_page.png`.

![Evaluation page](./evalation/images/eval_studio_page.png)

Path of this image is the full path from the root, with path as `/agent-platform/evaluation/images/eval_studio_page.png`.

![Evaluation page](/agent-platform/evaluation/images/eval_studio_page.png)

Path of this image is relative to docs.json, with path as `./agent-platform/evaluation/images/eval_studio_page.png`.

![Evaluation page](./agent-platform/evaluation/images/eval_studio_page.png)

Using `..` with path as `../evaluation/images/eval_studio_page.png`.

![Evaluation page](../evaluation/images/eval_studio_page.png)
