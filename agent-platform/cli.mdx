...
The Artemis CLI lets you build and manage Agent Platform projects from your terminal or CI pipeline. CLI lets developers automate the complete agentic lifecycle, including authentication, project sync, eval runs, and deployment, from external systems, without Studio.
