...
- The **Platform URL** provided by your platform administrator. For hosted solution, it's a [region-specific platform URL](/agent-platform/getting-started#region-specific-urls-and-allowlist-of-ips).
