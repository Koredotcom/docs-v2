...
For details on navigating sessions and traces in Studio, see [Sessions and Runtime Diagnostics](/agent-platform/analytics-insights/analytics-explorer#session-detail-view).
