...
| Field | Value |
|:------ |:------ |
| Endpoint | GET `https://domain/api/public/apps/aa-1abb7216-efa8-4157-b8af-04450bb09d7c/sessions?session_id=:sessionId` |
| Content-Type  | application/json |
| Authorization Header | x-api-key: `<API-KEY>` |
|API Permissions| Session Details |
...
| include   | No | Additional data to include in the response. Accepted values: traces, observations. Pass multiple values by repeating the parameter: &include=traces&include=observations. | 
...
--header 'apikey: kg-52093952-8024-41b4-bca1-bf221f6faa0a.028dea04-c107-4ce2-8185-bfd485a553cb' \
...
// the content is truncated for brevity.
```json
{
  // The content is truncated for brevity.
