...
[Learn More](/agent-platform/apis#session-resolution-process).
...
1. **Upload the file**. 
    ...
    Use the [File Upload API](upload) to upload the desired files. Uploaded files remain available only for the duration of the session.
