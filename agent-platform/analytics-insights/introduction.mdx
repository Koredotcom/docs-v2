...
|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [Overview and Usage](/agent-platform/analytics-insights/overview-usage)                  | Executive dashboard with KPIs, trend charts, outcome distribution, and ROI. Operational analytics with LLM performance, session/trace exploration, and billing-unit consumption reporting. |
