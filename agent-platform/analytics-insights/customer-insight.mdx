...
sidebarTitle: Customer Insights
---

This document covers the customer experience layer in Analytics and Insights: the Customer Insights page for intent classification, sentiment trajectory, and frustration detection, and the Feedback page for end-user ratings and verbatim comments.
