...
| **Triggers** | Displays the configured triggers for the workflow and their current status. Scheduled triggers are shown in a human-readable format, for example, **Daily at 2:00 AM**. |
...
Use the Start node to define the workflow input parameters. These parameters define the data that is passed to the workflow when it starts.
