...
3. In the Import Workflow dialog, enter a **Workflow name**.
4. Click **Preview**.
5. Review the workflow details and dependencies. Missing dependencies are identified in the preview.
6. If dependencies are missing, resolve them or select **Import with unresolved dependencies unselected** to continue without them.
7. Click **Import**.
