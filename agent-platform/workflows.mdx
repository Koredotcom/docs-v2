...
You can export an individual workflow and import it into another project as an editable draft.
...
The workflow export includes the workflow definition and references to dependent components, such as agents, tools, and auth profiles. These components are not exported with the workflow.
