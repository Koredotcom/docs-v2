...
Use cron schedule triggers to automatically execute workflows at configured intervals.
...
Use app triggers to start workflows from external application events. App triggers allow workflows to respond automatically to supported integration events.
