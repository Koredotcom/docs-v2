...
| Azure: Text Embedding 3 Small      | azure/text-embedding-3-small |
| Azure: Text Embedding Ada 002      | azure/text-embedding-ada-002 |
| GPT Audio (Azure)                  | GPT-Audio                    |
| GPT Audio Mini (Azure)             | GPT-Audio-Mini               |
| GPT Image 1 (Azure)                | GPT-Image-1                  |
| GPT Image 1 Mini (Azure)           | GPT-Image-1-Mini             |
| GPT Realtime (Azure)               | GPT-Realtime                 |
| GPT Realtime Mini (Azure)          | GPT-Realtime-Mini            |
| GPT-4.1 (Azure)                    | GPT-4.1                      |
| GPT-4.1 Mini (Azure)               | GPT-4.1-Mini                 |
| GPT-4.1 Nano (Azure)               | GPT-4.1-Nano                 |
| GPT-4o (Azure)                     | GPT-4o                       |
| GPT-4o Audio Preview (Azure)       | GPT-4o-Audio-Preview         |
| GPT-4o Mini (Azure)                | GPT-4o-Mini                  |
| GPT-4o Mini Audio Preview (Azure)  | GPT-4o-Mini-Audio-Preview    |
| GPT-4o Mini Transcribe (Azure)     | GPT-4o-Mini-Transcribe       |
| GPT-5 (Azure)                      | GPT-5                        |
| GPT-5 Chat (Azure)                 | GPT-5-Chat                   |
| GPT-5 Mini (Azure)                 | GPT-5-Mini                   |
| GPT-5 Nano (Azure)                 | GPT-5-Nano                   |
| GPT-5.1 (Azure)                    | GPT-5.1                      |
| GPT-5.1 Chat (Azure)               | GPT-5.1-Chat                 |
| GPT-5.2 (Azure)                    | GPT-5.2                      |
| GPT-5.2 Chat (Azure)               | GPT-5.2-Chat                 |
| GPT-5.4 (Azure)                    | GPT-5.4                      |
| GPT-5.4 Mini (Azure)               | GPT-5.4-Mini                 |
| GPT-5.4 Nano (Azure)               | GPT-5.4-Nano                 |
| GPT-5.4 Pro (Azure)                | GPT-5.4-Pro                  |
...
| Display Name                     | Model ID                                      |
|----------------------------------|-----------------------------------------------|
| Claude Haiku 4.5 (Microsoft Foundry)  | microsoft_foundry/claude-haiku-4-5-20251001  |
| Claude Opus 4.6 (Microsoft Foundry)   | microsoft_foundry/claude-opus-4-6            |
| Claude Opus 4.7 (Microsoft Foundry)   | microsoft_foundry/claude-opus-4-7            |
| Claude Sonnet 4.5 (Microsoft Foundry) | microsoft_foundry/claude-sonnet-4-5-20250929 |
| Claude Sonnet 4.6 (Microsoft Foundry) | microsoft_foundry/claude-sonnet-4-6          |

### OpenAI

| Display Name              | Model ID                       |
|---------------------------|--------------------------------|
| GPT-4o (Microsoft Foundry) | microsoft_foundry/gpt-4o       |
| GPT-5 (Microsoft Foundry)  | microsoft_foundry/gpt-5        |

### Meta

| Display Name                        | Model ID                                      |
|-------------------------------------|-----------------------------------------------|
| Llama 3.3 70B (Microsoft Foundry)   | microsoft_foundry/llama-3.3-70b-versatile     |

### Mistral

| Display Name                     | Model ID                                   |
|----------------------------------|--------------------------------------------|
| Mistral Large (Microsoft Foundry) | microsoft_foundry/mistral-large-latest     |

### Cohere

| Display Name                   | Model ID                                   |
|--------------------------------|--------------------------------------------|
| Command R+ (Microsoft Foundry) | microsoft_foundry/command-r-plus-08-2024   |
