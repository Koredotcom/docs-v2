...
The key actions at each Stage (S) of the Agentic Evaluation workflow:

```mermaid actions={false}
flowchart TD
    A[S1. Create Project] --> B[S2. Choose Data Source]
    B --> C[SIMULATED DATA <br /> Create personas, define test scenarios, and run simulations]
    B --> D[PRODUCTION DATA <br /> Import sessions from deployed Agentic apps]
    C --> E[S3. Create an Evaluation]
    D --> E
    E --> F[S4. Import Data]
    F --> G[S5. Configure Evaluators]
    G --> H[S6. Run the Evaluation]
    H --> I[S7. View and Analyze Results]
```
...
2. In the left pane, select **Agentic Evaluation**.
   ...
   ![Create project](/agent-platform/v1/evaluation/agentic-evaluation/images/create_project.png)
...
![Create persona](/agent-platform/v1/evaluation/agentic-evaluation/images/create_persona.png)
...
![Test scenarios page](/agent-platform/v1/evaluation/agentic-evaluation/images/test_scenarios_page.png)
...
![Write test scenario](/agent-platform/v1/evaluation/agentic-evaluation/images/write_test_scenario.png)
...
![Generate test scenario](/agent-platform/v1/evaluation/agentic-evaluation/images/generate_test_scenario.png)
...
![Create simulation](/agent-platform/v1/evaluation/agentic-evaluation/images/create_simulation.png)
...
![Simulation complete](/agent-platform/v1/evaluation/agentic-evaluation/images/simulation_complete.png)
...
![Simulation transcript](/agent-platform/v1/evaluation/agentic-evaluation/images/simulation_conversation.png)

![Simulation trace tree](/agent-platform/v1/evaluation/agentic-evaluation/images/simulation_trace.png)
...
1. On the Session Evaluation page, click **Create Evaluation**.
   ...
   ![Create evaluation](/agent-platform/v1/evaluation/agentic-evaluation/images/create_evaluation.png)
...
3. Select the data source and click **Create**:
   ...
   ![Evaluation creation dialog](/agent-platform/v1/evaluation/agentic-evaluation/images/eval_creation.png)
...
![Evaluations listing](/agent-platform/v1/evaluation/agentic-evaluation/images/evaluations_listing_page.png)
...
2. Select the evaluation and click **Import sessions**.
   ...
   ![Import live data](/agent-platform/v1/evaluation/agentic-evaluation/images/import_live_data.png)
...
3. In the Import Session dialog, enter the following and click **Import**:
   ...
   ![Import sessions dialog](/agent-platform/v1/evaluation/agentic-evaluation/images/import_prod_data.png)
...
2. Select the evaluation and click **Import simulated data**.
   ...
   ![Import simulated data](/agent-platform/v1/evaluation/agentic-evaluation/images/import_simulated_data.png)

3. Choose the **Simulation** from which to import sessions and click **Import**.

   ![Import simulated sessions dialog](/agent-platform/v1/evaluation/agentic-evaluation/images/import_session_simulated.png)
...
![Imported sessions](/agent-platform/v1/evaluation/agentic-evaluation/images/imported_sessions_new.png)
...
1. On the **Imported Sessions** page, click **+ Evaluators**.
   ...
   ![Add evaluators](/agent-platform/v1/evaluation/agentic-evaluation/images/add_evaluators.png)

2. Select the desired session or trace-level evaluators.

   ![Evaluators list](/agent-platform/v1/evaluation/agentic-evaluation/images/evaluators_list.png)

3. Configure the evaluator settings (such as selecting the model and adjusting model configurations) and click **Save**.

   ![Evaluator configuration](/agent-platform/v1/evaluation/agentic-evaluation/images/evaluator_config.png)
...
![Run evaluation](/agent-platform/v1/evaluation/agentic-evaluation/images/run_evaluation.png)
...
- In the **Sessions** tab, both session-level and trace-level evaluation results are visible.
  ...
  ![Sessions tab](/agent-platform/v1/evaluation/agentic-evaluation/images/sessions_tab.png)

- In the **Traces** tab, only trace-level results are shown.

  ![Traces tab](/agent-platform/v1/evaluation/agentic-evaluation/images/traces_tab.png)
...
![Session table](/agent-platform/v1/evaluation/agentic-evaluation/images/session_columns.png)
...
![Session view](/agent-platform/v1/evaluation/agentic-evaluation/images/click_session_evaluator_score.png)
...
![Trace view](/agent-platform/v1/evaluation/agentic-evaluation/images/click_trace_evaluator_score.png)
...
![Root level](/agent-platform/v1/evaluation/agentic-evaluation/images/root_level.png)
...
![Supervisor level](/agent-platform/v1/evaluation/agentic-evaluation/images/supervisor_level.png)
...
![Agent level](/agent-platform/v1/evaluation/agentic-evaluation/images/agent_level.png)
...
![Tool level](/agent-platform/v1/evaluation/agentic-evaluation/images/tool_level.png)
...
![Session evaluator scoring](/agent-platform/v1/evaluation/agentic-evaluation/images/pass_fail_scoring.png)
...
![Trace evaluator scoring](/agent-platform/v1/evaluation/agentic-evaluation/images/numerical_scoring.png)
...
![Missing tool errors](/agent-platform/v1/evaluation/agentic-evaluation/images/missing_tool_errors.png)
