...
When an export request is initiated, the API triggers the export process and returns a `dockStatusId`, which can be used with the [Get Dock Status API](/agent-platform/v1/apis/apis-list/get-dock-status) to track the export progress. The API response also includes an `exportJobId` for tracking the specific export job.
...
1. Follow the steps mentioned [here](/agent-platform/v1/tools#how-to-export-a-tool) to export a tool.
2. Open developer tools.
3. Select the **Network** tab.

![developer tools](/agent-platform/v1/apis/apis-list/images/developer-tools.png "developer tools")
