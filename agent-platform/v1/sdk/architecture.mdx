...
{/* Commenting it out - same as above dia 
![Component interaction diagram](/agent-platform/v1/sdk/design-decisions/assets/component_interaction.svg)
*/}
...
```
{/* Same as above dia
![Design-time class diagram](/agent-platform/v1/sdk/design-decisions/assets/designtime_class_diagram-1.svg)
*/}
...
```
{/*
![Deployment sequence diagram](/agent-platform/v1/sdk/design-decisions/assets/sequence.svg)
*/}
