...
<Badge icon="arrow-left" color="gray">[Back to SDK Overview and resources](/agent-platform/v1/sdk-overview)</Badge>
...
| **Memory store** | Persists context (for example. account data) across interactions                        |
...
For installation, workspace setup, and the full development lifecycle, see the [SDK overview](/agent-platform/v1/sdk-overview). This page walks through two complete examples.
