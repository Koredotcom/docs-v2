...
| `Agent`             | Autonomous unit that handles tasks.                          | [Creating Agents](/agent-platform/v1/sdk/guide/creating-agents)       |
| `Tool`              | Function an agent can invoke.                                | [Working with Tools](/agent-platform/v1/sdk/guide/working-with-tools) |
| `MemoryStore`       | Persistent data store scoped to users, sessions, or the app. | [Memory Stores](/agent-platform/v1/sdk/guide/memory-stores)           |
| `AppConfigurations` | Streaming, attachments, filler messages.                     | This guide                                                         |
| Orchestrator        | Routes messages between agents and users.                    | [Custom Orchestration](/agent-platform/v1/sdk/guide/orchestration)    |
...
See [Creating Agents](/agent-platform/v1/sdk/guide/creating-agents) for roles, sub-types, and prompt configuration.
...
See [Working with Tools](/agent-platform/v1/sdk/guide/working-with-tools) for custom, inline, and library tool types.
...
See [Memory Stores](/agent-platform/v1/sdk/guide/memory-stores) for scopes, retention policies, and namespaces.
...
See [Custom Orchestration](/agent-platform/v1/sdk/guide/orchestration) for message handling, routing strategies, and memory-aware orchestration.
