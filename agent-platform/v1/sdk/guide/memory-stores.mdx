...
- An `App` instance to attach memory stores to. See [Building Applications](/agent-platform/v1/sdk/guide/building-apps).
...
- [Memory Store API Reference](/agent-platform/v1/sdk/api-reference#memorystore)
