...
- An LLM model and prompt configured. See [Prompts and LLM Configuration](/agent-platform/v1/sdk/guide/prompts-llm).
- Tools defined if the agent needs to perform actions. See [Working with Tools](/agent-platform/v1/sdk/guide/working-with-tools).
...
For full prompt and LLM configuration options, see [Prompts and LLM Configuration](/agent-platform/v1/sdk/guide/prompts-llm).
...
- [Agent API Reference](/agent-platform/v1/sdk/api-reference#agent)
- [Working with Tools](/agent-platform/v1/sdk/guide/working-with-tools)
- [Prompts and LLM Configuration](/agent-platform/v1/sdk/guide/prompts-llm)
- [Building Applications](/agent-platform/v1/sdk/guide/building-apps)
