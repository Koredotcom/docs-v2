...
| Pattern                                                            | Best For                                            |
|--------------------------------------------------------------------|-----------------------------------------------------|
| [Single Agent](/agent-platform/v1/orchestration/single-agent)         | Simple, focused use cases with one domain           |
| [Supervisor](/agent-platform/v1/orchestration/supervisor)             | Complex tasks requiring parallel agent coordination |
| [Adaptive Network](/agent-platform/v1/orchestration/adaptive-network) | Dynamic hand-offs between specialized agents        |
