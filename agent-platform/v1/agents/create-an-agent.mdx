...
- **Create an Agentic App.** Agents must be associated with an app and can't exist independently. See [Create an Agentic App](/agent-platform/v1/agents/agentic-apps/create-an-app).
- **Configure an AI model** with tool-calling support. The Platform supports OpenAI, Gemini, Anthropic, and Azure OpenAI. See [Add an External Model](/agent-platform/v1/models/external-models#add-a-model-via-easy-integration).
...
|--------------------------------------------------------------------|----------------------------------------------|---------------------------------------------|
| [From Scratch](/agent-platform/v1/agents/create-from-scratch)         | You want full control over all settings      | Profile, instructions, tools, and knowledge |
| [Connect External Agent](/agent-platform/v1/agents/external-agents)   | You have an agent hosted elsewhere           | Connection details only                     |
| [From Marketplace](/agent-platform/v1/agents/create-from-marketplace) | You want a preconfigured, ready-to-use agent | Minimal edits required                      |
