...
![Playground](/agent-platform/v1/agents/agentic-apps/images/playground/home.png "Playground")
...
![Timeline](/agent-platform/v1/agents/agentic-apps/images/playground/processing-timeline.png "Session debug")
...
![Flow Diagram](/agent-platform/v1/agents/agentic-apps/images/playground/flow-diagram.png "Flow diagram")
...
- File count and size limits are set under **Attachment Configurations** in General Settings. [Learn more](/agent-platform/v1/agents/agentic-apps/settings/app-configurations#attachment-configuration).
- Uploaded files display a preview icon next to the file name for quick identification.

![Document Preview](/agent-platform/v1/agents/agentic-apps/images/playground/preview.png "Document preview")
</Note>
...
![Context Management](/agent-platform/v1/agents/agentic-apps/images/attachments/document-mgmt.png "Context Management")
...
![History](/agent-platform/v1/agents/agentic-apps/images/playground/history.png "Conversation History")
...
![Authorization](/agent-platform/v1/agents/agentic-apps/images/playground/auth.png)
