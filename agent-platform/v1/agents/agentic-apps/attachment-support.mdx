...
<Badge icon="arrow-left" color="gray">[Back to Playground](/agent-platform/v1/agents/agentic-apps/simulation-and-testing)</Badge>
...
In the Playground, use the **Attach** option in the chat widget to upload files while testing. For file size and count limits, see [Attachment Configuration](/agent-platform/v1/agents/agentic-apps/settings/app-configurations#attachment-configuration).
...
- There are limits on file count and size. See [App Configurations](/agent-platform/v1/agents/agentic-apps/settings/app-configurations#attachment-configuration) for details.
