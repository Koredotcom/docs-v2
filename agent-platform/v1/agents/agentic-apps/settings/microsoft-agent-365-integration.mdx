...
![Review Environment Variables page in Kore Agent Builder with the three A365 values entered](/agent-platform/v1/agents/agentic-apps/settings/images/ms-agent365-2.png)
