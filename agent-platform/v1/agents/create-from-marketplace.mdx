...
- [Test the agent](/agent-platform/v1/agents/create-an-agent#test-the-agent) before publishing
- [Configure delegation rules](/agent-platform/v1/agents/create-from-scratch#step-5-configure-delegation) if your app uses the Adaptive Network pattern
