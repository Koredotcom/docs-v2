...
| Welcome Message |Enable and provide a welcome message to play at the start of a session. |This is supported for Gemini real-time models.|

#### Adding a Welcome Message to Voice Interactions
...
To configure it, navigate to **Orchestrator** >** Voice-to-Voice Interactions**. Choose a supported model and click on **Settings**. Enable the **Welcome Message** toggle and provide the message in text format.
