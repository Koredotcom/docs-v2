...
<Note> Voice event logs are currently available for OpenAI real-time models only, across all orchestration patterns. Logs are not yet available for Gemini, Azure OpenAI, and Ultravox models. </Note>
