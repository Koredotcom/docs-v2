...
- If a conflict arises, that is, a tool with the same name exists in the Agentic app — the system prefixes the MCP server name to the tool name.
...
4. Review the request sent to the server and the response returned in the **Test Results** section.
