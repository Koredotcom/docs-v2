---
title: Agent Platform Release Notes 2025 Archive
noindex: true
hidden: true
mode: center
---
...
<Badge icon="arrow-left" color="gray">[Back to the latest release notes](/agent-platform/v1/release-notes/recent-updates)</Badge>

This document provides archived information about the feature updates and enhancements introduced in the past releases of Agent Platform.
...
Admins can now export and download All Runs and Logs from the Monitoring Custom Scripts dashboard as a `.csv>` file, following the schema and file-naming conventions defined in the Agent Platform. 
...
* Azure OpenAI models: GPT-4.1, GPT-4.1-Mini, and GPT-4.5 preview.
* Gemini 2.0 and 2.5 models: gemini-2.0-flash, gemini-2.0-flash-lite, and gemini-2.5-flash-preview-05-20. 
* Anthropic Claude 4 models: claude-sonnet-4-20250514 and claude-opus-4-20250514. 
