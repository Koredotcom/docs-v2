...
This document provides information about the latest feature updates and enhancements introduced in the recent Agent Platform releases. For previous updates, see [these release notes](/agent-platform/v1/release-notes/recent-updates-2025).

---

## v1.8.10 September 12, 2026
...
The platform now supports additional Google Gemini models:
 - gemini-3.5-flash-lite
 - gemini-3.6-flash
 - gemini-3.7-flash
 - gemini-3.7-flash-lite

[Learn more →](/agent-platform/v1/models/supported-models)

---

## v1.8.9 August 8, 2026

<Badge>Minor Release</Badge>

This release includes bug fixes and an update summarized below.

<p className="rn-title">Integrations</p>

<p className="rn-subtitle">New Composio connections are no longer supported</p>

New Composio integration connections can no longer be created. Existing Composio integrations remain available for use. 
...
<p className="rn-subtitle">Welcome Message for Gemini Real-time Voice Models</p>

Configurable Welcome Messages are now supported for Gemini real-time voice models. When enabled, the agent automatically speaks a predefined greeting at the start of a voice session, establishing context and creating a more natural conversational experience.

[Learn more →](/agent-platform/v1/orchestrate#add-a-welcome-message-to-voice-interactions)

<p className="rn-title">AI Engineering Tools</p>

<p className="rn-subtitle">Expanded Model Support</p>
 
The platform now supports the following additional AI models:
...
<p className="rn-subtitle">Vertex AI Model Integration</p>
 
The gemini-3.5-flash model is now supported, with connections configurable manually or via cURL import, and automated credential extraction available for both AI Studio and Vertex AI formats.

[Learn more →](/agent-platform/v1/models/external-models#vertex-ai)

<p className="rn-title">AI Safety, Security, and Governance</p>

<p className="rn-subtitle">Enhanced PII Detection and Anonymization</p>

The underlying NER model in the Anonymize/Deanonymize scanners has been upgraded to its latest version, improving detection accuracy for context-dependent entities such as PERSON, PHONE_NUMBER, and US_SSN — with fewer missed entities and reduced over-redaction of non-PII tokens.
...
<p className="rn-subtitle">Support for Hyperparameters in Custom Model Integrations</p>

Custom Integration models now support a JSON editor for defining model-specific hyperparameters and vendor-specific settings, enabling users to pass parameters not available through standard model controls. The JSON configuration is saved with the model and is automatically available when the model is selected in agents or orchestrators. 

[Learn more →](/agent-platform/v1/models//external-models#existing-provider-structures-mode)

<p className="rn-subtitle">Expanded Model Support</p>
 
The platform now supports additional AI models:
 - Google: gemini-3.1-flash-live-preview 
 - Open AI: gpt-realtime-2 
...
[Learn more →](/agent-platform/v1/apis/agentic-apps/import-export)
...
<p className="rn-title">No-Code & Pro-Code Tools</p>

<p className="rn-subtitle">Role-Based Access for Workflow Tools in Agentic Apps</p>
...
[Learn more →](/agent-platform/v1/tools/workflow#tool-access-control)
...
<p className="rn-subtitle">New Input Processor</p>
...
[Learn more →](/agent-platform/v1/orchestrate#input-processor)

<p className="rn-subtitle">Preprocessors for Events</p>
...
[Learn more →](/agent-platform/v1/agents/agentic-apps/settings/events#event-processor)

<p className="rn-subtitle">AI for Service Logs Integration</p>
...
<p className="rn-subtitle">Agent Protocol Enhancement - Get Sessions API</p>
...
[Learn more →](/agent-platform/v1/apis/agentic-apps/sessions#get-session-details)
...
<p className="rn-subtitle"> Custom Tags Support</p>
...
[Learn more →](/agent-platform/v1/agents/agentic-apps/custom-tags)

<p className="rn-subtitle">Expanded A2A Protocol Support</p>
...
[Learn more →](/agent-platform/v1/agents/external-agents#connect-through-a2a-protocol)

<p className="rn-subtitle">List Sessions API</p>
...
[Learn more →](/agent-platform/v1/apis/agentic-apps/sessions#list-sessions)


<p className="rn-subtitle">Expanded Real-time V2V Model Support for Adaptive Network</p>
...
[Learn more →](/agent-platform/v1/models/supported-models#real-time-voice-models)


<p className="rn-subtitle">Playground Enhancements</p>

The enhanced Playground significantly improves the testing and validation experience for developers:

* **Inline Artifacts Support:** Playground now supports inline rendering of artifacts, allowing developers to preview outputs without full deployment. When enabled, artifacts appear within the conversation flow, improving visibility and simplifying the validation of structured data. AI for Service-supported templates are rendered using native UI components, while non-supported artifacts are displayed as raw JSON. [Learn More](/agent-platform/v1/howto/structured-response-rendering-artifacts)
...
<p className="rn-subtitle">Configurable Transcription for Realtime Sessions</p>
...
[Learn more →](/agent-platform/v1/howto/configure-transcription)
...
<p className="rn-subtitle">Data Anonymization: Module-Level Control for Anonymization and Deanonymization</p>
...
Access controls are now configurable at the module level, specifying whether users, code tools, workflow tools, MCP tools, events, pre-processors, and proxy agents receive original or redacted values at each processing stage. [Learn more →](/agent-platform/v1/agents/agentic-apps/settings/pii-detection-pattern)

<p className="rn-subtitle">Native mTLS Support for OAuth 2.0 Client Credential Auth Profiles</p>
...
[Learn more →](/agent-platform/v1/administration/security-and-control#add-an-auth-profile)
...
[Learn more →](/agent-platform/v1/deploy/import-export)
...
[Learn more →](/agent-platform/v1/agents/agent-management#execution-mode)
...
[Learn more →](/agent-platform/v1/orchestrate#response-processor)
...
[Learn more →](/agent-platform/v1/tools/mcp#configure-mcp-tools)
...
[Learn more →](/agent-platform/v1/agents/agentic-apps/settings/variables)
...
[Learn more →](/agent-platform/v1/tools/code#step-4-define-output-parameters)
...
[Learn more →](/agent-platform/v1/agents/agentic-apps/settings/events)
...
[Learn more →](/agent-platform/v1/agents/agent-management)

<p className="rn-title">No-code and Pro-Code Tools</p>
...
[Learn more →](/agent-platform/v1/tools/workflow#versions)
...
[Learn more →](/agent-platform/v1/models/external-models#microsoft-foundry)
...
[Learn more →](/agent-platform/v1/administration/security-and-control#single-sign-on-sso)
...
[Learn more →](/agent-platform/v1/agents/create-an-agent)
...
Workflow Tools created outside an Agentic App and not linked to any app can't access namespaces or app-level environment variables.

[Learn more →](/agent-platform/v1/tools/workflow#access-app-environment-variables)
