...
Agent Platform now supports the gemini-3.5-flash model. You can configure connections manually or import them via cURL, with automated credential extraction available for both AI Studio and Vertex AI formats.
