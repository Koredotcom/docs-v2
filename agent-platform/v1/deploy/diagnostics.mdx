...
<Note>Diagnostics performs static and logical validation. It evaluates configuration health. Use [Playground](/agent-platform/v1/agents/agentic-apps/simulation-and-testing) to test conversational outcomes.</Note>
