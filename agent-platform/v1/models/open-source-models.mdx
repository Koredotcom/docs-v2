...
To connect your Hugging Face account, see [Enable Hugging Face](/agent-platform/v1/administration/integrations#hugging-face).
...
**Structured Output**: Kore-hosted models support JSON schema responses via the `response_format` parameter (v2/chat/completions endpoint only). See [Supported Models for Structured Output](/agent-platform/v1/models/supported-models#structured-output).
...
Version numbers auto-increment (for example, Model_v1, Model_v2).
