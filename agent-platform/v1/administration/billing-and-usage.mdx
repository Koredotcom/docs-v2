...
| Metric | Description |
|--------|-------------|
| **Runs** | Tool runs consumed vs. total allocation (for example. 45 of 10,000 = 0.45% used) |
| **Credits** | Credits used across models, guardrails, and custom scripts vs. total (for example. 212 of 300 = 70.72% used). Includes a color-coded pie chart; hover to see values per category. |
...
| **Credits Used** | Credits consumed for hardware and resources. See [pricing table](/agent-platform/v1/administration/security-and-control#step-3-resource-allocation). |
| **Last Active On** | Most recent date the script was active |
| **Status** | Deployment status. [Learn more](/agent-platform/v1/administration/security-and-control#script-statuses). |
...
- Credits consumed per component. See [pricing table](/agent-platform/v1/administration/security-and-control#step-3-resource-allocation).
...
- Before deploying custom scripts, review the [hardware profile and credits table](/agent-platform/v1/administration/security-and-control#step-3-resource-allocation).
