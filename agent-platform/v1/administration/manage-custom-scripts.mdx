...
- Project file is within the 1 GB limit.
   ...
   ![validate file](/agent-platform/v1/settings/manage-custom-scripts/images/validate-file.png)
...
![runtime settings](/agent-platform/v1/settings/manage-custom-scripts/images/runtime-settings.png)
...
![resource allocation](/agent-platform/v1/settings/manage-custom-scripts/images/resource-allocation.png)
...
2. Click **Re-deploy** on the **Overview** page.
   ...
   ![redeploy script](/agent-platform/v1/settings/manage-custom-scripts/images/re-deploy-script.png)
...
- **cURL**: API endpoint information for the script.
  ...
  ![curl code](/agent-platform/v1/settings/manage-custom-scripts/images/curl-endpoint.png)

- **JavaScript**: Payload JSON code in JavaScript format.

  ![java code](/agent-platform/v1/settings/manage-custom-scripts/images/java-endpoint.png)

- **Python**: Payload JSON code in Python format.

  ![python code](/agent-platform/v1/settings/manage-custom-scripts/images/python-endpoint.png)
...
2. In the **Edit Request** dialog, configure the following:
   ...
   - Copy the cURL from the [Endpoint](#endpoint) page of the custom script.
     ...
     ![copy endpoint](/agent-platform/v1/settings/manage-custom-scripts/images/copy-endpoint.png)

   - Paste it in the text field.

     ![curl link](/agent-platform/v1/settings/manage-custom-scripts/images/curl-edit-request.png)
...
For more information, see the [API node](/agent-platform/v1/tools/nodes#api-node) documentation.
