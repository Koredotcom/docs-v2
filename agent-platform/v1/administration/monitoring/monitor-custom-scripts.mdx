...
![Failure rate](/agent-platform/v1/settings/monitoring/images/failure-rate.png)
...
![Record view](/agent-platform/v1/settings/monitoring/images/record-view.png)
...
![Runs schema](/agent-platform/v1/settings/monitoring/images/runs-schema.png)

**Logs schema:**

![Logs schema](/agent-platform/v1/settings/monitoring/images/logs-schema.png)
