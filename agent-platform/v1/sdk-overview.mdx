...
For details, see the [SDK architecture](/agent-platform/v1/sdk/architecture).
...
{/* If you prefer a manual workspace setup, see [this article](/agent-platform/v1/sdk/manual-configuration). */ }
