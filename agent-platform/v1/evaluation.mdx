...
[Learn more →](/agent-platform/v1/evaluation/model-evaluation)
...
[Learn more →](/agent-platform/v1/evaluation/agentic-evaluation)

---

## Accessing Evaluation Studio

1. [Log in](/agent-platform/v1/getting-started) to your Platform account.
...
3. On the Evaluation page, select **Model Evaluation** or **Agentic Evaluation** to begin.
    ...
    ![Evaluation Studio Page](/agent-platform/v1/evaluation/images/eval_studio_page.png)
