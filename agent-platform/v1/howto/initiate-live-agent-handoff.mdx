...
* [Integrate AI for Service and the Platform using the Automation Node](/agent-platform/v1/agents/ai-for-service#integrate-an-agentic-app-with-ai-for-service-app).
...
[Learn more about event configuration →](/agent-platform/v1/agents/agentic-apps/settings/events#agent-handoff-event)
