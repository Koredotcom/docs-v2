...
<Note>[Wait Time Experience](/agent-platform/v1/agents/agentic-apps/settings/app-configurations#waiting-experience) is not supported for Real-Time Voice interactions.</Note>

**To configure:**

1. Enable Real-Time Voice in the AI for Service Automation Node. ![Enable Real Time Voice](/agent-platform/v1/howto/images/voice/real-time-voice.png "Enable Real-Time Voice")
2. Enable Real-Time Voice in the Agentic App and configure a model that supports real-time voice. ![Enable Real Time Voice in Agent Platform](/agent-platform/v1/howto/images/voice/enable-voice-ap.png "Enable Real-Time Voice in Agent Platform")
...
2. To enable streaming, turn on the **TTS Streaming** option. ![TTS Streaming](/agent-platform/v1/howto/images/voice/tts-streaming.png)
