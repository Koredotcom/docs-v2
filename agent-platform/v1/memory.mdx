...
[Learn More](/agent-platform/v1/tools/nodes#function-node).
...
When users upload files, metadata is stored in `sessionMeta.artifacts`. [Learn More](/agent-platform/v1/agents/agentic-apps/attachment-support#accessing-metadata-in-code-tools).
