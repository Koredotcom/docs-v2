...
After your agents go live, Arch reads production traces, runs evaluations, and proposes improvements as reviewable patches — continuously, without manual triage. Each iteration raises the quality floor across every agent in the project.

## Evaluations

Evals are automated tests that continuously check if an AI agent is correct, safe, and on-policy. They turn vague feelings into measurable numbers you can track and defend.
They make every downstream decision measurable. Evals are the prerequisite for trusting, improving, or tuning anything.  For more information, see [Evaluations](/agent-platform/evals).
