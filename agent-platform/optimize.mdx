...
| --- | --- | --- |
| **Production Traces** | Live agent sessions | Conversation, handoff, workflow, tool, guard, and retrieval events. (For more information, see [Sessions](/agent-platform/analytics-insights/analytics-explorer).)|
