...
Control whether projects in this workspace can enable server-side call recording.
 
Toggle **Enable call recording for this workspace** on or off. When disabled, recording settings and recorded media are hidden across all projects.
