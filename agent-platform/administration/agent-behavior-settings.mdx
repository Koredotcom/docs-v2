...
<Note>An account admin must turn on call recording for the workspace (**Account** → **Workspace Settings**) before a project can turn it on for itself. If your project's **Settings** menu doesn't show a **Recording** tab, ask your account admin to confirm the workspace-level setting.</Note>
...
Once a recording **Completed**, the panel shows its duration, storage size, and retention (expiry) date. You can:
