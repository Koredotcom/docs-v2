...
| **SIP Transfer Target URI**     | Project fallback SIP URI used when a call transfer does not provide an explicit SIP target (for example, `sip:agent@example.com`).                     | Empty                |
