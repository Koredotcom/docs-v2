...
| **Credits Used** | Credits consumed for hardware and resources. See [pricing table](../manage-custom-scripts/custom-scripts.md#step-3-resource-allocation). |
| **Last Active On** | Most recent date the script was active |
| **Status** | Deployment status. [Learn more](../manage-custom-scripts/custom-scripts.md#information-on-script-deployment-statuses). |
...
- Credits consumed per component. See [pricing table](../manage-custom-scripts/custom-scripts.md#step-3-resource-allocation).
...
- Before deploying custom scripts, review the [hardware profile and credits table](../manage-custom-scripts/custom-scripts.md#step-3-resource-allocation).
- Monitor guardrail deployment duration—hardware costs accumulate over time.

## Related

- [Custom Scripts](../manage-custom-scripts/custom-scripts.md) — Manage and deploy custom scripts
- [Tools Analytics Dashboard](../../monitoring/analytics/tools-analytics-dashboard/) — Detailed tool performance metrics
- [Model Analytics Dashboard](../../monitoring/analytics/model-analytics-dashboard/) — Model performance and token usage
