...
<CardGroup cols={3}>
  <Card title="General" icon="gear" href="/agent-platform/administration/project-settings/general">
  </Card>
  <Card title="Integrations" icon="plug" href="/agent-platform/administration/project-settings/integrations">
  </Card>
  <Card title="Agent Behavior" icon="comments" href="/agent-platform/administration/project-settings/agent-behavior">
  </Card>
  <Card title="Security and Observability" icon="shield-halved" href="/agent-platform/administration/project-settings/security-and-observability">
  </Card>
  <Card title="Catalog" icon="grid-2" href="/agent-platform/administration/project-settings/catalog">
  </Card>
  <Card title="Advanced" icon="sliders" href="/agent-platform/administration/project-settings/advanced">
  </Card>
</CardGroup>