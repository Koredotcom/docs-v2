...
|---------|-------------|---------|
| **Enable Attachments** | Allows users to upload files during chat sessions. Disable this setting to prevent file uploads for the project. | Enabled (Inherited) |
...
| **Allowed File Types** | MIME types that users can upload. You can configure up to **50** MIME types. | 27 predefined types |
...
**PII Policy**: Determines how the platform handles files containing **Personally Identifiable Information (PII)** after file contents have been extracted.
