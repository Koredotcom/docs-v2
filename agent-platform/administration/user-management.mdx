...
To change the role for a single user, see [Reassign a Role](./role-management.md#reassign-an-alternative-role-to-active-users).
...
For detailed instructions on creating and managing roles, see [Role Management](./role-management.md).
...
- [Role Management](./role-management.md) — Create and manage system and custom roles
- [Settings Console](../../administration/overview.mdx) — Other admin features
- [Audit Logs](../monitoring/audit-logs.md) — Track user activity and account events
