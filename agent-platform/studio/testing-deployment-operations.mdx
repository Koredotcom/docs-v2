...
- [Tools, knowledge & connections](/agent-platform/studio/tools-knowledge-connections) -- tools and workflows that generate sessions
- [Insights & settings](/agent-platform/studio/insights-and-settings) -- analytics derived from sessions, and project configuration
