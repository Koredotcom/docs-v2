...
| **Genesys Open Messaging** | Connect Genesys Cloud Open Messaging conversations through a project-scoped webhook adapter | [Set up Genesys Open Messaging](/agent-platform/channels/digital#set-up-genesys-open-messaging) |
...
| **Kore Agent Assist**      | Kore.ai Agent Assist - real-time agent guidance. The platform generates the API key; the external endpoint contract is unchanged. | Set up Kore Agent Assist                                             |
