...
| [Microsoft Teams](/agent-platform/channels/digital#set-up-microsoft-teams) | Integrate agents into Teams channels and chats                                                  |
...
| [Genesys Open Messaging](/agent-platform/channels/digital#set-up-genesys-open-messaging) | Connect Genesys Cloud Open Messaging conversations through a project-scoped webhook adapter     |
