...
| **Genesys Audio Connector** | Configure Genesys Audio Connector for KoreVG-owned AudioHook execution or legacy Artemis diagnostics        | [Set up Genesys Audio Connector](/agent-platform/channels/voice#set-up-genesys-audio-connector) |
