...
| [Webhook](#webhook-channels) | Webhooks (HTTP Async) | Agent responses are pushed to a webhook URL on your own server. |
...
| [WhatsApp](/agent-platform/channels/set-up-whatsapp)                     | Connect agents to WhatsApp Business for customer messaging                                      |
...
| [Telegram](/agent-platform/channels/set-up-telegram)                    | Connect agents to Telegram bots for messaging and group conversations                           |
...
| Channel               | Description                                                  |
|-----------------------|--------------------------------------------------------------|
| [Webhooks (HTTP Async)](/agent-platform/channels/set-up-webhook) | Receive agent responses via webhook callbacks to your server |
...
|----------------------|------------------------------------------------------------------------------------------|
| [AG-UI (CopilotKit)](/agent-platform/channels/set-up-ag-ui-copilotkit) | Server-sent events protocol for React/Next.js frontend agent UIs, with streaming support |
| [Agent-to-Agent (A2A)](/agent-platform/channels/set-up-agent-to-agent) | Google A2A protocol for inter-agent communication with task lifecycle management         |
