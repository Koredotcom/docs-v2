...
- **Create an Agentic App.** Agents must be associated with an app and can't exist independently. See [Create an Agentic App](/agent-platform/agents/agentic-apps/create-an-app).
