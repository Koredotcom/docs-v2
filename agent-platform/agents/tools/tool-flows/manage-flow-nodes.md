...
3. **Use the blue plus icon (+) on a node**: Hover over the grey dot on any node (including Start) to reveal a blue plus icon (+). Click to see options:
  ...
  <img src="../images/start_node_new.png" alt="Add a new Node" title="Add a new Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/rename_node_new.png" alt="Rename a Node" title="Rename a Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/rearrange-a-node-new.gif" alt="Rearrange a Node" title="Rearrange a Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/connect-nodes-new.gif" alt="Connect Nodes" title="Connect Nodes" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/blue_plus_icon.png" alt="Blue plus icon" title="Blue plus icon" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/sequential_connection.png" alt="Sequential connection" title="Sequential connection" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/simple_parallel.png" alt="Simple parallel" title="Simple parallel" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/blue_icon_parallel.png" alt="Blue icon" title="Blue icon" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/parallel_dragtoconnect.png" alt="Drag to connect" title="Drag to connect" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/parallel_connections_panel.png" alt="Drag to connect" title="Drag to connect" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/delete_connection.png" alt="Delete icon" title="Delete icon" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/delete_icon.png" alt="Delete icon" title="Delete icon" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/sequential_log.png" alt="Sequential log" title="Sequential log" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/debug_log_new.png" alt="Parallel log" title="Parallel log" class="border-2 border-gray-300 rounded-xl" />
