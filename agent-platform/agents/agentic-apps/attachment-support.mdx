...
In the Playground, use the **Attach** option in the chat widget to upload files while testing. For file size and count limits, see [Attachment Configuration](/agent-platform/agents/agentic-apps/settings/app-configurations#attachment-configuration).
