...
| **Response Display** | Shows the agent's response to each submitted query. If artifacts are enabled, the response also shows the artifacts after each response.  |
