...
These patterns are configured in agent definitions and executed automatically by the runtime. See the [ABL SDK](/agent-platform/sdks#abl-sdk) for programmatic access to agent definitions.
