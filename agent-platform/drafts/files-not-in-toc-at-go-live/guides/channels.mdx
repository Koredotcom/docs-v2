...
section: 'guides'
order: 11
description: 'Channels connect your deployed agents to the platforms where your users interact -- websites, messaging apps, and voice calls. Agent Platform provides channel adapters that handle the protocol-specific '
---

# Channels

Channels connect your deployed agents to the platforms where your users interact -- websites, messaging apps, and voice calls. Agent Platform provides channel adapters that handle the protocol-specific details so your agent definition works across all channels without modification.
...
Register the Slack app credentials with the Agent Platform.
...
Register the WhatsApp credentials with the Agent Platform.
...
- [Safety & Guardrails](/agent-platform/guides/safety-and-guardrails) -- Rate limiting for SDK channels
- [Publishing & Operations](/agent-platform/guides/publishing-and-operations) -- Deploy agents to channels
