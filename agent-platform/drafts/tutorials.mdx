...
<CardGroup cols={2}>
  <Card title="1. Build Your First Agent" icon="robot" href="/agent-platform/tutorials/build-your-first-agent">
    ...
    **Prerequisites:** An Agent Platform account with at least one project.
  </Card>

  <Card title="2. Add Structured Steps to an Agent" icon="list-ol" href="/agent-platform/tutorials/build-a-scripted-flow">
    ...
    **Prerequisites:** Completed [Build Your First Agent](/agent-platform/tutorials/build-your-first-agent).
  </Card>

  <Card title="3. Multi-Agent and Knowledge" icon="network-wired" href="/agent-platform/tutorials/multi-agent-and-knowledge">
    ...
    **Prerequisites:** Completed [Add Structured Steps to an Agent](/agent-platform/tutorials/build-a-scripted-flow).
  </Card>

  <Card title="4. Safety, Testing and Publishing" icon="shield-check" href="/agent-platform/tutorials/safety-testing-publishing">
