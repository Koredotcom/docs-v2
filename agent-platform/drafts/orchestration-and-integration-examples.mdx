...
Multi-agent coordination patterns and step-by-step recipes for connecting ABL agents to external services such as Salesforce, Slack, WhatsApp, and voice IVR.
...
- [Examples by Pattern](/agent-platform/drafts/abl-examples-by-pattern) -- complete ABL definitions for each pattern shown here
- [Examples by Industry](/agent-platform/drafts/abl-examples-by-industry) -- these patterns combined in production-style, industry-specific systems