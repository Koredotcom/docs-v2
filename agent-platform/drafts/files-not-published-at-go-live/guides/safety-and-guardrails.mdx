...
section: 'guides'
order: 9
description: 'Agent Platform provides multiple layers of safety controls to protect your agents from misuse, prevent sensitive data leaks, enforce business rules, and maintain audit trails. This guide covers input an'
---

# Safety & Guardrails

Agent Platform provides multiple layers of safety controls to protect your agents from misuse, prevent sensitive data leaks, enforce business rules, and maintain audit trails. This guide covers input and output guardrails, business constraints, rate limiting, audit logging, and custom guardrail policies.
...
- [Guardrails Reference](/agent-platform/abl-reference/guardrails) -- Full ABL syntax for GUARDRAILS blocks
- [Memory & Constraints Reference](/agent-platform/abl-reference/memory-and-constraints) -- CONSTRAINTS block syntax
- [Testing & Evaluation](/agent-platform/guides/testing-and-evaluation) -- Test guardrail effectiveness with adversarial personas
