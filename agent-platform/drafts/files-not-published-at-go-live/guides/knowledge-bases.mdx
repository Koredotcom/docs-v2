...
section: 'guides'
order: 7
description: 'Knowledge bases give your agents access to your organization information. Instead of relying solely on the LLM training data, your agents can search through your documents, websites, and connectors.'
---
...
**3. Chunk** -- Raw extracted text is typically too long to embed as a single unit. The chunking stage splits text into smaller, meaningful segments that can be individually embedded and retrieved. Agent Platform supports three chunking strategies:
...
Agent Platform uses **hybrid search**, combining two complementary strategies:
...
- [Core Concepts](/agent-platform/core-concepts) -- Foundational platform concepts
- [Tools](/agent-platform/abl-reference/tools) -- Search tool definitions and parameters
- [Memory & State](/agent-platform/guides/memory-and-state) -- Store and recall knowledge search results
