...
section: 'studio'
order: 1
description: 'Studio is the primary web interface for building, testing, deploying, and monitoring AI agents on the Agent Platform. It provides a unified workspace where teams can manage every phase of the agent life'
---
...
- **AI Architect toggle** -- opens the AI Architect side panel (available inside any project). See [Agent development](/agent-platform/studio/agent-development).
...
Project settings are organized into dedicated pages accessible from the **Settings** group in the sidebar. See [Insights & settings](/agent-platform/studio/insights-and-settings) for complete documentation of each settings page.

## Related pages

- [Agent development](/agent-platform/studio/agent-development) -- building and testing agents
- [Tools, knowledge & connections](/agent-platform/studio/tools-knowledge-connections) -- managing agent resources
- [Testing, deployment & operations](/agent-platform/studio/testing-deployment-operations) -- evaluations, deployment, and monitoring
- [Insights & settings](/agent-platform/studio/insights-and-settings) -- analytics, guardrails, and project configuration
