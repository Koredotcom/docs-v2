...
- See [Orchestration Patterns Cookbook](/agent-platform/examples/orchestration-and-integration) for reusable multi-agent coordination strategies.
- See [Integration Recipes](/agent-platform/examples/orchestration-and-integration) for connecting agents to external services.
- See [Examples by Pattern](/agent-platform/examples/by-pattern) for fundamental ABL constructs.
