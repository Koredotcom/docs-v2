...
## Getting Started with ABL Patterns

ABL agent definitions range from a single conversational agent to multi-agent systems with compliance gates, memory, and human oversight. The examples in this section are organized so you can start with the simplest pattern that fits your use case and layer in complexity only when you need it.
