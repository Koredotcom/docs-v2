...
section: 'admin'
order: 1
description: 'Your workspace is the central hub for managing agents, team members, AI models, and billing within the Agent Platform. Every resource you create lives inside a workspace, and every team member you invit'
---

# Workspace & Team Management

Your workspace is the central hub for managing agents, team members, AI models, and billing within the Agent Platform. Every resource you create lives inside a workspace, and every team member you invite joins through one. This page covers workspace structure, team management, and multi-workspace organizations.

## Workspace Overview

### Resource hierarchy

The Agent Platform organizes resources in a three-level hierarchy:
...
The Agent Platform uses a hierarchical role-based access control (RBAC) system. Each role inherits all permissions from the roles below it.
...
Not all workspace features are available on every plan. The Agent Platform offers tiered plans that unlock progressively more capabilities:
...
> **Important:** Removing a member does not delete their Agent Platform account. They can still access other workspaces they belong to.
