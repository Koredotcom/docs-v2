...
sidebarTitle: Multi-agent and knowledge
noindex: true
hidden: true
---
...
- Completed [Add structured steps to an agent](/agent-platform/tutorials/build-a-scripted-flow)
...
- [Building agents](/agent-platform/guides/building-reasoning-agents) — Deep dive into agent patterns.
- [Knowledge bases](/agent-platform/guides/knowledge-bases) — Advanced knowledge base configuration and search strategies.
