...
> **Intent routing note:** When an example routes on `intent.category`, define the matching categories in the supervisor's top-level `INTENTS:` section. `INTENTS:` declares classifier vocabulary; `HANDOFF:` maps categories to agents.
