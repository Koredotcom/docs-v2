...
<Note>All source files referenced below live in the `examples/` directory. File paths are noted for each example.</Note>
...
> **Source:** `examples/multilingual-insurance-support/supervisor.agent.abl` + `examples/multilingual-insurance-support/agents/`
...
> **Source:** `examples/device-care-support/agents/device_care_supervisor.agent.abl` + `examples/device-care-support/agents/`
...
- [Examples by Pattern](/agent-platform/drafts/abl-examples-by-pattern) -- the same constructs organized by reusable agent pattern instead of industry
- [Orchestration & Integration Examples](/agent-platform/drafts/orchestration-and-integration-examples) -- named multi-agent topologies and external service integration recipes