...
|----------------------------------------------------------------------------|----------------------------------------------------------------------------|
| Amazon S3 Connector                                                        | Enables ingestion of files and objects stored in Amazon S3 buckets.        |
| [Box Connector](/agent-platform/connectors/box)                            | Enables ingestion of documents from Box.                                   |
...
| [Jira Connector](/agent-platform/connectors/jira)                          | Enables ingestion of issues from Jira cloud.                               |
| [Salesforce Connector](/agent-platform/connectors/salesforce)              | Enables ingestion from Salesforce objects, records, and attachments.       |
...
| [Zendesk Connector](/agent-platform/connectors/zendesk)                    | Enables ingestion of knowledge base articles, tickets, and related content from Zendesk. |
