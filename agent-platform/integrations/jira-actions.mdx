---
title: Jira Actions integration
sidebarTitle: Jira Actions
---

<Badge icon="arrow-left" color="gray">[Back to list of integrations](/agent-platform/integrations#actions-and-triggers-integrations)</Badge>
