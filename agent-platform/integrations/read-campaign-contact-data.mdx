...
This guide explains how an Artemis agent can use customer and campaign fields supplied by an AI for Service (CCAI) campaign during an outbound voice session.
