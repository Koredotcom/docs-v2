...
<Note>
The Contact Center app may appear in your environment as CCAI, XO Contact Center, XOCC, SmartAssist, or Contact Center AI, depending on the tenant. This article uses **CCAI**. Use the label shown in your environment; the underlying fields and configuration are the same.
</Note>
...
## Worked example: dynamic customer-profile routing
