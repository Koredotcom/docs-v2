...
| **Channel ID** | Identifies the channel that attributes the request source. |
...
Ensure that the Agent Platform response adheres to the required JSON contract for sub-metric evaluation.
