...
<Steps>
  ...
  <Step title="Create a Contact Center app">
  </Step>

  <Step title="Configure Artemis Integration">
  </Step>

  <Step title="Enable and publish the app.">
  </Step>

  <Step title="Create a Kore Smart Assist integration in Artemis">
  </Step>

  <Step title="Review and enable the connection">
  </Step>
...
3. Use the SmartAssist integration for Agent Transfer routing. Go to **Project Settings** > **Agent Transfer** > **Default Routing** > **Connection** and select the integration. This completes the integration. 

When an agent escalates a conversation, Artemis automatically routes it to the configured AI for Service Contact Center app. Responses generated by the Contact Center app are returned through the SmartAssist connection and presented seamlessly to the customer.
