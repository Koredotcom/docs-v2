...
<Steps>
  ...
  <Step title="Configure the CCAI campaign in AI for Service">
    ...
    1. Click **Create New Voice Campaign**, or edit an existing voice campaign. [Learn more](https://docs.kore.ai/ai-for-service/contact-center/campaigns#create-a-voice-campaign)
