...
| `RICH_CONTENT` | `object`                | No       | --      | Rich content format variants. See [Rich Content](/agent-platform/abl-reference/rich-content-and-expressions).              |
...
| `HANDOFF`   | Transfer to a specified agent (for example. `HANDOFF Live_Agent`). |
