...
| `pipeline`                 | `object`  | No       | disabled         | Pre-classification / tool-filter pipeline (supervisors). See [Multi-Agent & Supervisor](/agent-platform/abl-reference/multi-agent-and-supervisor#execution-pipeline-pre-classification). |
