...
<Note>
  ...
  top level it is not parsed. See [GATHER within FLOW](/agent-platform/abl-reference/flow#gather-in-flow-steps).
</Note>
...
<Note>
  ...
  field — see [GATHER within FLOW](/agent-platform/abl-reference/flow#gather-in-flow-steps).
</Note>
