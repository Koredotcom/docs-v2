...
sidebarTitle: By Pattern
---

A comprehensive collection of fully runnable ABL examples organized by agent pattern. Each example includes the full ABL definition, explanation of key constructs, and guidance on when to use that pattern.
