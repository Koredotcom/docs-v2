...
3. Fine-tune [search settings](https://docs.kore.ai/xo/searchai/chunk-browser/).
...
<Note>You must first build a bot on the AI for Service Platform and create a webhook channel. See [Building a Virtual Assistant](https://docs.kore.ai/xo/getting-started/building-a-virtual-assistant/) and [Add Webhook Channel](https://docs.kore.ai/xo/channels/add-webhook-channel/).</Note>
