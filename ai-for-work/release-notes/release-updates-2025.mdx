...
This document provides archived information about the feature updates and enhancements introduced in the past releases of the AI for Work Platform.

<Info>For recent updates, see [the latest release notes](/ai-for-work/release-notes/release-updates).</Info>>
