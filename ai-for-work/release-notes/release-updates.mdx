...
Administrators can now select which LLM connection generates memory chunks and drives personalization features. The model selector activates when you enable at least one memory feature and lists all configured LLM connections. [Learn more→](/ai-for-work/getting-started/how-to-use#personalisation-and-memory)
