...
The org chart now surfaces employees without a reporting manager. Select the **Show unassigned employees** checkbox to jump to a dedicated section listing them, and expand any employee with reportees to view direct reports inline. Administrators can also control the chart root and administrators can override this selection at any time. [Learn more→](/ai-for-work/getting-started/how-to-use#organization-chart)
