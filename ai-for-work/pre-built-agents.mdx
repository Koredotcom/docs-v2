...
1. Navigate to **User Profile** > **Admin Console** > **Workspaces** > **API Agents** or **Prompt Agents**. You'll see a list of Pre-Built Agents, each marked with a "Prebuilt" label.

2. Toggle the switch **ON** next to the specific agent, or click the **ellipsis (⋮)** icon. A pop-up window appears.

    ![enable-api-agents](/ai-for-work/pre-built-agents/images/enable-api-agents.png "enable-api-agents")
...
3. Provide the following details:
    ...
    * **Actions**: Choose what users can do with this agent:
        ...
        * **Creation**: Users can create new items.
        ...
        ![publish-agent](/ai-for-work/pre-built-agents/images/publish-agent.png "publish-agent")

4. Click **Publish**. The system displays the **Auth Settings** screen before completing the publishing process. See the section below for details.
