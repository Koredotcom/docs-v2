...
**Before you start:** Gather the following credentials from your Search AI app. In the Search AI app, go to **Manage** > **Dev Tools** > **Web/Mobile SDK**. See [Search AI Credentials](/ai-for-service/app-settings/dev-tools/kore-ai-web-sdk) for details.
