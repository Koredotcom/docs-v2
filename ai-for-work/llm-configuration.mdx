...
AI for Work integrates with OpenAI, Azure OpenAI, Google Gemini, and Amazon Bedrock out of the box, and supports custom models via API endpoint. All configurations are managed from the Admin Console.
...
|------|----------|----------------|
| **Basic** | High-volume, straightforward tasks — classification, simple Q&A, routine inquiries | `gpt-4o-mini`, `gemini-2.5-flash`, `gemini-2.5-flash-lite`, `amazon.nova-lite-v1:0` |
| **Standard** | Complex reasoning, multi-step workflows, deeper contextual understanding — recommended default for all system prompts and orchestrators | `gpt-4.1`, `gpt-4o`, `gemini-2.5-pro`, `anthropic.claude-3-5-sonnet-20241022-v2:0`, `amazon.nova-pro-v1:0` |
| **Premium** | Advanced reasoning and complex problem-solving requiring maximum AI capability | `gpt-5`, `gpt-5.1`, `gpt-5.2`, `o3`, `o4-mini`, `gemini-3-pro`, `anthropic.claude-opus-4-20250514-v1:0` |
...
| Capability | OpenAI | Azure OpenAI | Gemini | Bedrock |
|------------|--------|--------------|--------|---------|
| Prompt-based LLM | ✓ | ✓ | ✓ | ✓ |
| Reasoning models | ✓ | ✓ | ✓ | ✓ |
| Native embeddings | ✓ | ✓ | ✓ | ✓ |
| Managed vector DB | ✓ | N/A | N/A | N/A |
| File search / RAG | ✓ | N/A | N/A | N/A |
| Web search | ✓ (`web_search`) | ✓ (`web_search`) | ✓ (`google_search`) | N/A |
| Code execution | ✓ (`code_interpreter`) | N/A | N/A | N/A |
| Container execution | ✓ | N/A | N/A | N/A |
| File generation (docs, pdf, xlsx, zip) | ✓ | N/A | N/A | N/A |
...
2. Click **New** and select a provider: **OpenAI**, **Azure OpenAI**, **Google Gemini**, or **Amazon Bedrock**.
...
| **Provider** | OpenAI, Azure OpenAI, Gemini, Bedrock, or Custom |
