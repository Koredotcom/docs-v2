...
<Note>The Default MCP Server is designed to work within the Agent Platform environment. Compatibility with third-party MCP clients is planned for a future release.</Note>
...
Language Settings lets administrators set a default language for the platform. The configured language applies automatically to all new users onboarded into the account.

**Navigation**: Account Hub → Assistant Configurations → Language Settings

### Configure the Default Language

1. Navigate to **Language Settings**.
2. Search for or select a language from the list.
3. Click **Done** to save.

The selected language becomes the default for all new users added to the account. Existing users are not affected.
...
**Navigation**: Admin Console > Assistant Configurations > Personalisation & Memory

![personalisation-memory-admin](/ai-for-work/assistant-configurations/images/personalisation-memory-admin.png "personalisation-memory-admin")
...
![prebuilt-tools](/ai-for-work/assistant-configurations/images/prebuilt-tools.png "prebuilt-tools")
