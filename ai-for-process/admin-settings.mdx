...
description: Reference guide to the AI for Process Settings console. Covers workspaces, access steps, user management levels, and all modules including user management, integrations, custom scripts, guardrails, monitoring, and security controls.
...
1. [Workspaces](/ai-for-process/settings/workspace-management)
2. [Users](/ai-for-process/settings/user-management)
3. [Roles and permissions](/ai-for-process/settings/role-management)
4. [Automated synchronization](/ai-for-process/settings/user-management#step-4-schedule-automatic-ad-sync) of user data from Enterprise AD, plus configuration of user profile fields and email notifications.
5. [Integrations](/ai-for-process/settings/integrations)
6. [Manage Custom Scripts](/ai-for-process/settings/security-control#custom-scripts)
7. [Monitoring](/ai-for-process/settings/monitoring-overview): [Audit Logs](/ai-for-process/settings/audit-logs), [Workflows Analytics Dashboard](/ai-for-process/settings/monitoring/workflows-analytics), [Model Analytics Dashboard](/ai-for-process/settings/monitoring/model-analytics-and-traces), [Model Traces](/ai-for-process/settings/monitoring/model-analytics-and-traces), and [Monitoring Custom Scripts](/ai-for-process/settings/monitor-custom-scripts).
8. Security and Control: [Single Sign On](/ai-for-process/settings/security-control), [Authorization Profile](/ai-for-process/settings/security-control), and [API Scopes](/ai-for-process/settings/security-control).
...
The current workspace is displayed at the top right corner of the platform UI.

![Workspace home](/ai-for-process/settings/images/workspace-home.png)
...
Click the workspace name to open a drop-down list of all accessible workspaces. Click **Browse all Workspaces** to view the complete list.

![Workspace switcher](/ai-for-process/settings/images/workspace-switcher.png)
...
**[Users](/ai-for-process/settings/user-management)**
...
**[Role Management](/ai-for-process/settings/role-management)**
...
**[Settings](/ai-for-process/settings/user-management)**
...
- Use the configured connection in the [Integration node](/ai-for-process/nodes) to access third-party services while building the workflow.
...
- Select and execute the configured custom script through the [Function node](/ai-for-process/nodes) of the workflows flow.
...
**[Audit Logs](/ai-for-process/settings/audit-logs)**
...
**[Workflows Analytics Dashboard](/ai-for-process/settings/monitoring/workflows-analytics)**
...
**[Model Analytics Dashboard](/ai-for-process/settings/monitoring/model-analytics-and-traces)**
...
**[Model Traces](/ai-for-process/settings/monitoring/model-analytics-and-traces)**
...
**[Custom Scripts](/ai-for-process/settings/monitor-custom-scripts)**
...
**[Single Sign On](/ai-for-process/settings/security-control)**
...
**[Authorization Profile](/ai-for-process/settings/security-control)**
...
**[API Scopes](/ai-for-process/settings/security-control)**
