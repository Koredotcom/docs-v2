...
<img src="../images/access-single-sign-on.png" alt="access sso" title="access sso" class="border-2 border-gray-300 rounded-xl"/>

If SSO is already configured, the **Single sign-on** setup page is displayed, as shown below.

<img src="../images/sso-set-up.png" alt="sso setup" title="sso setup" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/enable-sso.png" alt="enable sso" title="enable sso" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/sso-configuration-updated-successfully.png" alt="sso updated successfully message" title="sso updated successfully message" class="border-2 border-gray-300 rounded-xl"/>

Additionally, the timestamp of when you enabled SSO is displayed as shown below:
<img src="../images/sso-timestamp.png" alt="sso timestamp" title="sso timestamp" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/saml-okta-selection.png" alt="saml-okta-selection" title="saml-okta-selection" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/okta-create-app-integration.png" alt="okta create app integration" title="okta create app integration" class="border-2 border-gray-300 rounded-xl"/></ol>

<ol start="7"><li>In the <b>Create a new app integration</b> window, select <b>SAML 2.0</b> and click <b>Next</b>.
<img src="../images/create-a-new-app-integration.png" alt="create a new app integration" title="create a new app integration" class="border-2 border-gray-300 rounded-xl"/></li>
<li>On the <b>Create SAML Integration</b> page, provide the <b>App Name</b> under <b>General Settings</b>, and click <b>Next</b>.
<img src="../images/create-saml-integration.png" alt="create saml integration" title="create saml integration" class="border-2 border-gray-300 rounded-xl"/></li>
...
<li>Copy the <b>Identity Provider Issuer</b> value into the <b>Identity provider issuer</b>.</li>
    <img src="../images/copy-Identity-Provider-Issuer.png" alt="copy identity provider issuer" title="copy identity provider issuer" class="border-2 border-gray-300 rounded-xl"/></ul>
...
<img src="../images/download-certificate-saml.png" alt="download certificate" title="download certificate" class="border-2 border-gray-300 rounded-xl"/></li>
...
<img src="../images/okta-certificate-notepad.png" alt="okta certificate" title="okta certificate" class="border-2 border-gray-300 rounded-xl"/></li>
<li>Paste the value into the <b>Certificate</b> field on AI for Process’ SSO setup page.
<img src="../images/paste-okta-certificate.png" alt="paste okta certificate" title="paste okta certificate" class="border-2 border-gray-300 rounded-xl"/></li>
...
<img src="../images/okta-sign-in-page.png" alt="okta sign in page" title="okta sign in page" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/onelogin-add-app.png" alt="onelogin add app" title="onelogin add app" class="border-2 border-gray-300 rounded-xl"/>
...
<li>Copy the following values from <b>SSO</b> > <b>Enable SAML2.0</b> on Onelogin and paste them into the relevant fields on AI for Process’ SSO setup page:</li>
    ...
    <img src="../images/paste-onelogin-issuer-url.png" alt="paste one login issuer url" title="paste one login issuer url" class="border-2 border-gray-300 rounded-xl"/></ul>
...
<img src="../images/onelogin-view-details.png" alt="one login view details" title="one login view details" class="border-2 border-gray-300 rounded-xl"/></li>
...
<img src="../images/add-new-x-509-certificate.png" alt="add new x 509 certificate" title="add new x 509 certificate" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/copy-acs-urls.png" alt="copy acs urls" title="copy acs urls" class="border-2 border-gray-300 rounded-xl"/></ul>
...
<img src="../images/onelogin-sign-in-page.png" alt="one login sign in page" title="one login sign in page" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/other-sso-provider.png" alt="other sso provider" title="other sso provider" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/paste-parameters-other-configuration.png" alt="paste parameters for other provider" title="paste parameters for other provider" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/copy-idp-url.png" alt="copy idp url" title="copy idp url"  class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/paste-azure-parameters.png" alt="paste azure parameters" title="paste azure parameters"  class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/paste-ws-federation-data.png" alt="paste ws federation data" title="paste ws federation data"  class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/sign-in-with-google.png" alt="sign in with google" title="sign in with google"  class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/click-disable-sso.png" alt="click disable sso" title="click disable sso" class="border-2 border-gray-300 rounded-xl"/>

3. In the **Disable SSO** confirmation window, click **Yes**.
<img src="../images/disable-sso-screen.png" alt="disable sso screen" title="disable sso screen" class="border-2 border-gray-300 rounded-xl"/>

The following screen is displayed after SSO is disabled.
<img src="../images/enable-sso-screen.png" alt="enable sso screen" title="enable sso screen" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/manage-users-sso.png" alt="manage sso users" title="manage sso users" class="border-2 border-gray-300 rounded-xl"/>

You can add multiple users to the list, as shown below:
<img src="../images/add-multiple-users-to-exclude.png" alt="exclude multiple users" title="exclude multiple users" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/screen-for-excluded-user.png" alt="screen for excluded user" title="screen for excluded user" class="border-2 border-gray-300 rounded-xl"/>

When the user clicks **Continue**, one of the following happens:

When **SSO is enabled**, the following page is displayed.
<img src="../images/login-with-sso.png" alt="login with sso" title="login with sso" class="border-2 border-gray-300 rounded-xl"/>

The user can do one of the following:

* Click **Continue** to log in using the configured SSO provider service's sign-in page, for example, OKTA, as shown below:

<img src="../images/connect-to-okta.png" alt="connect to okta" title="connect to okta" class="border-2 border-gray-300 rounded-xl"/>
