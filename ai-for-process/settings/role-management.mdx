...
- After creating a custom role, it appears in the role dropdown during email invitations.
  ...
  ![custom role listing](/ai-for-process/settings/images/custom-role-listing.png)

- You cannot delete a custom role assigned to active users or included in a pending invitation.

  ![error custom role deletion](/ai-for-process/settings/images/error-custom-role.png)
...
- **Summary counts**: Total roles, system roles, and custom roles.
  ...
  ![summary of counts](/ai-for-process/settings/images/summary-of-counts.png)
...
- **Role table** with the following columns:
  ...
  ![custom and system roles](/ai-for-process/settings/images/custom-and-system-roles.png)
...
![no results found](/ai-for-process/settings/images/no-results-found.png)
...
3. Select **View**.
   ...
   ![select view](/ai-for-process/settings/images/click-view.png)
...
![module-wise permissions](/ai-for-process/settings/images/module-wise-permissions-new.png)
...
3. Select **Duplicate**.
   ...
   ![select duplicate](/ai-for-process/settings/images/select-duplicate.png)

The duplicate appears with the system role name followed by **_copy_**. You can rename it.

![duplicate role](/ai-for-process/settings/images/duplicate-role.png)
...
2. Click **Add New Role**.
   ...
   ![add new role](/ai-for-process/settings/images/add-new-role.png)

3. In the **New Role** window:
   - Enter a unique **Role Name** and **Role Description**.

     ![enter role name and description](/ai-for-process/settings/images/enter-role-name-and-description.png)

   - Select the **Role Type** from the dropdown.

     ![select role type](/ai-for-process/settings/images/select-role-type.png)
...
![enable permissions](/ai-for-process/settings/images/enable-permissions.png)
...
- Select the access level for **Models** first to activate its permissions. Skipping this step automatically disables them.
  ...
  ![set models access](/ai-for-process/settings/images/select-access-for-models.png)

- **Full** automatically selects all module permissions.

  ![full auto select](/ai-for-process/settings/images/select-full-auto-select.png)

- **Custom** lets you select individual permissions.

  ![select custom access](/ai-for-process/settings/images/select-custom-access.png)

- **View** and **No Access** disable permission selection.

  ![select view and no access](/ai-for-process/settings/images/select-view-and-no-access.png)
...
- **Full** for **Settings** sets Integrations and User Management to Full, and enables all permissions for: Integrations (View is always on by default), User Management, Security and Control Settings, Manage Guardrail Models, Monitoring, and Billing.
  ...
  ![select full access](/ai-for-process/settings/images/select-full-access.png)
...
- **No Access** for **Settings** sets Integrations to View and User Management to No Access, and disables all sub-permissions (View for Integrations remains on by default).
  ...
  ![no access](/ai-for-process/settings/images/select-no-access.png)
...
- **Custom** for **Settings** sets Integrations and User Management to Custom, where you can select individual permissions. You can then change Integrations to Full or View, and User Management to Full or No Access.
  ...
  ![select custom](/ai-for-process/settings/images/select-custom.png)

**If Role Type is Workflow:**

Select **Custom**, **View**, or **Full** for **Access**. Custom is the default.

![access options](/ai-for-process/settings/images/access-options.png)
...
![list new custom role](/ai-for-process/settings/images/list-new-custom-role.png)
...
3. Select **Edit**.
   ...
   ![edit role](/ai-for-process/settings/images/edit-role.png)
...
5. Click **Update**.
   ...
   ![update role window](/ai-for-process/settings/images/update-role-window.png)

A success message confirms the update.

![role updated message](/ai-for-process/settings/images/role-updated-message.png)
...
3. Select **Delete**.
   ...
   ![select delete role](/ai-for-process/settings/images/select-delete-role.png)

4. Click **Confirm**.

   ![confirm delete role](/ai-for-process/settings/images/delete-role-confirm.png)
...
![role deletion error](/ai-for-process/settings/images/role-deletion-error.png)
...
3. Select the new role.
   ...
   ![reassign role](/ai-for-process/settings/images/select-role-to-reassign.png)

After reassigning, return to **Role Management** and delete the role. The custom role count decreases.

![custom role deleted](/ai-for-process/settings/images/custom-role-deleted.png)
...
![duplicate custom role](/ai-for-process/settings/images/duplicate-custom-role.png)
