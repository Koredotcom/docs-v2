...
1. Log in → In AI for Process Modules top menu → Click **Data**.
   <img src="../images/navigate-to-data-module.png" alt="Navigate to Data Module" title="Navigate to Data Module" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/download-or-delete-datasets.png" alt="Navigate to Data Module" title="Navigate to Data Module" class="border-2 border-gray-300 rounded-xl"/>
