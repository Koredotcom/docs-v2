...
<img src="../images/import-options.png" alt="import options" title="import options" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/validate-file.png" alt="validate file" title="validate file" class="border-2 border-gray-300 rounded-xl"/></ul>
</p>
</div>
...
<img src="../images/file-naming-convention.png" alt="file naming convention error" title="file naming convention error" class="border-2 border-gray-300 rounded-xl"/></ul>
</p>
</div>
...
<img src="../images/click-add-key.png" alt="add key value" title="add key value" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/runtime-settings.png" alt="runtime settings" title="runtime settings" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/resource-allocation.png" alt="resource allocation" title="resource allocation" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/saved-as-draft.png" alt="saved as draft" title="saved as draft" class="border-2 border-gray-300 rounded-xl"/>

4. Click **Deploy**.
<img src="../images/click-deploy-terms.png" alt="deploy terms" title="deploy terms" class="border-2 border-gray-300 rounded-xl"/>

The following message is displayed when the script deployment progresses, and the status changes to “*Deploying*”.
<img src="../images/initiated-deployment.png" alt="initiated deployment" title="initiated deployment" class="border-2 border-gray-300 rounded-xl"/>
...
* Total allocation
   ...
   <img src="../images/deployment-email.png" alt="deployed success" title="deployed success" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/search-script.png" alt="search script" title="search script" class="border-2 border-gray-300 rounded-xl"/>
...
* **Status**: The current deployment status of the script.
   <img src="../images/deployment-statuses.png" alt="all statuses" title="all statuses" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/hover-over-failed-status.png" alt="failed status" title="failed status" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/access-export.png" alt="access export" title="access export" class="border-2 border-gray-300 rounded-xl"/>

   Alternatively, click the deployed script entry and select **Export** on the **Overview** page.
   <img src="../images/click-export-script.png" alt="export script" title="export script" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/access-undeploy.png" alt="access undeploy" title="access undeploy" class="border-2 border-gray-300 rounded-xl"/>

   You can also select a script entry and click **Proceed to Undeploy** on its **Overview** page. 

   <img src="../images/proceed-to-undeploy.png" alt="proceed to undeploy" title="proceed to undeploy" class="border-2 border-gray-300 rounded-xl"/>

<ol start="2"><li>Click <b>Undeploy</b> in the confirmation window.</li>
<img src="../images/undeploy-script-confirmation.png" alt="undeploy script confirm" title="undeploy script confirm" class="border-2 border-gray-300 rounded-xl"/></ol>

A success message is displayed, and the script’s status changes to <b>Ready to Deploy</b>.</li>
<img src="../images/ready-to-deploy-success.png" alt="ready to deploy" title="ready to deploy" class="border-2 border-gray-300 rounded-xl"/>
...
* Total allocation
   ...
   <img src="../images/undeploy-email.png" alt="undeployed success" title="undeployed success" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/access-delete.png" alt="access delete" title="access delete" class="border-2 border-gray-300 rounded-xl"/>  

   Alternatively, select a script entry and click **Proceed to Delete** on its **Overview** page.
   <img src="../images/proceed-to-delete-script.png" alt="proceed to delete" title="proceed to delete" class="border-2 border-gray-300 rounded-xl"/>  

<ol start="2"><li>Click <b>Delete</b> in the confirmation window.</li> 
<img src="../images/delete-the-script.png" alt="delete the script" title="delete the script" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/click-deployed-script.png" alt="deployed script" title="deployed script" class="border-2 border-gray-300 rounded-xl"/>  

<img src="../images/re-deploy-script.png" alt="redeploy script" title="redeploy script" class="border-2 border-gray-300 rounded-xl"/>  

The system redirects to the following page.

<img src="../images/general-details-page.png" alt="general details page" title="general details page" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/overview-script-deployment.png" alt="overview" title="overview" class="border-2 border-gray-300 rounded-xl"/>  
...
* For the “**Draft**” status, the following window is displayed.
     ...
     <img src="../images/draft-action.png" alt="draft action" title="draft action" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/view-failure-reason.png" alt="deployment failure" title="deployment failure" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/green-check-icon.png" alt="deployment details" title="deployment details" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/rename-dep-version.png" alt="rename deployment version" title="rename deployment version" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/naming-convention.png" alt="naming convention" title="naming convention" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/expand-deployment-history.png" alt="deployment history expansion" title="deployment history expansion" class="border-2 border-gray-300 rounded-xl"/> 
...
<img src="../images/deployment-history-screen.png" alt="deployment history" title="deployment history" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/deployment-success.png" alt="deployment success" title="deployment success" class="border-2 border-gray-300 rounded-xl"/>  


**Deployment Failed**

<img src="../images/deployment-failed.png" alt="deployment failed" title="deployment failed" class="border-2 border-gray-300 rounded-xl"/> 

**Ready to Deploy**

<img src="../images/success-status-deployment.png" alt="ready to deploy status" title="ready to deploy status" class="border-2 border-gray-300 rounded-xl"/>  

**Deploying**

<img src="../images/deploying-status.png" alt="deploying status" title="deploying status" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/curl-endpoint.png" alt="curl code" title="curl code" class="border-2 border-gray-300 rounded-xl"/>  
 
* **JavaScript**: Displays the payload JSON code in JS format.
<img src="../images/java-endpoint.png" alt="java code" title="java code" class="border-2 border-gray-300 rounded-xl"/>   

* **Python**: Displays the payload JSON code in Python format.
<img src="../images/python-endpoint.png" alt="python code" title="python code" class="border-2 border-gray-300 rounded-xl"/>   
...
<img src="../images/copy-endpoint-icon.png" alt="copy endpoint icon" title="copy endpoint icon" class="border-2 border-gray-300 rounded-xl"/>   
...
<img src="../images/not-deployed-error.png" alt="not deployed error" title="not deployed error" class="border-2 border-gray-300 rounded-xl"/>   
...
2. Click **Create a New API Key** or **Create New Key**.
   <img src="../images/create-a-new-api-key.png" alt="create a new api key" title="create a new api key" class="border-2 border-gray-300 rounded-xl"/>  
   <img src="../images/click-create-new-key.png" alt="create new key" title="create new key" class="border-2 border-gray-300 rounded-xl"/>  
 
3. Enter a unique name for the key. By default, “**Secret Key**” is displayed, which you can change.
4. Click **Generate Key**.
   
   <img src="../images/generate-secret-key.png" alt="generate secret key" title="generate secret key" class="border-2 border-gray-300 rounded-xl"/>

<ol start="5"><li>Click <b>Copy and Close</b>.</li>   
<img src="../images/create-new-api-copy.png" alt="create new api copy" title="create new api copy" class="border-2 border-gray-300 rounded-xl"/></ol>  
...
<img src="../images/api-key-success-message.png" alt="api key success message" title="api key success message" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/api-delete-icon.png" alt="click delete" title="click delete" class="border-2 border-gray-300 rounded-xl"/>  

3. Click **Delete** in the confirmation window.

       <img src="../images/delete-api-key.png" alt="delete api key" title="delete api key" class="border-2 border-gray-300 rounded-xl"/>  
...
<img src="../images/define-request.png" alt="define request" title="define request" class="border-2 border-gray-300 rounded-xl"/>  
...
2. Enter or select the following details in the **Edit Request** dialog box: 
    ...
    * Copy the cURL from the [Endpoint section](../manage-custom-scripts/custom-scripts.md#endpoint) of the custom script wizard.
    <img src="../images/copy-endpoint.png" alt="copy endpoint" title="copy endpoint" class="border-2 border-gray-300 rounded-xl"/> 

    * Paste it in the text field of the **Edit Request** page.
    <img src="../images/curl-edit-request.png" alt="curl link" title="curl link" class="border-2 border-gray-300 rounded-xl"/> 
