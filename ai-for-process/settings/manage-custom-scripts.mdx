...
Custom scripts let you deploy reusable code in isolated containers and call them from workflow nodes using secure API endpoints. 

Use the **Manage Custom Scripts** page in **Settings** to upload, configure, and deploy a complete script project without writing code directly in workflow nodes.
