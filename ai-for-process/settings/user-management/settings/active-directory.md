...
<img src="../images/configure-directory-button.png" alt="configure directory" title="configure directory" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/configure-ad-connection.png" alt="configure ad connection" title="configure ad connection" class="border-2 border-gray-300 rounded-xl"/></ul>
...
<img src="../images/org-units.png" alt="manage org units" title="manage org units" class="border-2 border-gray-300 rounded-xl"/></li></ol>
...
<img src="../images/default-fields.png" alt="default fields" title="default fields" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/custom-field-management.png" alt="manage custom field" title="manage custom field" class="border-2 border-gray-300 rounded-xl"/>
</ul>

To remove a field, click the **Delete** icon as shown below.

<img src="../images/delete-custom-field.png" alt="delete custom field" title="delete custom field" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/manage-rules.png" alt="manage rules" title="manage rules" class="border-2 border-gray-300 rounded-xl"/></ol>
...
<img src="../images/add-exclusion.png" alt="add exclusion" title="add exclusion" class="border-2 border-gray-300 rounded-xl"/>

To delete a rule, hover over the entry and click the **Delete** icon.

<img src="../images/delete-rule.png" alt="delete rule" title="delete rule" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/enable-auto-sync.png" alt="enable auto sync" title="enable auto sync" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/daily-schedule.png" alt="daily schedule" title="daily schedule" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/weekly-schedule.png" alt="weekly schedule" title="weekly schedule" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/monthly-schedule.png" alt="monthly schedule" title="monthly schedule" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/other-schedule.png" alt="other schedule" title="other schedule" class="border-2 border-gray-300 rounded-xl"/>

<ol start="3"><li>Click <b>Save</b>.</li>
<img src="../images/save-schedule.png" alt="save schedule" title="save schedule" class="border-2 border-gray-300 rounded-xl"/>
</ol>
...
* **Sync History**: Displays the history of AD syncs, including the comprehensive summary of the following:
  ...
  * The number of **successful** and **failed** user records that got synced.
  <img src="../images/sync-history.png" alt="sync history" title="sync history" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/configure-sync-with-directory.png" alt="configure sync with directory" title="configure sync with directory" class="border-2 border-gray-300 rounded-xl"/>

### Sync Status Email Notifications

For a **successful** sync, you will receive the following email:    

<img src="../images/success-sync.png" alt="success sync" title="success sync" class="border-2 border-gray-300 rounded-xl"/>

For a **failed** sync, you will receive the following email:    

<img src="../images/failed-sync.png" alt="failed sync" title="failed sync" class="border-2 border-gray-300 rounded-xl"/>
