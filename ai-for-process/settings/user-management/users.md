...
<img src="../images/users-count.png" alt="users count" title="users count" class="border-2 border-gray-300 rounded-xl"/>
...
2. On the **Users** dashboard, click **Add New User**, and select **Import**.
   <img src="../images/add-new-user-aip.png" alt="add user" title="add user" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/click-upload-file.png" alt="click upload file" title="click upload file" class="border-2 border-gray-300 rounded-xl"/>
...
* Click and download the sample ._csv_ file for reference.
    ...
    <img src="../images/click-download-sample-file.png" alt="download sample file" title="download sample file" class="border-2 border-gray-300 rounded-xl"/>

* The fields are pre-defined in the sample file, and the data requirements are shown below:
<img src="../images/pre-defined-fields.png" alt="pre-defined fields" title="pre-defined fields" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/mismatch-error.png" alt="fields mismatch error" title="fields mismatch error" class="border-2 border-gray-300 rounded-xl"/>

4. A preview window displays the file’s data with a file uploaded success message. Click **Continue** to import the file.
<img src="../images/success-import.png" alt="click settings" title="click settings" class="border-2 border-gray-300 rounded-xl"/>

5. Click **Continue** once the import is complete, and the following message appears.
<img src="../images/import-completed.png" alt="import completed" title="import completed" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/failed-import-entries.png" alt="failed import entries" title="failed import entries" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/file-imported-successfully.png" alt="file imported successfully" title="file imported successfully" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/imported-entries.png" alt="imported entries" title="imported entries" class="border-2 border-gray-300 rounded-xl"/>

You can see the success/failed import status on the dashboard as highlighted below:

<img src="../images/success-failed-import-status.png" alt="success and failed import status" title="success and failed import status" class="border-2 border-gray-300 rounded-xl"/>

**Failed Import** 

The following message is displayed if the user data in the uploaded file fails to import:

<img src="../images/failed-import-message.png" alt="failed import message" title="failed import message" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/import-canceled.png" alt="import canceled" title="import canceled" class="border-2 border-gray-300 rounded-xl"/>

#### Import History

Click **Import History** in the **Import Users** window to view and analyze the import history of users in your account.
<img src="../images/click-import-history.png" alt="click import history" title="click import history" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/import-history.png" alt="import history" title="import history" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/single-delete.png" alt="single delete" title="single delete" class="border-2 border-gray-300 rounded-xl"/>

**Updated Screen**

<img src="../images/single-delete-result.png" alt="single delete result" title="single delete result" class="border-2 border-gray-300 rounded-xl"/>

**Bulk Delete**

1. Select the required users, and click the **Delete** icon at the bottom of the screen to delete multiple users in the list.
<img src="../images/click-delete-icon.png" alt="click delete icon" title="click delete icon" class="border-2 border-gray-300 rounded-xl"/>

2. Click **Remove** in the **Remove users** window.

    <img src="../images/click-remove.png" alt="click remove" title="click remove" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/bulk-delete-result.png" alt="bulk delete result" title="bulk delete result" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/all-matching-results.png" alt="matching results" title="matching results" class="border-2 border-gray-300 rounded-xl"/>

The following message is displayed if the user does not exist.
<img src="../images/user-does-not-exist.png" alt="user does not exist" title="user does not exist" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/click-unlock.png" alt="click unlock" title="click unlock" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/select-for-role-change.png" alt="select for role change" title="select for role change" class="border-2 border-gray-300 rounded-xl"/>

The role is updated for the selected users.
<img src="../images/bulk-role-changed.png" alt="select for role change" title="select for role change" class="border-2 border-gray-300 rounded-xl"/>
