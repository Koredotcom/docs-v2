...
- If no script has been deployed and executed yet, or if it has been deployed but not run, the following message is displayed.
  ...
  ![No data to display](./images/no-data-to-display.png)
...
![Default calendar selection](./images/one-week-default.png)
...
- **Tooltips**: Hover over metrics for additional information.
  ...
  ![Hover over metrics](./images/hover-over-metrics.png)

- **ID copying**: Click the copy icon when hovering over **Run ID** or **Log ID**.

  ![Copy run ID](./images/copy-run-id.png)

- **Script selection**: Switch between scripts using the dropdown.

  ![Script selection](./images/current-script-selection.png)
...
- **Status indicators**: Green labels for successful runs, red labels for failed runs, and *In Progress* for scripts currently deploying.
  ...
  ![In progress deployments](./images/in-progress-deployments.png)
...
![Failure rate](./images/failure-rate.png)
...
![Total logs](./images/total-logs.png)
...
![Time selection dropdown](./images/time-selection-dropdown.png)
...
![Contains filter example](./images/contains-adding.png)
...
![Record view](./images/record-view.png)
...
![Export error](./images/export-err.png)
...
![Runs schema](./images/runs-schema.png)

**Logs schema:**

![Logs schema](./images/logs-schema.png)
