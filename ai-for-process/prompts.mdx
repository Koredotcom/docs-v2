...
3. Optionally, define a **Response JSON schema** to structure model responses.
   ...
   Supported types: String, Boolean, Number, Integer, Object, Array, Enum, and anyOf. For schema syntax, see [Defining JSON schema](/workflows/workflow-builder/perform-other-actions-on-the-flow-builder/defining-json.md). Resolve any schema errors before proceeding.
