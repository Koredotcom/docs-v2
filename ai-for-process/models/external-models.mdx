...
{/* AG: Is this content highly compressed - How to test configuration and Map Output Fields? */}

### API Integration

{/* AG: Steps are very convoluted. Update for clarity. Remove as many screenshots. Simplify Step 7.  */}
...
5. Select an **Authorization profile** for the request, or select **None** to proceed without authentication. See [Authorization Profiles](/ai-for-process/settings/security-control.mdx#authorization-profile-summary) for details.
...
7. In **Model configurations**, select one of the following options:
   ...
   **Option B: Existing Model Provider Structures**
   ...
   - **Model Features**: Enable one or more features. At least one must be enabled.
     ...
     | Feature             | Description                                                                                                                                                   |
     |---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
     | Structured response | Enables structured output in [Prompts](/ai-for-process/prompts.mdx#add-prompts) and [Workflows](/ai-for-process/workflows/workflow-builder). |
     | Data generation     | Enables synthetic data generation for text tasks in [Prompt Studio](/ai-for-process/prompts.mdx#add-prompts).                                        |
