...
1. Click the **Create a new API key** button. The **Create new API key** dialog is displayed.
    ...
    <img src="../images/create-a-new-api-key-open-source-model.png" alt="Create a new API Key" title="Create a new API Key" class="border-2 border-gray-300 rounded-xl"/>
...
1. Enter a **Name** for the key and click the **Generate key** button. Click the **Copy and close** button to copy your API key and share it with others if required.
    ...
    <img src="../images/copy-and-close-api-key.png" alt="Copy API Key" title="Copy API Key" class="border-2 border-gray-300 rounded-xl"/>
