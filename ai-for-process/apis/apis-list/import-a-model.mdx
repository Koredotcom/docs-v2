...
* [Start Import Session](/ai-for-process/apis/apis-list/import-a-model#start-import-session) - Import Model - Start Session API.
* [Upload Model in Chunks](/ai-for-process/apis/apis-list/import-a-model#upload-model-in-chunks) - Import Model - Chunk Upload API.
* [Complete the Import Process](/ai-for-process/apis/apis-list/import-a-model#complete-the-import-process) - Import Model- Completion API.
...
| **isAdapter**   | Indicates whether the file is an adapter model. Values: True or False. | Boolean    | Optional               |
...
The **Import Model - Chunk Upload** API uploads a file chunk for model import. The `sessionId` from the [Start Import Session API](/ai-for-process/apis/apis-list/import-a-model#start-import-session) must be used here to upload the file in incrementing chunks identified by a unique `Number`.
...
The **Import Model- Complete** API completes the model import process after all file chunks have been successfully uploaded. The `sessionId` from the [Start Import Session API](/ai-for-process/apis/apis-list/import-a-model#start-import-session) must be used for this API.
