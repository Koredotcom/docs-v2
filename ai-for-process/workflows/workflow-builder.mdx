...
![Sequential connection using drag](/ai-for-process/workflows/images/connect-nodes-new.gif)
...
![Connections panel — sequential](/ai-for-process/workflows/images/sequential_connection.png)
...
![Parallel connection using blue icon](/ai-for-process/workflows/images/blue_icon_parallel.png)
...
![Connections panel — parallel](/ai-for-process/workflows/images/parallel_connections_panel.png)
...
![Delete connection from panel](/ai-for-process/workflows/images/delete_icon.png)
...
![Debug log — parallel execution](/ai-for-process/workflows/images/debug_log_new.png)
...
![Define response schema](/ai-for-process/workflows/images/define_response_schema.png)
...
![View structured output](/ai-for-process/workflows/images/view_structured_output.png)
...
![Reuse keys in later nodes](/ai-for-process/workflows/images/reuse_keys.png)
