...
- Set up a connection and authentication profile for the integration. See [Add a connection](/ai-for-process/settings/integrations#add-a-connection) and [Add authorization profile](/ai-for-process/settings/security-control#add-an-authorization-profile).
