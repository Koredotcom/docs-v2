...
<img src="../images/workflow_everyone.png" alt="Human Node" title="Human Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/workflow_reviewnote.png" alt="Human Node" title="Human Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/workflow_wait for response.png" alt="Human Node" title="Human Node" class="border-2 border-gray-300 rounded-xl" />
