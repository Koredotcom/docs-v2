...
<img src="../images/text_to_text_node_new.png" alt="Text to Text Node" title="Text to Text Node" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/configure-gen-ai-node.png" alt="Configure AI Node" title="Configure AI Node" class="border-2 border-gray-300 rounded-xl" />
...
* Enter the following General Settings:
    ...
    2. **Prompt options**: Choose one of the following options:
        ...
        * **Choose a prompt from prompt hub:** If you select ‘Choose a prompt from prompt hub’, follow these steps:
        ...
        <img src="./../images/choose_prompt_with_variables_fields.png" alt="Choose a prompt" title="Choose a prompt" class="border-2 border-gray-300 rounded-xl" />      
...
* **On Failure** > **Go to Node**: If the execution of the current node fails, go to the End node to display any custom error message from the AI node.
    ...
    <img src="./../images/gen-ai-connections.png" alt="AI Actions" title="AI Actions" class="border-2 border-gray-300 rounded-xl" />
...
* **Configure workflow settings**:
    ...
    * In the Additional settings section, configure the following:
    ...
    <img src="./../images/tool_calling_configuration.png" alt="AI Actions" title="AI Actions" class="border-2 border-gray-300 rounded-xl" />
