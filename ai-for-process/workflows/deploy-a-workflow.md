...
<img src="../images/agent_platform/tool_endpoint.png" alt="Deploy Button" title="Deploy Button" class="border-2 border-gray-300 rounded-xl"/>

5. The workflow is deployed and the **Sync** and **Async poll** endpoints are generated.  
<img src="../images/new_endpoint.png" alt="Sync Async Poll" title="Sync Async Poll" class="border-2 border-gray-300 rounded-xl"/>
...
6. If you want to generate an Async push endpoint for the workflow, do the following:
    ...
    <img src="../images/enable-settings.png" alt="Enable/Settings" title="Enable/Settings" class="border-2 border-gray-300 rounded-xl"/>
    ...
    <img src="../images/async-push-endpoint.png" alt="Deploy Button" title="Deploy Button" class="border-2 border-gray-300 rounded-xl"/>
