...
1. Log in → In AI for Process Modules top menu → Click **Workflows**.
    ...
    <img src="../workflow-builder/types-of-nodes/images/access-workflows.png" alt="access workflows" title="access workflows" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../workflow-builder/types-of-nodes/images/import-a-workflow.png" alt="Import a workflow" title="Import a workflow" class="border-2 border-gray-300 rounded-xl"/></li>
...
<img src="../workflow-builder/types-of-nodes/images/workflow-dashboard.png" alt="Workflow dashboard" title="Workflow dashboard" class="border-2 border-gray-300 rounded-xl"/></li></ul>
...
<img src="../workflow-builder/types-of-nodes/images/workflow_instructions.png" alt="click import" title="click import" class="border-2 border-gray-300 rounded-xl"/>
</ol>
...
<img src="../workflow-builder/types-of-nodes/images/go-to-flow.png" alt="tool flow page" title="tool flow page" class="border-2 border-gray-300 rounded-xl"/>
...
4. Scroll down to the **Import a workflow** section and click **Import**.
    <img src="../workflow-builder/types-of-nodes/images/import-a-workflow-canvas.png" alt="import a workflow" title="import a workflow" class="border-2 border-gray-300 rounded-xl"/>
...
5. (Optional) In the following dialog, select the **Back up your current workflow** option to preserve the data of the version being replaced.
    ...
    <img src="../workflow-builder/types-of-nodes/images/backup-workflow.png" alt="import confirmation" title="import confirmation" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/agent_platform/overwrite-or-keep.png" alt="import tool" title="import tool" class="border-2 border-gray-300 rounded-xl"/>
...
2. Select **Edit**.  
<img src="../images/agent_platform/edit-env-variable.png" alt="edit variable" title="edit variable" class="border-2 border-gray-300 rounded-xl"/>   

3. Change the required values in the **Edit Variable** window.  
4. Click **Save**.  
<img src="../images/agent_platform/save-edit-variable.png" alt="save variable" title="save variable" class="border-2 border-gray-300 rounded-xl"/>  
