...
<img src="../images/generate-new-api-key.png" alt="Generate new API Key" title="Generate new API Key" class="border-2 border-gray-300 rounded-xl"/>
...
<img src="../images/copy-and-close-api-key.png" alt="Copy and Close API Key" title="Copy and Close API Key" class="border-2 border-gray-300 rounded-xl"/>
