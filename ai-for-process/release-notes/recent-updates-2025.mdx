---
title: AI for Process Release Notes 2025 Archive
noindex: true
hidden: true
---

<Badge icon="arrow-left" color="gray">[Back to the latest release notes](/ai-for-process/release-notes/recent-updates)</Badge>

This document provides archived information about the feature updates and enhancements introduced in AI for Process past releases.
...
This update includes a new feature.
...
* [Re-deploy the workflow](/ai-for-process/workflows/workflow-management#redeploy-a-workflow), or
* [Re-test the associated Auth profile](/ai-for-process/settings/security-control#test-an-auth-profile)
