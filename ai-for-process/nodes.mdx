...
- Configure a Search AI application and enable the **Answer Generation** API scope. See [Creating and Managing JWT Apps](https://docs.kore.ai/xo/apis/automation/api-introduction/#creating-and-managing-jwt-apps-in-xo-platform).
...
[Supported Libraries](/ai-for-process/supported-libraries).