  ...
  <div className="kore-ap-inner">
    <div className="kore-ap-card">
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div className="kore-ap-title" style={{ flex: 1 }}>Kore.ai Agent Platform \{ Artemis \}</div>
      ...
      <p className="kore-ap-desc" style={{ marginBottom: '4px', maxWidth: 'none' }}>An AI-programmable foundation for building and deploying enterprise AI agents across customer and employee experiences, with certainty:</p>
