  ...
  <div className="kore-ap-inner">
    <div className="kore-ap-card">
      ...
      <div className="kore-cap-grid">
        <CapabilityTile href="/agent-platform/index#how-it-works" icon={<IconCPU />} title="Dual-Brain Architecture" description="A split-brain runtime: an agentic engine that reasons and a deterministic validator, running in parallel over a shared spine." />
