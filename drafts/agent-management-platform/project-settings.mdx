...
Navigation: In the left navigation of your project, go to **Settings**.
...
![General Settings](/agent-management-platform/images/general-settings.png)
...
![Baseline Metrics](/agent-management-platform/images/baseline-metrics.png)
...
- Review permissions periodically to ensure users have only what they need.
...
<Note>Only Project Admins can generate, revoke, or rotate API keys.</Note>

![API Key Management](/agent-management-platform/images/api-key.png)
...
- The key secret is displayed only once. Copy it securely immediately after generation or rotation.
- Use descriptive key names to indicate environment, project, or purpose.
- Rotate keys periodically to follow security best practices.
