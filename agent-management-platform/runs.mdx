...
![Runs page](/agent-platform/runs/images/runs-overview.png)
...
![Session detail panel](/agent-platform/runs/images/session-detail-panel.png)
...
![Datasets](/agent-platform/runs/images/runs-create-datasets.png)
