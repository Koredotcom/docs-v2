...
![Notifications detail](/agent-management-platform/images/notifications_detail.png)
...
![Notifications context](/agent-management-platform/images/notifications_context.png)
