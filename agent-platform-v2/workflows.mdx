...
For more information about human-in-the-loop workflows and approvals, see [Human-in-the-loop Workflows](/agent-platform-v2/hitl).

Assigned users can open Inbox tasks to review, approve, reject, or submit the requested information. For more information, see [Inbox](/agent-platform-v2/inbox).
