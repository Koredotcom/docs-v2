...
| `RESPOND`   | `string`                 | No       | _none_  | Response message                                           |
| `SET`       | `Record<string, string>` | No       | _none_  | Variable assignments                                       |
| `THEN`      | `string`                 | No       | _none_  | Step to transition to                                      |
...
- [Language overview](/agent-platform-v2/abl-reference/language-overview) -- syntax rules and auto-detection
- [Tools](/agent-platform-v2/abl-reference/tools) -- tool definitions used by `CALL` actions
- [GATHER](/agent-platform-v2/abl-reference/gather) -- top-level gather field definitions
- [Agent declaration](/agent-platform-v2/abl-reference/agent-declaration) -- GOAL used by `REASONING: true` steps, `max_flow_iterations` and model settings
