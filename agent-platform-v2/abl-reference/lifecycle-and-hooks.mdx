...
order: 10
description: 'ABL provides lifecycle handlers and hooks that execute at specific points in an agent execution cycle. These allow you to initialize state, and run side effects.'
---
...
| `VOICE`        | `object`                | No       | --      | Voice-specific overrides for the response. See [Rich Content](/agent-platform-v2/abl-reference/rich-content-and-expressions). |
| `RICH_CONTENT` | `object`                | No       | --      | Rich content format variants. See [Rich Content](/agent-platform-v2/abl-reference/rich-content-and-expressions).              |
...
- [Memory & Constraints](/agent-platform-v2/abl-reference/memory-and-constraints) -- variables initialized in ON_START and hooks
- [Multi-Agent & Supervisor](/agent-platform-v2/abl-reference/multi-agent-and-supervisor) -- ESCALATE and HANDOFF used in THEN actions
- [Rich Content & Expressions](/agent-platform-v2/abl-reference/rich-content-and-expressions) -- voice and rich content in handler responses
