...
Within a `FLOW:` step, gather uses a different syntax. See [GATHER within FLOW](/agent-platform-v2/abl-reference/flow#gather-in-flow-steps).
...
See [FLOW](/agent-platform-v2/abl-reference/flow) for the full flow step GATHER syntax.
...
- [Tools](/agent-platform-v2/abl-reference/tools) -- tool definitions (tools and gather work together)
- [FLOW](/agent-platform-v2/abl-reference/flow) -- GATHER within flow steps uses a different syntax
- [Language overview](/agent-platform-v2/abl-reference/language-overview) -- syntax rules for lists and blocks
