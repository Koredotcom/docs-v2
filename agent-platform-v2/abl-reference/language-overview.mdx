...
| `LIMITATIONS:`   | Explicit boundaries             | [Agent declaration](./agent-declaration#limitations)               |
...
| `CONSTRAINTS:`   | Business rule enforcement       | [Memory & Constraints](./memory-and-constraints#constraints)       |
