...
These patterns are configured in agent definitions and executed automatically by the runtime. See the [ABL SDK](/agent-platform-v2/sdks/index#abl-sdk) for programmatic access to agent definitions.
...
- [SDKs](/agent-platform-v2/sdks/index) -- Parse agent definitions programmatically
