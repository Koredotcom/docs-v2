...
The platform uses URL-path versioning. The current version is `v1`. For changes that aren't backward compatbible, a new version prefix (for example, `/api/v2/`) is added. Previous versions remain available during a documented deprecation window.
...
- [Conversation API](/agent-platform-v2/api-reference/conversation-api) -- Send messages and interact with agents
- [Management APIs](/agent-platform-v2/api-reference/management-apis) -- Manage agents, multi-agent workflows, and tools
- [SDKs](/agent-platform-v2/sdks/index) -- Embed agents in your web application
