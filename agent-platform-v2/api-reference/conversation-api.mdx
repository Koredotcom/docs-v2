...
The conversation API provides three interaction modes: agent-backed chat (ABL runtime execution), streaming LLM completions, and non-streaming LLM completions. All chat endpoints require authentication and enforce per-tenant rate limits (see [API overview](/agent-platform-v2/api-reference/api-overview)).
...
- [Management APIs](/agent-platform-v2/api-reference/management-apis) -- Manage agents, deployments, and tools
- [Knowledge, Analytics & Export APIs](/agent-platform-v2/api-reference/knowledge-analytics-export) -- Analytics and project operations
- [SDKs](/agent-platform-v2/api-reference/sdks) -- Build chat interfaces with the Web SDK
