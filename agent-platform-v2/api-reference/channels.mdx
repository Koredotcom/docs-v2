...
The Agent Platform 2.0 delivers agent conversations through 20+ channels. Each channel has an adapter that normalizes inbound messages, delivers outbound responses, and handles platform-specific features like interactive elements, threading, and media. For authentication and error handling conventions, see [API overview](/agent-platform-v2/api-reference/index).
...
- [API overview](/agent-platform-v2/api-reference/index) -- Authentication and general conventions
