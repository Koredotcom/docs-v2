...
sidebarTitle: 'Knowledge & Analytics'
...
This page covers the knowledge and memory API for runtime data persistence and contact management, the analytics API for event metrics and voice analytics, and the project export/import API for migrating agent projects between environments. For authentication and error handling conventions, see [API overview](/agent-platform-v2/api-reference/api-overview).
...
- [SDKs](/agent-platform-v2/api-reference/sdks) -- Parse and validate exported ABL files programmatically
