---
title: 'Knowledge, Analytics and Export APIs'
sidebarTitle: 'Knowledge and Analytics'
description: 'Knowledge and memory API for runtime data persistence and contact management, the analytics API for event metrics and voice analytics, and the project export/import API for migrat'
---

This page covers the knowledge and memory API for runtime data persistence and contact management, the analytics API for event metrics and voice analytics, and the project export/import API for migrating agent projects between environments. For authentication and error handling conventions, see [API overview](/agent-platform-v2/api-reference/index).
...
See [Conversation API -- Session traces](/agent-platform-v2/api-reference/conversation-api#get-apiprojectsprojectidsessionsidtraces) for full documentation.
...
- [Conversation API](/agent-platform-v2/api-reference/conversation-api) -- Session and trace details
- [Management APIs](/agent-platform-v2/api-reference/management-apis) -- Manage imported agents
- [SDKs](/agent-platform-v2/sdks/index) -- Parse and validate exported ABL files programmatically
