...
section: 'examples'
order: 2
description: 'Production-quality ABL examples organized by industry vertical. Each example is drawn from or inspired by real agent deployments in the platform example library.'
---
...
- See [Orchestration Patterns Cookbook](/agent-platform-v2/examples/orchestration-and-integration) for reusable multi-agent coordination strategies.
- See [Integration Recipes](/agent-platform-v2/examples/orchestration-and-integration) for connecting agents to external services.
- See [Examples by Pattern](/agent-platform-v2/examples/by-pattern) for fundamental ABL constructs.
