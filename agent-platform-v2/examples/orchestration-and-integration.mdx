...
- See [Examples by Pattern](/agent-platform-v2/examples/by-pattern) for fundamental ABL construct examples.
- See [Examples by Industry](/agent-platform-v2/examples/by-industry) for production implementations using these patterns.
- See the [ABL Language Reference](/agent-platform-v2/abl-reference/language-overview) for complete syntax documentation.
- See the [Tools Reference](/agent-platform-v2/abl-reference/tools) for detailed tool configuration options.
