...
1. [Platform overview](/agent-platform-v2/platform-overview-user) to know the Platform.
2. [Quickstart](/agent-platform-v2/quickstart) to build a foundation.
3. [Glossary](/agent-platform-v2/glossary) to get familiar with terms.
