...
Start with the [platform overview](/agent-platform-v2/platform-overview-user) and work through the [quickstart](/agent-platform-v2/quickstart) to build a foundation. Use the [glossary](/agent-platform-v2/glossary) to clarify unfamiliar terms. The documentation includes tutorials, how-to guides, the ABL language reference, and the REST API reference.
...
3. **Review the [ABL language reference](/agent-platform-v2/abl-reference/language-overview)** before submitting documentation changes.
...
Your support tier is determined by your [plan tier](/agent-platform-v2/glossary#plan-tier). Contact your account team to discuss support options.
