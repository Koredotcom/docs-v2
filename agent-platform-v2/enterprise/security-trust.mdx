...
- **Incident response:** A documented incident response process governs detection, containment, communication, and post-incident review. See [Status and service health](/agent-platform-v2/community) for details.
