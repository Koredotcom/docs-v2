---
title: "Testing Agentic Projects"
sidebarTitle: "Testing Agentic Projects"
---
...
3. To test an individual agent in isolation, go to the **Agent** page and click **Chat with Agent**. ![Test Agent](/agent-platform-v2/images/test.png)
4. Or use the **Chat** option next to any agent on the **Overview** page. ![Test Agent](/agent-platform-v2/images/test-agent.png)
