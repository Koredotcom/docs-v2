...
When workflow execution reaches an Approval or Data Entry step:

1. A human task is created.
2. The task appears in the Inbox.
3. Workflow execution pauses.
4. A user reviews or completes the task.
5. Workflow execution resumes after task completion.
...
For detailed information about Inbox tasks, task management, and workflow execution behavior, see [Inbox](/agent-platform-v2/inbox).
