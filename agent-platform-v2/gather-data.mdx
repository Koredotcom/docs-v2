...
For full details on display modes and masking configuration, see [Handling transient and sensitive fields.](/agent-platform-v2/abl-reference/gather#transient-and-sensitive-fields)
