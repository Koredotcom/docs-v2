...
![Retrieval Process](/agent-platform-v2/images/knowledge/retrieval-process.png)
...
Navigate to **Data** > **Add Source** > **Web Crawler** to manage web sources.
...
Pre-built integrations for third-party applications. Navigate to **Data** > **Add Source** to configure integrations.
...
<Note>
  The pipeline runs in sequence. A change to an upstream stage, such as
