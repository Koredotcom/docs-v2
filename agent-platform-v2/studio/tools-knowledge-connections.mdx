...
After creating tools, connect them to agents through the agent editor's **Tools** section. Add tools from your project's tool library and configure any parameter mappings or overrides specific to each agent. See [Agent development](/agent-platform-v2/studio/agent-development) for details on the agent editor.
...
After creating and populating a knowledge base, connect it to agents so they can use it during conversations. Knowledge base connections are managed through the agent's tool and configuration settings. See [Agent development](/agent-platform-v2/studio/agent-development) for details.
...
When a workflow reaches an approval step, a task is created in the **Inbox** (see [Testing, deployment & operations](/agent-platform-v2/studio/testing-deployment-operations)). The workflow pauses until a team member reviews and approves or rejects the step.

## Related pages

- [Agent development](/agent-platform-v2/studio/agent-development) -- building agents that use tools and knowledge bases
- [Studio overview](/agent-platform-v2/studio/studio-overview) -- navigation and project management
- [Testing, deployment & operations](/agent-platform-v2/studio/testing-deployment-operations) -- deploying and monitoring agents
- [Insights & settings](/agent-platform-v2/studio/insights-and-settings) -- guardrails and project configuration
