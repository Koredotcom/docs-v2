...
- [Tools, knowledge & connections](/agent-platform-v2/studio/tools-knowledge-connections) -- tools and workflows that generate sessions
- [Insights & settings](/agent-platform-v2/studio/insights-and-settings) -- analytics derived from sessions, and project configuration
