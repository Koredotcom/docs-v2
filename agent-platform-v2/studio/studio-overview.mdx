...
- **AI Architect toggle** -- opens the AI Architect side panel (available inside any project). See [Agent development](/agent-platform-v2/studio/agent-development).
...
Project settings are organized into dedicated pages accessible from the **Settings** group in the sidebar. See [Insights & settings](/agent-platform-v2/studio/insights-and-settings) for complete documentation of each settings page.

## Related pages

- [Agent development](/agent-platform-v2/studio/agent-development) -- building and testing agents
- [Tools, knowledge & connections](/agent-platform-v2/studio/tools-knowledge-connections) -- managing agent resources
- [Testing, deployment & operations](/agent-platform-v2/studio/testing-deployment-operations) -- evaluations, deployment, and monitoring
- [Insights & settings](/agent-platform-v2/studio/insights-and-settings) -- analytics, guardrails, and project configuration
