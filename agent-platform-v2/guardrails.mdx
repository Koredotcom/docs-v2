...
| Setting | Description |
| --- | --- |
| Fail Mode | Controls whether execution continues or is blocked if guardrail evaluation fails.<br /><br /><ul><li><strong>Fail-open</strong> allows execution to continue if guardrail evaluation fails or times out.</li><li><strong>Fail-closed</strong> blocks execution when guardrail evaluation cannot be completed successfully.<br /><br />Use fail-closed behavior for high-security or compliance-sensitive applications.</li></ul> |
...
For API payloads, policy schemas, and advanced configuration examples, see the Guardrail Policy API Reference in the *<span style="text-decoration:underline;">ABL Reference Guide</span>*.
...
For advanced syntax and additional examples, see the Guardrails section in the *<span style="text-decoration:underline;">ABL Reference Guide</span>*.
