...
- **Agent developer** — You define agent behavior in ABL DSL or Studio's visual editor. You write supervisor routing logic, tool integrations, and knowledge base configurations. Start with the [Quickstart](/agent-platform-v2/quickstart), then move to [Your first agent](/agent-platform-v2/tutorials/build-your-first-agent).
- **QA / Tester** — You create evaluation sets with personas, scenarios, and LLM-based judges to validate agent behavior at scale. Start with the [Evaluation guide](/agent-platform-v2/tutorials/safety-testing-publishing).
