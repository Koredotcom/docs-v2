...
order: 3
description: 'A workspace is your team's dedicated environment on the Agent Platform. It enforces isolated data boundaries, controls which AI models and features are available, and determines what each team member can do. '
---
...
The Workspace Members page shows a Pending Invitations section for invitations that have not yet been accepted.
