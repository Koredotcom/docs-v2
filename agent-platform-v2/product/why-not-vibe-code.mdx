...
For the full analysis of why AI coding tools solve the _coding_ problem but not the _agent platform_ problem, see [Why a New Platform](/agent-platform-v2/why-a-new-platform).
