...
![ABL Editor](/agent-platform-v2/images/dsl-editor.png)
...
![ABL Editor outline panel](/agent-platform-v2/images/dsl-editor-outline-option.png)
...
![ABL Editor diagnostics panel](/agent-platform-v2/images/dsl-editor-diagnostics-option.png)
...
![Insert Tool Signature dialog](/agent-platform-v2/images/dsl-signature-insert-tools-signature-option.png)
