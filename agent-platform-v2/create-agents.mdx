...
<Tip>
  Always set `max_reasoning_iterations` to prevent runaway loops. Start with
  10–15 and tune based on observed behavior.
</Tip>
...
<Note>
  Create the tool at the project level, then attach it to the agent via UI or
  DSL.{" "}
</Note>
