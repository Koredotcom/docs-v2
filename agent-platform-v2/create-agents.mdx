...
For full details, see the [Data Collection and Memory & State guides](/agent-platform-v2/memory-and-state).
...
For more details, see [NLU configuration](/agent-platform-v2/abl-reference/nlu).
...
For full details, refer [Sessions guide](/agent-platform-v2/sessions). 
