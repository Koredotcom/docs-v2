---
title: 'Multi-Agent and Knowledge'
sidebarTitle: 'Multi-Agent & Knowledge'
---
...
- Completed [Add structured steps to an agent](/agent-platform-v2/tutorials/build-a-scripted-flow)
...
```mermaid
flowchart LR
    A["**Part 1** <br /> Build a Supervisor"]
    B["**Part 2** <br /> Add Delegation <br /> & Routing"]
    C["**Part 3** <br /> Add a Knowledge <br /> Base"]
    D["**Part 4** <br /> Connect It <br /> Together"]
    A --> B --> C --> D
```
...
- [Safety, testing, and publishing](/agent-platform-v2/tutorials/safety-testing-publishing) — Add guardrails, run evaluations, and publish your agent.
- [Building agents](/agent-platform-v2/guides/building-reasoning-agents) — Deep dive into agent patterns.
- [Knowledge bases](/agent-platform-v2/guides/knowledge-bases) — Advanced knowledge base configuration and search strategies.

<Tip>Use `RETURN: true` on handoffs when you want the supervisor to resume after a specialist finishes. Use `RETURN: false` when the specialist should own the rest of the session.</Tip>
