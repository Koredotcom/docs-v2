...
> **Time:** ~25 minutes | **Level:** Beginner | **Prerequisites:** [Build your first agent](/agent-platform-v2/tutorials/build-your-first-agent)
...
- [Multi-agent and knowledge](/agent-platform-v2/tutorials/multi-agent-and-knowledge) -- Create a supervisor that routes between specialist agents and add a knowledge base
